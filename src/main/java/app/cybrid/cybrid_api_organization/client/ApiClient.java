...
import app.cybrid.cybrid_api_organization.client.auth.Authentication;
import app.cybrid.cybrid_api_organization.client.auth.HttpBasicAuth;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    private String basePath = "https://organization.sandbox.cybrid.app";
