  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.guid, subscriptionDelivery.guid) &&
        equalsNullable(this.response, subscriptionDelivery.response) &&
        ...
        equalsNullable(this.nextAttemptAt, subscriptionDelivery.nextAttemptAt) &&
        Objects.equals(this.attemptCount, subscriptionDelivery.attemptCount) &&
        equalsNullable(this.completedAt, subscriptionDelivery.completedAt) &&
        equalsNullable(this.failedAt, subscriptionDelivery.failedAt) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(guid, hashCodeNullable(response), subscriptionEventGuid, subscriptionGuid, state, hashCodeNullable(nextAttemptAt), attemptCount, hashCodeNullable(completedAt), hashCodeNullable(failedAt), createdAt, updatedAt);
  }
