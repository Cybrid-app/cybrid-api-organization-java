 ...
 */
@ApiModel(description = "Request body for subscription creation.")
@JsonPropertyOrder({
...
public class PostSubscriptionOrganizationModel {
  ...
  public PostSubscriptionOrganizationModel environment(EnvironmentEnum environment) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The environment that the subscription is configured for.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Type of the subscription.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "URL provided for the subscription.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.environment, postSubscription.environment) &&
        Objects.equals(this.type, postSubscription.type) &&
        Objects.equals(this.name, postSubscription.name) &&
        Objects.equals(this.url, postSubscription.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(environment, type, name, url);
  }
