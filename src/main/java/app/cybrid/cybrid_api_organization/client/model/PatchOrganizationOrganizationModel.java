 ...
 */
@ApiModel(description = "Request body for organization modification.")
@JsonPropertyOrder({
  PatchOrganizationOrganizationModel.JSON_PROPERTY_NAME
})
@JsonTypeName("PatchOrganization")
...
public class PatchOrganizationOrganizationModel {
  public static final String JSON_PROPERTY_NAME = "name";
  private JsonNullable<String> name = JsonNullable.<String>undefined();

  public PatchOrganizationOrganizationModel() { 
  }

  public PatchOrganizationOrganizationModel name(String name) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Name for the organization.")
  @JsonIgnore
  ...
  public boolean equals(Object o) {
    ...
    PatchOrganizationOrganizationModel patchOrganization = (PatchOrganizationOrganizationModel) o;
    return equalsNullable(this.name, patchOrganization.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchOrganizationOrganizationModel {\n");
