...
- Build date: 2022-06-11T14:13:13.314039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.24.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.24.5.jar`
- `target/lib/*.jar`
