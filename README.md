...
- Build date: 2025-01-29T16:36:29.697806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.179"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.179.jar`
- `target/lib/*.jar`
