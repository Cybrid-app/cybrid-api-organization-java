...
- Build date: 2024-03-06T14:04:47.572590Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.42.jar`
- `target/lib/*.jar`
