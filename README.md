...
- Build date: 2024-04-19T14:23:52.216328Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.110"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.110.jar`
- `target/lib/*.jar`
