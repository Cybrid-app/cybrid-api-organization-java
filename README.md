...
- Build date: 2023-05-26T11:46:33.703391Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.48.jar`
- `target/lib/*.jar`
