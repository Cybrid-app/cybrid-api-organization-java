...
- Build date: 2023-06-27T18:33:28.548062Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.17.jar`
- `target/lib/*.jar`
