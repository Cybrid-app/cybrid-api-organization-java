...
- Build date: 2023-06-12T13:39:10.604969Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.7.jar`
- `target/lib/*.jar`
