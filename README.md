...
- Build date: 2025-04-29T13:45:43.164103Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.433"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.433.jar`
- `target/lib/*.jar`
