...
- Build date: 2023-12-05T18:13:21.402953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.8.jar`
- `target/lib/*.jar`
