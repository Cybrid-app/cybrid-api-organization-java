...
- Build date: 2023-10-11T18:33:04.919159Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.103.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.103.0.jar`
- `target/lib/*.jar`
