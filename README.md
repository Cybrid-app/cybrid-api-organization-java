...
- Build date: 2023-05-24T17:46:22.602886Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.38.jar`
- `target/lib/*.jar`
