...
- Build date: 2025-06-30T14:30:01.335130Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.651"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.651.jar`
- `target/lib/*.jar`
