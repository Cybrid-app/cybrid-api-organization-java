...
- Build date: 2024-11-07T22:21:38.537151Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.39.jar`
- `target/lib/*.jar`
