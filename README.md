...
- Build date: 2024-02-21T20:45:18.129959Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.9.jar`
- `target/lib/*.jar`
