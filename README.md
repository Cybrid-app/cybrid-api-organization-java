...
- Build date: 2023-09-26T01:28:18.295303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.34.jar`
- `target/lib/*.jar`
