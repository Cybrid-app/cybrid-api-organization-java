...
- Build date: 2023-10-11T22:01:03.978890Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.104.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.104.1.jar`
- `target/lib/*.jar`
