...
- Build date: 2025-06-20T13:41:45.744765Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.614"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.614.jar`
- `target/lib/*.jar`
