...
- Build date: 2024-12-03T15:01:00.718071Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.47.jar`
- `target/lib/*.jar`
