...
- Build date: 2024-12-31T14:53:43.019457Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.115"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.115.jar`
- `target/lib/*.jar`
