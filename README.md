...
- Build date: 2022-05-12T18:08:10.707231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.3.jar`
- `target/lib/*.jar`
