...
- Build date: 2024-08-01T14:29:21.084020Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.116"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.116.jar`
- `target/lib/*.jar`
