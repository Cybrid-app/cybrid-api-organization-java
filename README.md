...
- Build date: 2025-03-26T18:08:53.776494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.329"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.329.jar`
- `target/lib/*.jar`
