...
- Build date: 2024-11-14T16:52:47.668637Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.67.jar`
- `target/lib/*.jar`
