...
- Build date: 2025-02-12T14:05:34.627102Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.227"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.227.jar`
- `target/lib/*.jar`
