...
- Build date: 2024-01-05T13:53:10.724611Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.49.jar`
- `target/lib/*.jar`
