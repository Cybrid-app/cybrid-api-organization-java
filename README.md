...
- Build date: 2024-02-07T21:23:17.280734Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.125"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.125.jar`
- `target/lib/*.jar`
