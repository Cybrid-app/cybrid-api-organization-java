...
- Build date: 2023-05-30T12:09:19.565214Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.57.jar`
- `target/lib/*.jar`
