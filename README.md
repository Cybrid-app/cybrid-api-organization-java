...
- Build date: 2023-10-16T18:31:29.963610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.107.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.107.1.jar`
- `target/lib/*.jar`
