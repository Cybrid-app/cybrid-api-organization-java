...
- Build date: 2024-11-15T14:58:49.554156Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.70.jar`
- `target/lib/*.jar`
