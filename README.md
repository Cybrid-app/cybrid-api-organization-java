...
- Build date: 2024-09-26T12:16:11.871386Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.140"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.140.jar`
- `target/lib/*.jar`
