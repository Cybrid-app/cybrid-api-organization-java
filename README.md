...
- Build date: 2024-09-24T15:53:00.446227Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.135"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.135.jar`
- `target/lib/*.jar`
