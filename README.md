...
- Build date: 2025-05-06T13:10:56.199723Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.452"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.452.jar`
- `target/lib/*.jar`
