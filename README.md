...
- Build date: 2025-06-12T14:22:36.592435Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.579"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.579.jar`
- `target/lib/*.jar`
