...
- Build date: 2025-03-13T13:38:21.192086Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.292"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.292.jar`
- `target/lib/*.jar`
