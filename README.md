...
- Build date: 2024-09-09T17:02:34.460986Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.75"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.75.jar`
- `target/lib/*.jar`
