...
- Build date: 2023-10-16T14:38:16.331921Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.7.jar`
- `target/lib/*.jar`
