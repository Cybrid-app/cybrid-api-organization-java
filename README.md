...
- Build date: 2024-07-30T17:52:44.496743Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.112"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.112.jar`
- `target/lib/*.jar`
