...
- Build date: 2023-07-05T19:01:13.214291Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.2.jar`
- `target/lib/*.jar`
