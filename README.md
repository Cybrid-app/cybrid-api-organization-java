...
- Build date: 2024-02-29T17:35:57.274248Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.26.jar`
- `target/lib/*.jar`
