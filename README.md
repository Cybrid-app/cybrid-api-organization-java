...
- API version: v0.123.159

- Build date: 2025-01-23T13:26:33.953819Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.159"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.159.jar`
- `target/lib/*.jar`
