...
- Build date: 2024-01-25T18:38:32.448142Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.98"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.98.jar`
- `target/lib/*.jar`
