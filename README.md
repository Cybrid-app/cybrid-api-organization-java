...
- Build date: 2025-01-06T13:48:30.717845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.124"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.124.jar`
- `target/lib/*.jar`
