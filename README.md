...
- Build date: 2024-07-18T15:04:46.477063Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.85"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.85.jar`
- `target/lib/*.jar`
