...
- Build date: 2024-04-01T16:36:19.512935Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.52.jar`
- `target/lib/*.jar`
