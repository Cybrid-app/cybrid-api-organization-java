...
- Build date: 2024-11-20T15:43:55.849500Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.10.jar`
- `target/lib/*.jar`
