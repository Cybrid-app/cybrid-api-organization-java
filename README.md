...
- Build date: 2023-10-24T12:55:52.313475Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.15.jar`
- `target/lib/*.jar`
