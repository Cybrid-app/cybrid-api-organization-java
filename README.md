...
- Build date: 2025-04-25T14:29:31.033663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.426"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.426.jar`
- `target/lib/*.jar`
