...
- Build date: 2024-10-17T21:32:40.980939Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.18.jar`
- `target/lib/*.jar`
