...
- Build date: 2024-04-08T20:29:51.556811Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.68.jar`
- `target/lib/*.jar`
