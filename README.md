...
- Build date: 2024-09-20T16:04:42.832798Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.125"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.125.jar`
- `target/lib/*.jar`
