...
- Build date: 2025-06-09T11:28:31.569454Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.559"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.559.jar`
- `target/lib/*.jar`
