...
- Build date: 2023-11-16T16:45:01.916553Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.4.jar`
- `target/lib/*.jar`
