...
- Build date: 2025-05-15T00:10:09.430626Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.482"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.482.jar`
- `target/lib/*.jar`
