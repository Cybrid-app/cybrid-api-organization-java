...
- Build date: 2022-06-08T16:15:56.164764Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.23.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.23.1.jar`
- `target/lib/*.jar`
