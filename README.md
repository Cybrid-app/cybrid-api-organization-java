...
- Build date: 2025-05-29T17:51:46.942231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.537"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.537.jar`
- `target/lib/*.jar`
