...
- Build date: 2022-05-24T21:20:44.701220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.8.jar`
- `target/lib/*.jar`
