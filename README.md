...
- Build date: 2024-09-05T17:55:57.964636Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.69.jar`
- `target/lib/*.jar`
