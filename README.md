...
- Build date: 2024-10-16T17:44:27.074445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.12.jar`
- `target/lib/*.jar`
