...
- Build date: 2025-06-26T18:58:28.948597Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.647"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.647.jar`
- `target/lib/*.jar`
