...
- Build date: 2025-05-21T19:52:57.418953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.510"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.510.jar`
- `target/lib/*.jar`
