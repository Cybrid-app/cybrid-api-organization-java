...
- Build date: 2023-06-08T20:24:33.452244Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.4.jar`
- `target/lib/*.jar`
