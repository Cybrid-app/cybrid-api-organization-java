...
- Build date: 2024-12-19T12:19:38.295860Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.97"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.97.jar`
- `target/lib/*.jar`
