...
- Build date: 2024-03-28T20:48:51.202120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.49.jar`
- `target/lib/*.jar`
