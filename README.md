...
- Build date: 2023-08-28T19:11:50.300036Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.0.jar`
- `target/lib/*.jar`
