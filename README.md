...
- Build date: 2024-04-01T23:53:09.032994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.54.jar`
- `target/lib/*.jar`
