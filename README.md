...
- Build date: 2025-02-06T22:14:38.168036Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.217"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.217.jar`
- `target/lib/*.jar`
