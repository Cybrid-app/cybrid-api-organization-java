...
- Build date: 2025-04-10T17:51:14.993048Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.376"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.376.jar`
- `target/lib/*.jar`
