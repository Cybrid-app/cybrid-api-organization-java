...
- Build date: 2024-03-28T12:44:44.989523Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.45.jar`
- `target/lib/*.jar`
