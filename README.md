...
- Build date: 2024-11-13T19:19:33.874040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.65.jar`
- `target/lib/*.jar`
