...
- Build date: 2024-02-12T14:32:49.764289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.137"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.137.jar`
- `target/lib/*.jar`
