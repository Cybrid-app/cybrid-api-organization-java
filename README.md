...
- Build date: 2024-04-29T14:10:42.739289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.126"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.126.jar`
- `target/lib/*.jar`
