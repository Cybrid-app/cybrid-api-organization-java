...
- Build date: 2024-02-06T14:01:42.187894Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.120"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.120.jar`
- `target/lib/*.jar`
