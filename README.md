...
- Build date: 2024-01-26T16:03:52.556051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.101"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.101.jar`
- `target/lib/*.jar`
