...
- Build date: 2025-06-17T16:53:08.161867Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.600"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.600.jar`
- `target/lib/*.jar`
