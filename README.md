...
- Build date: 2025-02-12T22:30:18.058448Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.229"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.229.jar`
- `target/lib/*.jar`
