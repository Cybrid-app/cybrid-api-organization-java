...
- Build date: 2022-06-06T22:14:37.991663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.19.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.19.1.jar`
- `target/lib/*.jar`
