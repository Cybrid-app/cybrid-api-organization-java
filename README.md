...
- Build date: 2024-02-28T01:28:02.153785Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.23.jar`
- `target/lib/*.jar`
