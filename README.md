...
- API version: v0.123.162

- Build date: 2025-01-23T16:48:39.578421Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.162"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.162.jar`
- `target/lib/*.jar`
