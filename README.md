...
- Build date: 2024-08-15T21:39:25.860062Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.26.jar`
- `target/lib/*.jar`
