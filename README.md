...
- Build date: 2023-06-27T20:45:06.673006Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.19.jar`
- `target/lib/*.jar`
