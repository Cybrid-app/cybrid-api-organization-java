...
- Build date: 2024-02-27T19:04:44.644992Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.20.jar`
- `target/lib/*.jar`
