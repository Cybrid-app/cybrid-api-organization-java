...
- Build date: 2025-01-03T15:34:25.352024Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.119"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.119.jar`
- `target/lib/*.jar`
