...
- Build date: 2024-10-23T11:55:42.080122Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.34.jar`
- `target/lib/*.jar`
