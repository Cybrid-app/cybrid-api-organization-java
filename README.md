...
- Build date: 2023-06-20T13:24:36.866311Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.32.jar`
- `target/lib/*.jar`
