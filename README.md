...
- Build date: 2023-08-22T19:59:09.398579Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.1.jar`
- `target/lib/*.jar`
