...
- Build date: 2023-12-21T22:55:40.115855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.35.jar`
- `target/lib/*.jar`
