...
- Build date: 2024-11-08T00:56:20.162721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.41.jar`
- `target/lib/*.jar`
