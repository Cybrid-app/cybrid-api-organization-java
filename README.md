...
- Build date: 2023-11-14T20:28:06.053669Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.59.jar`
- `target/lib/*.jar`
