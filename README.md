...
- Build date: 2025-05-06T15:33:56.761469Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.454"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.454.jar`
- `target/lib/*.jar`
