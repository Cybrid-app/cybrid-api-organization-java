...
- Build date: 2023-04-12T20:45:24.259135Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.39.jar`
- `target/lib/*.jar`
