...
- Build date: 2023-09-21T21:49:28.147171Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.26.jar`
- `target/lib/*.jar`
