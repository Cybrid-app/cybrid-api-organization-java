...
- Build date: 2023-10-11T14:45:25.250153Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.100.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.100.0.jar`
- `target/lib/*.jar`
