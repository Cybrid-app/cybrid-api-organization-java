...
- Build date: 2024-10-23T14:13:33.856163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.37.jar`
- `target/lib/*.jar`
