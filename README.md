...
- Build date: 2025-02-07T17:48:19.322270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.220"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.220.jar`
- `target/lib/*.jar`
