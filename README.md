...
- Build date: 2025-02-14T20:19:17.202131Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.234"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.234.jar`
- `target/lib/*.jar`
