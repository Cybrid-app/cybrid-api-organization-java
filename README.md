...
- Build date: 2023-08-15T15:43:23.451763Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.5.jar`
- `target/lib/*.jar`
