...
- Build date: 2025-04-15T17:03:57.285682Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.390"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.390.jar`
- `target/lib/*.jar`
