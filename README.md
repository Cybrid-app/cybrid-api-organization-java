...
- Build date: 2024-08-28T16:52:33.944249Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.52.jar`
- `target/lib/*.jar`
