...
- Build date: 2024-10-04T21:16:15.635708Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.4.jar`
- `target/lib/*.jar`
