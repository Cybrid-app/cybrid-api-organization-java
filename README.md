...
- Build date: 2023-10-18T17:35:53.972615Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.1.jar`
- `target/lib/*.jar`
