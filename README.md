...
- Build date: 2023-07-14T11:51:51.968717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.8.jar`
- `target/lib/*.jar`
