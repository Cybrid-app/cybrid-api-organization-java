...
- Build date: 2024-12-16T21:08:50.761017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.91.jar`
- `target/lib/*.jar`
