...
- Build date: 2024-10-04T18:03:44.278476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.1.jar`
- `target/lib/*.jar`
