...
- Build date: 2023-12-19T15:37:01.303753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.21.jar`
- `target/lib/*.jar`
