...
- Build date: 2024-08-22T15:01:46.458012Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.41.jar`
- `target/lib/*.jar`
