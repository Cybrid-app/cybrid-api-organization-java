...
- Build date: 2024-07-04T15:22:11.647059Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.63.jar`
- `target/lib/*.jar`
