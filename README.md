...
- Build date: 2025-03-28T15:07:47.988316Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.337"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.337.jar`
- `target/lib/*.jar`
