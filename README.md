...
- Build date: 2024-09-20T19:12:51.445035Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.127"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.127.jar`
- `target/lib/*.jar`
