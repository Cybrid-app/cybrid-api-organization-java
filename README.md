...
- Build date: 2025-03-18T11:50:29.941337Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.302"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.302.jar`
- `target/lib/*.jar`
