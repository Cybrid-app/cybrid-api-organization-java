...
- Build date: 2024-10-23T18:14:44.516065Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.39.jar`
- `target/lib/*.jar`
