...
- Build date: 2024-07-26T15:13:42.153574Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.101"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.101.jar`
- `target/lib/*.jar`
