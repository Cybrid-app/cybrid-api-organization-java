...
- Build date: 2024-03-26T14:38:24.872748Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.39.jar`
- `target/lib/*.jar`
