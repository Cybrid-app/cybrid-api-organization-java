...
- Build date: 2023-08-15T16:07:21.672654Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.6.jar`
- `target/lib/*.jar`
