...
- Build date: 2024-05-08T14:51:25.606810Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.143"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.143.jar`
- `target/lib/*.jar`
