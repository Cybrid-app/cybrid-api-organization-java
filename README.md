...
- Build date: 2023-12-21T15:06:07.052524Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.29.jar`
- `target/lib/*.jar`
