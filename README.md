...
- Build date: 2024-03-01T19:05:40.213805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.32.jar`
- `target/lib/*.jar`
