...
- Build date: 2023-10-12T21:49:46.104252Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.1.jar`
- `target/lib/*.jar`
