...
- Build date: 2025-03-28T21:11:41.257043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.340"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.340.jar`
- `target/lib/*.jar`
