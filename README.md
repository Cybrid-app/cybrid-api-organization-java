...
- Build date: 2024-12-05T14:39:46.981900Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.59.jar`
- `target/lib/*.jar`
