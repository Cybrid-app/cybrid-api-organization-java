...
- Build date: 2024-05-09T21:54:01.549075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.147"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.147.jar`
- `target/lib/*.jar`
