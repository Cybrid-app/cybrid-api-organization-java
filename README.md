...
- Build date: 2022-05-11T22:21:28.699871Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.2.jar`
- `target/lib/*.jar`
