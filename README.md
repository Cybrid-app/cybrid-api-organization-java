...
- Build date: 2025-02-25T22:56:12.653583Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.256"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.256.jar`
- `target/lib/*.jar`
