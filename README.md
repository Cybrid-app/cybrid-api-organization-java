...
- Build date: 2025-06-03T17:30:44.550115Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.548"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.548.jar`
- `target/lib/*.jar`
