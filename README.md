...
- Build date: 2023-11-08T13:54:00.909789Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.41.jar`
- `target/lib/*.jar`
