...
- Build date: 2024-11-14T18:30:43.921723Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.69.jar`
- `target/lib/*.jar`
