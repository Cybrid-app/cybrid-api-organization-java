...
- Build date: 2025-01-17T13:51:10.527974Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.148"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.148.jar`
- `target/lib/*.jar`
