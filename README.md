...
- Build date: 2024-09-09T14:19:45.827023Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.72.jar`
- `target/lib/*.jar`
