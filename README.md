...
- Build date: 2024-07-29T15:11:06.106994Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.107"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.107.jar`
- `target/lib/*.jar`
