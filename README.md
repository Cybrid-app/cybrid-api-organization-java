...
- Build date: 2023-12-21T14:20:53.747668Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.28.jar`
- `target/lib/*.jar`
