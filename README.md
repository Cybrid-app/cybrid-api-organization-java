...
- Build date: 2024-05-10T22:58:41.599882Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.150"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.150.jar`
- `target/lib/*.jar`
