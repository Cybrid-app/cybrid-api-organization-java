...
- Build date: 2024-01-29T13:48:22.259913Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.105"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.105.jar`
- `target/lib/*.jar`
