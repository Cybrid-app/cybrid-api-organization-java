...
- Build date: 2024-04-08T18:48:25.311803Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.67.jar`
- `target/lib/*.jar`
