...
- Build date: 2024-12-12T18:53:23.327046Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.81"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.81.jar`
- `target/lib/*.jar`
