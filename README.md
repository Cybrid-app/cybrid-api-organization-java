...
- Build date: 2023-08-09T15:55:10.249079Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.0.jar`
- `target/lib/*.jar`
