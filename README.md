...
- Build date: 2025-04-15T13:45:42.273648Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.387"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.387.jar`
- `target/lib/*.jar`
