...
- Build date: 2023-12-06T17:24:02.441688Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.11.jar`
- `target/lib/*.jar`
