...
- Build date: 2022-05-19T11:29:22.204149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.12.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.12.3.jar`
- `target/lib/*.jar`
