...
- Build date: 2023-10-31T15:01:55.418376Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.28.jar`
- `target/lib/*.jar`
