...
- Build date: 2024-03-05T13:40:47.443736Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.38.jar`
- `target/lib/*.jar`
