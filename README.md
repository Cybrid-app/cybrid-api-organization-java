...
- Build date: 2024-06-03T15:10:50.730741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.29.jar`
- `target/lib/*.jar`
