...
- Build date: 2023-07-20T14:06:48.197839Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.7.jar`
- `target/lib/*.jar`
