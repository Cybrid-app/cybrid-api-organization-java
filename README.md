...
- Build date: 2025-03-05T19:55:35.325150Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.272"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.272.jar`
- `target/lib/*.jar`
