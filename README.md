...
- Build date: 2022-05-31T13:11:57.388708Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.16.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.16.4.jar`
- `target/lib/*.jar`
