...
- Build date: 2022-05-24T10:26:17.161016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.1.jar`
- `target/lib/*.jar`
