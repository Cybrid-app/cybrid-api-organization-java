...
- Build date: 2024-02-02T16:09:38.291524Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.117"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.117.jar`
- `target/lib/*.jar`
