...
- Build date: 2024-11-11T21:16:50.043538Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.57.jar`
- `target/lib/*.jar`
