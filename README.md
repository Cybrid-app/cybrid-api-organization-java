...
- Build date: 2023-12-12T14:38:28.060434Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.35.jar`
- `target/lib/*.jar`
