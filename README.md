...
- Build date: 2024-08-29T19:03:28.357075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.56.jar`
- `target/lib/*.jar`
