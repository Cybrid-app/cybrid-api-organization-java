...
- Build date: 2025-06-09T18:34:48.237356Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.567"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.567.jar`
- `target/lib/*.jar`
