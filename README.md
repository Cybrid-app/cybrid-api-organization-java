...
- Build date: 2022-05-09T10:43:08.667562Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.4.jar`
- `target/lib/*.jar`
