...
- Build date: 2025-05-16T12:05:13.822920Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.492"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.492.jar`
- `target/lib/*.jar`
