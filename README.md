...
- Build date: 2022-06-06T17:12:59.196693Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.17.jar`
- `target/lib/*.jar`
