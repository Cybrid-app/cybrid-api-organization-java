...
- API version: v0.123.163

- Build date: 2025-01-24T14:38:58.337017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.163"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.163.jar`
- `target/lib/*.jar`
