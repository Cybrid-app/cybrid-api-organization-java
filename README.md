...
- Build date: 2024-08-02T17:18:44.147559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.119"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.119.jar`
- `target/lib/*.jar`
