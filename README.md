...
- Build date: 2024-12-06T19:31:54.632349Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.63.jar`
- `target/lib/*.jar`
