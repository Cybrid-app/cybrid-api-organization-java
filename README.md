...
- Build date: 2023-06-19T14:09:50.426689Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.25.jar`
- `target/lib/*.jar`
