...
- Build date: 2023-10-25T13:02:11.382321Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.16.jar`
- `target/lib/*.jar`
