...
- Build date: 2024-04-18T23:11:35.812489Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.108"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.108.jar`
- `target/lib/*.jar`
