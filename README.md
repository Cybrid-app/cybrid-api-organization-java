...
- Build date: 2024-02-22T18:55:15.166571Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.11.jar`
- `target/lib/*.jar`
