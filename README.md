...
- Build date: 2025-03-07T01:08:00.221908Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.280"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.280.jar`
- `target/lib/*.jar`
