...
- Build date: 2023-07-24T23:34:02.231367Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.16.jar`
- `target/lib/*.jar`
