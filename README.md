...
- Build date: 2022-05-30T13:57:54.717592Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.10.jar`
- `target/lib/*.jar`
