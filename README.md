...
- Build date: 2023-09-18T10:52:34.091558Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.13.jar`
- `target/lib/*.jar`
