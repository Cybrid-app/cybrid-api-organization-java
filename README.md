...
- Build date: 2025-05-15T18:56:45.524828Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.487"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.487.jar`
- `target/lib/*.jar`
