...
- Build date: 2025-05-29T16:11:13.213439Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.536"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.536.jar`
- `target/lib/*.jar`
