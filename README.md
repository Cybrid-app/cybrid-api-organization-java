...
- Build date: 2024-10-02T20:45:47.231035Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.164"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.164.jar`
- `target/lib/*.jar`
