...
- Build date: 2023-10-10T16:09:44.381556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.98.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.98.2.jar`
- `target/lib/*.jar`
