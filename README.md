...
- Build date: 2024-10-02T13:36:49.878689Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.160"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.160.jar`
- `target/lib/*.jar`
