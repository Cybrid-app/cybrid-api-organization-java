...
- Build date: 2022-05-03T11:03:11.506435Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.14.jar`
- `target/lib/*.jar`
