...
- Build date: 2022-06-12T03:46:51.172101Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.24.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.24.6.jar`
- `target/lib/*.jar`
