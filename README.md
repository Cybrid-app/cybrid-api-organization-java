...
- Build date: 2023-12-10T21:31:34.112583Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.24.jar`
- `target/lib/*.jar`
