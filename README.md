...
- Build date: 2024-04-15T16:14:50.731139Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.96"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.96.jar`
- `target/lib/*.jar`
