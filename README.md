...
- Build date: 2022-06-03T19:47:07.014717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.7.jar`
- `target/lib/*.jar`
