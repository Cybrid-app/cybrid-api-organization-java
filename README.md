...
- Build date: 2025-03-07T14:40:45.173300Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.282"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.282.jar`
- `target/lib/*.jar`
