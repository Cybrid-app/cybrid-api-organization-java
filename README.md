...
- Build date: 2023-08-16T02:00:30.002030Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.11.jar`
- `target/lib/*.jar`
