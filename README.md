...
- Build date: 2024-04-09T15:35:15.508315Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.71.jar`
- `target/lib/*.jar`
