...
- Build date: 2023-06-07T14:54:19.941333Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.72.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.72.0.jar`
- `target/lib/*.jar`
