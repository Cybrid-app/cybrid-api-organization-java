...
- Build date: 2023-06-06T19:24:03.023743Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.69.jar`
- `target/lib/*.jar`
