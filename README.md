...
- Build date: 2023-11-29T14:16:51.269330Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.8.jar`
- `target/lib/*.jar`
