...
- Build date: 2025-05-07T18:31:59.911629Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.460"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.460.jar`
- `target/lib/*.jar`
