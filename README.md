...
- Build date: 2024-09-26T14:18:51.489507Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.141"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.141.jar`
- `target/lib/*.jar`
