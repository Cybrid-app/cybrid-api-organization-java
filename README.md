...
- Build date: 2024-09-23T12:22:15.109823Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.131"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.131.jar`
- `target/lib/*.jar`
