...
- Build date: 2023-07-26T16:55:28.437721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.80.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.80.5.jar`
- `target/lib/*.jar`
