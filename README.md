...
- Build date: 2025-01-14T21:05:04.443342Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.142"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.142.jar`
- `target/lib/*.jar`
