...
- Build date: 2024-06-10T15:53:36.744586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.14.jar`
- `target/lib/*.jar`
