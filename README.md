...
- Build date: 2023-10-26T16:37:29.108060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.21.jar`
- `target/lib/*.jar`
