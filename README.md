...
- Build date: 2023-10-18T12:12:51.799473Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.108.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.108.1.jar`
- `target/lib/*.jar`
