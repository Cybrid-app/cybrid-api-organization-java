...
- Build date: 2024-12-03T13:55:22.434805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.46.jar`
- `target/lib/*.jar`
