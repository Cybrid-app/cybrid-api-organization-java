...
- Build date: 2024-10-17T21:13:28.648027Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.17.jar`
- `target/lib/*.jar`
