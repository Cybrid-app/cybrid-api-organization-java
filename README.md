...
- Build date: 2023-10-02T19:39:16.136835Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.53.jar`
- `target/lib/*.jar`
