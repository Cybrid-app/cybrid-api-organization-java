...
- Build date: 2024-06-26T14:38:46.954810Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.45.jar`
- `target/lib/*.jar`
