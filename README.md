...
- Build date: 2022-05-03T10:44:34.933797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.13.jar`
- `target/lib/*.jar`
