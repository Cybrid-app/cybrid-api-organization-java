...
- Build date: 2025-06-16T19:39:46.479124Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.595"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.595.jar`
- `target/lib/*.jar`
