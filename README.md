...
- Build date: 2023-10-03T22:38:31.841695Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.56.jar`
- `target/lib/*.jar`
