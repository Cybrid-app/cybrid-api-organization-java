...
- Build date: 2023-07-18T15:21:14.838928Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.20.jar`
- `target/lib/*.jar`
