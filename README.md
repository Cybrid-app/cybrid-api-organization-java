...
- Build date: 2023-09-05T16:51:09.552306Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.1.jar`
- `target/lib/*.jar`
