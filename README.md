...
- Build date: 2024-12-06T21:52:53.786657Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.64.jar`
- `target/lib/*.jar`
