...
- Build date: 2025-03-07T16:27:56.383741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.284"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.284.jar`
- `target/lib/*.jar`
