...
- Build date: 2023-11-14T13:45:32.005813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.56.jar`
- `target/lib/*.jar`
