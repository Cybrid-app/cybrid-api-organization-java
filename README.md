...
- Build date: 2024-11-08T13:47:46.718476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.42.jar`
- `target/lib/*.jar`
