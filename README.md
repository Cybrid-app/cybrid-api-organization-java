...
- Build date: 2025-01-06T16:22:51.040764Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.125"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.125.jar`
- `target/lib/*.jar`
