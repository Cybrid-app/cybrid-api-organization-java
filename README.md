...
- Build date: 2023-08-14T15:32:09.148783Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.2.jar`
- `target/lib/*.jar`
