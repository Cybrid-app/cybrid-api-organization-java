...
- Build date: 2024-02-12T18:14:48.010147Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.140"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.140.jar`
- `target/lib/*.jar`
