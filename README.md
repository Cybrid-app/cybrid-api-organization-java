...
- Build date: 2023-09-07T11:14:00.379544Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.9.jar`
- `target/lib/*.jar`
