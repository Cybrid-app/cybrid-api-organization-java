...
- Build date: 2023-07-13T15:19:03.313716Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.7.jar`
- `target/lib/*.jar`
