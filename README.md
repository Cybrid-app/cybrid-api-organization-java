...
- Build date: 2022-05-16T14:08:50.152586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.7.jar`
- `target/lib/*.jar`
