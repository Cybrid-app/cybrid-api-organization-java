...
- Build date: 2024-03-23T04:01:49.978603Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.32.jar`
- `target/lib/*.jar`
