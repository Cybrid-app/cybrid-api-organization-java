...
- Build date: 2023-08-15T23:15:01.416857Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.10.jar`
- `target/lib/*.jar`
