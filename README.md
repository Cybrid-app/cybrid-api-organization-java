...
- Build date: 2022-06-06T14:58:36.267324Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.15.jar`
- `target/lib/*.jar`
