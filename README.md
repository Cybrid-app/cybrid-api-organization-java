...
- Build date: 2025-05-14T14:37:55.636038Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.478"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.478.jar`
- `target/lib/*.jar`
