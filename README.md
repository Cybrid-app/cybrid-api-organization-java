...
- Build date: 2023-10-23T15:55:58.685251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.11.jar`
- `target/lib/*.jar`
