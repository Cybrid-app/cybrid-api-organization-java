...
- Build date: 2022-06-14T02:56:26.696335Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.25.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.25.0.jar`
- `target/lib/*.jar`
