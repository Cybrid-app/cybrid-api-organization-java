...
- Build date: 2022-06-01T23:32:48.521408Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.2.jar`
- `target/lib/*.jar`
