...
- Build date: 2025-01-03T22:56:22.957700Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.120"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.120.jar`
- `target/lib/*.jar`
