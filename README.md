...
- Build date: 2025-05-26T19:12:02.440814Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.526"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.526.jar`
- `target/lib/*.jar`
