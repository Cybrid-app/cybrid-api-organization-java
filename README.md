...
- Build date: 2024-06-03T12:09:37.939855Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.28.jar`
- `target/lib/*.jar`
