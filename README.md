...
- Build date: 2025-06-26T17:58:55.667679Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.646"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.646.jar`
- `target/lib/*.jar`
