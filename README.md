...
- Build date: 2024-04-19T14:59:06.145438Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.111"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.111.jar`
- `target/lib/*.jar`
