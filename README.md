...
- Build date: 2024-03-29T12:53:22.102518Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.50.jar`
- `target/lib/*.jar`
