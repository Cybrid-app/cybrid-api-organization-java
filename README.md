...
- Build date: 2024-11-14T17:50:55.941885Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.68.jar`
- `target/lib/*.jar`
