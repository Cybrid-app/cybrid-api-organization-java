...
- Build date: 2023-11-09T21:03:35.455991Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.45.jar`
- `target/lib/*.jar`
