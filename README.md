...
- Build date: 2023-11-06T13:16:52.917310Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.37.jar`
- `target/lib/*.jar`
