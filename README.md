...
- Build date: 2023-08-14T17:44:05.120514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.3.jar`
- `target/lib/*.jar`
