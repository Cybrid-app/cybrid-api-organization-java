...
- Build date: 2023-06-15T15:21:30.322565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.17.jar`
- `target/lib/*.jar`
