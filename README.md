...
- Build date: 2024-02-02T13:49:51.022133Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.115"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.115.jar`
- `target/lib/*.jar`
