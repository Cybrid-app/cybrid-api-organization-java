...
- Build date: 2024-12-27T17:48:10.936046Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.109"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.109.jar`
- `target/lib/*.jar`
