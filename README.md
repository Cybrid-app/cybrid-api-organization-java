...
- Build date: 2024-01-05T20:27:51.296215Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.53.jar`
- `target/lib/*.jar`
