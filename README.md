...
- Build date: 2024-12-12T18:18:25.624210Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.80"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.80.jar`
- `target/lib/*.jar`
