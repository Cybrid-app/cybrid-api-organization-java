...
- Build date: 2025-02-24T23:09:26.876120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.252"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.252.jar`
- `target/lib/*.jar`
