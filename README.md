...
- Build date: 2024-06-13T13:36:03.882912Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.22.jar`
- `target/lib/*.jar`
