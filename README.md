...
- Build date: 2022-06-14T17:32:19.812101Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.26.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.26.1.jar`
- `target/lib/*.jar`
