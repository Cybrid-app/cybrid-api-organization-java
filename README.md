...
- Build date: 2023-12-12T14:00:26.293916Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.34.jar`
- `target/lib/*.jar`
