...
- Build date: 2022-05-27T18:25:01.337164Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.5.jar`
- `target/lib/*.jar`
