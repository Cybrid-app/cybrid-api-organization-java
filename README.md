...
- Build date: 2024-05-27T17:29:44.139965Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.16.jar`
- `target/lib/*.jar`
