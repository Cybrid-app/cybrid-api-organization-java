...
- Build date: 2023-07-20T13:35:41.626446Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.6.jar`
- `target/lib/*.jar`
