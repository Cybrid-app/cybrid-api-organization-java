...
- Build date: 2024-01-20T17:27:56.194441Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.81"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.81.jar`
- `target/lib/*.jar`
