...
- Build date: 2025-03-13T18:14:50.636428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.294"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.294.jar`
- `target/lib/*.jar`
