...
- Build date: 2024-05-10T17:01:14.732418Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.149"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.149.jar`
- `target/lib/*.jar`
