...
- Build date: 2024-02-09T16:17:47.108111Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.131"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.131.jar`
- `target/lib/*.jar`
