...
- Build date: 2024-05-27T19:22:36.579852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.17.jar`
- `target/lib/*.jar`
