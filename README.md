...
- Build date: 2022-05-27T13:10:17.047049Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.1.jar`
- `target/lib/*.jar`
