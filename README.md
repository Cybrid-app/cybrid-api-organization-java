...
- Build date: 2023-04-12T15:18:14.793335Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.38.jar`
- `target/lib/*.jar`
