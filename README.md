...
- Build date: 2023-07-12T14:36:46.833245Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.4.jar`
- `target/lib/*.jar`
