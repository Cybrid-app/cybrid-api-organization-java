...
- Build date: 2023-09-15T13:00:29.251651Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.9.jar`
- `target/lib/*.jar`
