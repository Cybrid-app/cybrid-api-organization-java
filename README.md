...
- Build date: 2024-11-05T14:06:11.962332Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.29.jar`
- `target/lib/*.jar`
