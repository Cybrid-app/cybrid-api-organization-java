...
- Build date: 2025-03-17T20:49:59.756825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.299"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.299.jar`
- `target/lib/*.jar`
