...
- Build date: 2025-05-27T15:39:38.774535Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.529"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.529.jar`
- `target/lib/*.jar`
