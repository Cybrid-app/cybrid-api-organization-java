...
- Build date: 2023-05-29T12:42:02.029926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.55.jar`
- `target/lib/*.jar`
