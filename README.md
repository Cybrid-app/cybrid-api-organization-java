...
- Build date: 2025-05-06T17:00:12.102064Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.456"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.456.jar`
- `target/lib/*.jar`
