...
- Build date: 2023-07-05T11:57:48.819226Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.5.jar`
- `target/lib/*.jar`
