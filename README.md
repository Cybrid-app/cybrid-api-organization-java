...
- Build date: 2025-01-07T13:59:28.119950Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.126"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.126.jar`
- `target/lib/*.jar`
