...
- Build date: 2024-02-15T14:03:06.602556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.150"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.150.jar`
- `target/lib/*.jar`
