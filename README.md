...
- Build date: 2023-11-10T13:11:17.969774Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.48.jar`
- `target/lib/*.jar`
