...
- Build date: 2024-02-26T13:57:44.291120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.17.jar`
- `target/lib/*.jar`
