...
- Build date: 2024-11-08T21:27:22.727675Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.49.jar`
- `target/lib/*.jar`
