...
- API version: v0.115.59

- Build date: 2024-04-04T18:15:09.767535Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.59.jar`
- `target/lib/*.jar`
