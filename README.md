...
- Build date: 2025-05-28T13:26:03.987811Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.531"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.531.jar`
- `target/lib/*.jar`
