...
- Build date: 2025-03-27T20:56:13.205196Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.334"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.334.jar`
- `target/lib/*.jar`
