...
- Build date: 2025-05-12T12:37:13.133174Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.474"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.474.jar`
- `target/lib/*.jar`
