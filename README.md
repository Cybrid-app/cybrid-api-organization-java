...
- Build date: 2024-05-21T15:42:08.264705Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.0.jar`
- `target/lib/*.jar`
