...
- Build date: 2025-06-19T21:56:22.562341Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.613"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.613.jar`
- `target/lib/*.jar`
