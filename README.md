...
- Build date: 2023-05-30T13:12:53.939067Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.58"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.58.jar`
- `target/lib/*.jar`
