...
- Build date: 2024-07-31T23:29:05.153181Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.115"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.115.jar`
- `target/lib/*.jar`
