...
- Build date: 2024-01-25T13:11:26.957540Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.94"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.94.jar`
- `target/lib/*.jar`
