...
- Build date: 2023-07-31T16:55:50.566111Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.7.jar`
- `target/lib/*.jar`
