...
- Build date: 2025-03-21T22:19:05.437879Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.317"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.317.jar`
- `target/lib/*.jar`
