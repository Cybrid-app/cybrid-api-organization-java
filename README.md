...
- Build date: 2024-02-16T17:26:10.594686Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.0.jar`
- `target/lib/*.jar`
