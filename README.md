...
- Build date: 2024-10-23T14:56:05.330787Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.38.jar`
- `target/lib/*.jar`
