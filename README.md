...
- Build date: 2023-08-19T13:32:23.023931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.3.jar`
- `target/lib/*.jar`
