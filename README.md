...
- Build date: 2025-05-09T21:20:39.697970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.472"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.472.jar`
- `target/lib/*.jar`
