...
- Build date: 2025-04-16T15:49:49.797824Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.397"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.397.jar`
- `target/lib/*.jar`
