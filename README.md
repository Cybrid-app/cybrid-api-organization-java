...
- Build date: 2024-07-25T16:55:21.332799Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.95"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.95.jar`
- `target/lib/*.jar`
