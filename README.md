...
- Build date: 2024-09-16T17:26:21.040755Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.99"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.99.jar`
- `target/lib/*.jar`
