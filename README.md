...
- Build date: 2022-05-27T20:18:20.354843Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.8.jar`
- `target/lib/*.jar`
