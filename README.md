...
- Build date: 2023-10-19T13:27:33.898830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.5.jar`
- `target/lib/*.jar`
