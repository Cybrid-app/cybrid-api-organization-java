...
- Build date: 2024-05-12T19:01:07.363798Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.151"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.151.jar`
- `target/lib/*.jar`
