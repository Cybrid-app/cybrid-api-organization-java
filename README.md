...
- Build date: 2023-12-14T16:47:35.173696Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.5.jar`
- `target/lib/*.jar`
