...
- Build date: 2023-09-26T11:21:13.254805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.35.jar`
- `target/lib/*.jar`
