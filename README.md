...
- Build date: 2024-01-25T14:23:44.328648Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.95"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.95.jar`
- `target/lib/*.jar`
