...
- Build date: 2024-10-09T21:20:43.126159Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.16.jar`
- `target/lib/*.jar`
