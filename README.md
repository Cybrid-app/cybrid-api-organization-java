...
- Build date: 2023-12-10T22:45:34.346567Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.25.jar`
- `target/lib/*.jar`
