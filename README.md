...
- Build date: 2022-05-04T13:56:51.698274Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.28.jar`
- `target/lib/*.jar`
