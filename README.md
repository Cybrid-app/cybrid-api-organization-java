...
- Build date: 2025-06-06T19:39:08.231634Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.558"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.558.jar`
- `target/lib/*.jar`
