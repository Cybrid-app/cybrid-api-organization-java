...
- Build date: 2024-02-14T20:24:25.842274Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.146"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.146.jar`
- `target/lib/*.jar`
