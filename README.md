...
- Build date: 2024-09-10T14:05:45.482496Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.79"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.79.jar`
- `target/lib/*.jar`
