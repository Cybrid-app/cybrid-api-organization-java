...
- Build date: 2022-05-31T14:52:49.162519Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.17.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.17.1.jar`
- `target/lib/*.jar`
