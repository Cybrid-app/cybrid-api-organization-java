...
- Build date: 2025-03-09T18:22:25.564624Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.286"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.286.jar`
- `target/lib/*.jar`
