...
- Build date: 2025-04-09T18:26:14.299319Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.371"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.371.jar`
- `target/lib/*.jar`
