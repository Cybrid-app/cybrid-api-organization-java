...
- Build date: 2023-09-22T18:07:20.898836Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.30.jar`
- `target/lib/*.jar`
