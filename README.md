...
- Build date: 2024-12-23T17:22:56.314942Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.104"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.104.jar`
- `target/lib/*.jar`
