...
- Build date: 2024-03-04T20:51:48.724813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.37.jar`
- `target/lib/*.jar`
