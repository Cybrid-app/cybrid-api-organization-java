...
- Build date: 2024-05-07T23:41:51.565469Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.142"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.142.jar`
- `target/lib/*.jar`
