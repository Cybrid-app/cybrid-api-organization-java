...
- Build date: 2024-04-10T15:35:27.452937Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.78"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.78.jar`
- `target/lib/*.jar`
