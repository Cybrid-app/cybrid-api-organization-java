...
- Build date: 2025-06-11T15:49:34.904180Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.574"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.574.jar`
- `target/lib/*.jar`
