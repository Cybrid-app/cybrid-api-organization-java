...
- Build date: 2024-02-15T12:36:01.313666Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.149"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.149.jar`
- `target/lib/*.jar`
