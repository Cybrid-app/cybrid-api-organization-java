...
- Build date: 2025-02-04T16:39:04.740542Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.197"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.197.jar`
- `target/lib/*.jar`
