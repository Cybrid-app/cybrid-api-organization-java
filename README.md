...
- Build date: 2023-06-16T18:59:05.807797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.22.jar`
- `target/lib/*.jar`
