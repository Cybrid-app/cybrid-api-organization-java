...
- Build date: 2025-01-02T18:39:35.705150Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.117"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.117.jar`
- `target/lib/*.jar`
