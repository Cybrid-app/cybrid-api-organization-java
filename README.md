...
- Build date: 2024-09-30T19:18:20.435809Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.154"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.154.jar`
- `target/lib/*.jar`
