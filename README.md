...
- Build date: 2023-06-27T23:01:25.970746Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.20.jar`
- `target/lib/*.jar`
