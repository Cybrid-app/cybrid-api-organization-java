...
- Build date: 2025-04-18T18:24:12.605055Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.406"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.406.jar`
- `target/lib/*.jar`
