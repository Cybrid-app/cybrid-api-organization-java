...
- Build date: 2025-06-13T20:57:48.953260Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.586"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.586.jar`
- `target/lib/*.jar`
