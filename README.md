...
- Build date: 2024-08-15T18:05:42.623387Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.25.jar`
- `target/lib/*.jar`
