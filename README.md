...
- Build date: 2024-10-02T15:03:28.659749Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.161"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.161.jar`
- `target/lib/*.jar`
