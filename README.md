...
- Build date: 2023-12-14T15:39:40.362418Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.4.jar`
- `target/lib/*.jar`
