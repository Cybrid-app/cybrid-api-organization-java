...
- Build date: 2023-10-20T11:47:20.630667Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.8.jar`
- `target/lib/*.jar`
