...
- Build date: 2024-01-26T13:47:49.146101Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.99"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.99.jar`
- `target/lib/*.jar`
