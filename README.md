...
- Build date: 2025-05-27T17:06:26.289215Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.530"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.530.jar`
- `target/lib/*.jar`
