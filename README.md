...
- Build date: 2024-05-22T17:05:37.016341Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.6.jar`
- `target/lib/*.jar`
