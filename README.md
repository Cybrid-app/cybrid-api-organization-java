...
- Build date: 2023-11-27T16:32:05.166724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.2.jar`
- `target/lib/*.jar`
