...
- Build date: 2025-03-26T12:30:31.286565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.327"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.327.jar`
- `target/lib/*.jar`
