...
- Build date: 2024-12-04T14:13:22.916586Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.51.jar`
- `target/lib/*.jar`
