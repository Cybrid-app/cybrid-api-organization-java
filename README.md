...
- Build date: 2025-05-09T20:37:15.994514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.471"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.471.jar`
- `target/lib/*.jar`
