...
- Build date: 2023-11-09T22:40:19.211668Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.47.jar`
- `target/lib/*.jar`
