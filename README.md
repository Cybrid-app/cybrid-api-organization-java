...
- Build date: 2023-07-06T18:59:43.275863Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.5.jar`
- `target/lib/*.jar`
