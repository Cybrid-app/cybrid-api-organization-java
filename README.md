...
- Build date: 2024-09-26T15:39:37.359857Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.143"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.143.jar`
- `target/lib/*.jar`
