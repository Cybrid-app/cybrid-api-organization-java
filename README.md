...
- Build date: 2024-09-18T14:07:14.769809Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.110"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.110.jar`
- `target/lib/*.jar`
