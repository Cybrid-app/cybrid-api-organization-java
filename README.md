...
- Build date: 2025-01-08T22:54:54.607439Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.129"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.129.jar`
- `target/lib/*.jar`
