...
- Build date: 2025-03-25T13:39:09.704557Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.323"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.323.jar`
- `target/lib/*.jar`
