...
- Build date: 2024-11-18T18:47:56.180172Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.4.jar`
- `target/lib/*.jar`
