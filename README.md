...
- Build date: 2024-04-12T13:31:53.172737Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.89"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.89.jar`
- `target/lib/*.jar`
