...
- Build date: 2024-12-20T13:52:18.705829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.100"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.100.jar`
- `target/lib/*.jar`
