...
- Build date: 2023-05-09T19:06:23.077538Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.8.jar`
- `target/lib/*.jar`
