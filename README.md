...
- Build date: 2025-04-10T21:41:13.711810Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.378"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.378.jar`
- `target/lib/*.jar`
