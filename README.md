...
- Build date: 2024-12-16T18:57:39.081104Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.90"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.90.jar`
- `target/lib/*.jar`
