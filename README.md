...
- Build date: 2022-05-26T10:46:38.973539Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.16.jar`
- `target/lib/*.jar`
