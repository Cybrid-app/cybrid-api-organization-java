...
- Build date: 2023-04-26T12:44:24.304323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.64.jar`
- `target/lib/*.jar`
