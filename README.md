...
- Build date: 2023-12-06T18:16:12.088757Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.12.jar`
- `target/lib/*.jar`
