...
- Build date: 2023-04-13T21:17:15.097693Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.47.jar`
- `target/lib/*.jar`
