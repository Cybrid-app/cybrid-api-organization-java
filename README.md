...
- Build date: 2023-05-26T14:18:06.746463Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.51.jar`
- `target/lib/*.jar`
