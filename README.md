...
- Build date: 2024-09-11T21:09:09.450488Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.85"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.85.jar`
- `target/lib/*.jar`
