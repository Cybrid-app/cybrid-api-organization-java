...
- Build date: 2024-08-15T16:53:51.943807Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.24.jar`
- `target/lib/*.jar`
