...
- Build date: 2024-08-07T00:51:01.700166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.7.jar`
- `target/lib/*.jar`
