...
- Build date: 2022-05-05T11:17:51.061808Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.31.jar`
- `target/lib/*.jar`
