...
- Build date: 2025-02-26T18:05:47.847220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.261"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.261.jar`
- `target/lib/*.jar`
