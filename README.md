...
- Build date: 2023-04-13T16:53:08.703213Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.44.jar`
- `target/lib/*.jar`
