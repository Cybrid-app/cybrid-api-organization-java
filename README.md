...
- Build date: 2024-02-10T18:50:20.479174Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.135"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.135.jar`
- `target/lib/*.jar`
