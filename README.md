...
- Build date: 2023-08-31T12:14:49.567952Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.90.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.90.0.jar`
- `target/lib/*.jar`
