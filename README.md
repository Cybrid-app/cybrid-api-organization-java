...
- Build date: 2023-08-22T12:02:06.295624Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.7.jar`
- `target/lib/*.jar`
