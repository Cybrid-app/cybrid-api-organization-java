...
- Build date: 2024-05-10T15:26:38.574945Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.148"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.148.jar`
- `target/lib/*.jar`
