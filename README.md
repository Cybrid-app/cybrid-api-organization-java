...
- Build date: 2024-04-22T16:15:28.694428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.115"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.115.jar`
- `target/lib/*.jar`
