...
- Build date: 2025-04-17T13:08:43.891064Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.402"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.402.jar`
- `target/lib/*.jar`
