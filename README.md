...
- Build date: 2025-01-15T22:46:41.968123Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.145"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.145.jar`
- `target/lib/*.jar`
