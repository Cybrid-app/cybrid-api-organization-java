...
- Build date: 2025-03-18T12:51:47.462526Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.303"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.303.jar`
- `target/lib/*.jar`
