...
- Build date: 2023-06-15T13:40:37.247010Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.15.jar`
- `target/lib/*.jar`
