...
- Build date: 2025-01-04T17:35:06.911652Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.121"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.121.jar`
- `target/lib/*.jar`
