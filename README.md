...
- Build date: 2023-11-03T12:59:07.671084Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.34.jar`
- `target/lib/*.jar`
