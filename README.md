...
- Build date: 2024-11-08T14:51:59.736032Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.43.jar`
- `target/lib/*.jar`
