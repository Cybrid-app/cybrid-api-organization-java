...
- Build date: 2024-08-12T17:37:20.715374Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.11.jar`
- `target/lib/*.jar`
