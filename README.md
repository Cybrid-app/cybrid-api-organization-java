...
- Build date: 2025-03-14T17:21:07.273231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.297"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.297.jar`
- `target/lib/*.jar`
