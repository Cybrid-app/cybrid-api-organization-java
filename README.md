...
- Build date: 2023-04-11T20:20:55.898875Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.36.jar`
- `target/lib/*.jar`
