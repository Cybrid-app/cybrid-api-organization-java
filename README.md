...
- Build date: 2023-12-07T14:11:28.397406Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.13.jar`
- `target/lib/*.jar`
