...
- Build date: 2025-06-14T12:57:42.429293Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.588"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.588.jar`
- `target/lib/*.jar`
