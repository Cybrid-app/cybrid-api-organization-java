...
- Build date: 2023-07-07T11:35:03.599765Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.6.jar`
- `target/lib/*.jar`
