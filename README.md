...
- Build date: 2023-07-12T18:29:25.723418Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.5.jar`
- `target/lib/*.jar`
