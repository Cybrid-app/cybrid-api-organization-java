...
- Build date: 2025-05-21T21:06:50.509490Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.512"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.512.jar`
- `target/lib/*.jar`
