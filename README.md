...
- Build date: 2022-05-20T14:05:36.171109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.4.jar`
- `target/lib/*.jar`
