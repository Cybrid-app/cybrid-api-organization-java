...
- Build date: 2022-05-02T18:53:20.936915Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.12.jar`
- `target/lib/*.jar`
