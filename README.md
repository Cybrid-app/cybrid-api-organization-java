...
- Build date: 2023-08-03T14:27:42.484922Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.27.jar`
- `target/lib/*.jar`
