...
- Build date: 2023-04-14T18:52:47.737155Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.50.jar`
- `target/lib/*.jar`
