...
- Build date: 2025-05-15T16:28:28.793110Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.485"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.485.jar`
- `target/lib/*.jar`
