...
- Build date: 2024-07-04T17:11:40.915289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.65.jar`
- `target/lib/*.jar`
