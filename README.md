...
- Build date: 2024-10-03T20:21:45.987604Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.168"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.168.jar`
- `target/lib/*.jar`
