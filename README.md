...
- Build date: 2023-08-02T13:11:00.216704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.24.jar`
- `target/lib/*.jar`
