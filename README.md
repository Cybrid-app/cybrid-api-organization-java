...
- Build date: 2024-04-19T13:39:16.441886Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.109"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.109.jar`
- `target/lib/*.jar`
