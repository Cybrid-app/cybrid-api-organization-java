...
- Build date: 2023-12-07T22:30:23.925597Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.14.jar`
- `target/lib/*.jar`
