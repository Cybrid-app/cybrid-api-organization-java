...
- Build date: 2024-12-30T23:02:34.489921Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.114"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.114.jar`
- `target/lib/*.jar`
