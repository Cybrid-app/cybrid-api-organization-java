...
- Build date: 2025-03-06T16:09:22.190043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.275"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.275.jar`
- `target/lib/*.jar`
