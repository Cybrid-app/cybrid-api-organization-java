...
- Build date: 2023-08-15T21:25:55.877216Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.9.jar`
- `target/lib/*.jar`
