...
- Build date: 2024-04-23T20:52:32.467375Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.117"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.117.jar`
- `target/lib/*.jar`
