...
- Build date: 2023-10-12T16:52:29.170615Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.105.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.105.0.jar`
- `target/lib/*.jar`
