...
- Build date: 2023-09-12T13:16:02.729485Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.93.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.93.5.jar`
- `target/lib/*.jar`
