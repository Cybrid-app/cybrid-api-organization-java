...
- Build date: 2024-01-26T19:26:31.840934Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.103"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.103.jar`
- `target/lib/*.jar`
