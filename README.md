...
- Build date: 2025-06-10T14:18:22.292876Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.569"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.569.jar`
- `target/lib/*.jar`
