...
- Build date: 2023-05-09T14:35:04.014588Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.3.jar`
- `target/lib/*.jar`
