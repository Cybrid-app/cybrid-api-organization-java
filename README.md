...
- Build date: 2024-09-09T16:01:13.580579Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.74"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.74.jar`
- `target/lib/*.jar`
