...
- Build date: 2023-08-01T20:31:31.830556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.21.jar`
- `target/lib/*.jar`
