...
- Build date: 2024-04-15T20:36:51.491009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.98"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.98.jar`
- `target/lib/*.jar`
