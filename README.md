...
- Build date: 2023-04-26T21:50:38.731893Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.67.jar`
- `target/lib/*.jar`
