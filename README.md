...
- Build date: 2024-09-28T00:15:30.251813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.149"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.149.jar`
- `target/lib/*.jar`
