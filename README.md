...
- Build date: 2023-05-15T20:48:31.202491Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.23.jar`
- `target/lib/*.jar`
