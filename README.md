...
- Build date: 2023-06-23T13:04:39.721837Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.4.jar`
- `target/lib/*.jar`
