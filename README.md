...
- Build date: 2023-09-29T22:53:37.912842Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.50.jar`
- `target/lib/*.jar`
