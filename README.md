...
- Build date: 2025-05-08T12:27:26.272604Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.463"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.463.jar`
- `target/lib/*.jar`
