...
- Build date: 2024-01-11T13:20:18.076944Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.61.jar`
- `target/lib/*.jar`
