...
- Build date: 2025-04-14T15:54:01.940021Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.384"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.384.jar`
- `target/lib/*.jar`
