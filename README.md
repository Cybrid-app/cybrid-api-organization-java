...
- Build date: 2025-06-19T14:01:38.767541Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.605"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.605.jar`
- `target/lib/*.jar`
