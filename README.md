...
- Build date: 2023-06-07T16:22:39.308639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.0.jar`
- `target/lib/*.jar`
