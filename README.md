...
- Build date: 2023-05-09T16:00:37.316360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.5.jar`
- `target/lib/*.jar`
