...
- Build date: 2025-04-23T15:46:22.849005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.416"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.416.jar`
- `target/lib/*.jar`
