...
- Build date: 2025-02-06T17:49:35.826217Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.216"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.216.jar`
- `target/lib/*.jar`
