...
- Build date: 2023-06-30T11:53:13.629764Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.25.jar`
- `target/lib/*.jar`
