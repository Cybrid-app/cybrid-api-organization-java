...
- Build date: 2024-09-12T19:57:30.379400Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.92"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.92.jar`
- `target/lib/*.jar`
