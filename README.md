...
- Build date: 2024-07-25T23:03:56.555552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.100"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.100.jar`
- `target/lib/*.jar`
