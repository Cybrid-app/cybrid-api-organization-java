...
- Build date: 2023-08-01T17:17:38.193084Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.18.jar`
- `target/lib/*.jar`
