...
- Build date: 2022-05-26T11:10:30.974771Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.17.jar`
- `target/lib/*.jar`
