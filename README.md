...
- API version: v0.117.24

- Build date: 2024-05-31T15:13:10.558905Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.24.jar`
- `target/lib/*.jar`
