...
- Build date: 2024-08-19T18:33:50.181437Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.31.jar`
- `target/lib/*.jar`
