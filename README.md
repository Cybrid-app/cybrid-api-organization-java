...
- Build date: 2023-12-09T17:57:26.924594Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.22.jar`
- `target/lib/*.jar`
