...
- Build date: 2024-03-10T17:03:18.476738Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.6.jar`
- `target/lib/*.jar`
