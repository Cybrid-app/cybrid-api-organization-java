...
- Build date: 2022-05-19T10:34:07.060610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.12.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.12.2.jar`
- `target/lib/*.jar`
