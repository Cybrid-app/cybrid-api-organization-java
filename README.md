...
- Build date: 2024-10-18T14:41:04.447353Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.21.jar`
- `target/lib/*.jar`
