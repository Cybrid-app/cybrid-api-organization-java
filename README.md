...
- Build date: 2024-04-09T12:24:49.669588Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.69.jar`
- `target/lib/*.jar`
