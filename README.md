...
- Build date: 2024-11-07T20:51:31.220445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.38.jar`
- `target/lib/*.jar`
