...
- Build date: 2023-09-14T16:59:35.133177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.7.jar`
- `target/lib/*.jar`
