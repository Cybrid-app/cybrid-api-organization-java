...
- Build date: 2024-12-13T22:17:40.920362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.87"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.87.jar`
- `target/lib/*.jar`
