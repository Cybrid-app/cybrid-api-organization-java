...
- Build date: 2025-01-02T14:25:58.473083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.116"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.116.jar`
- `target/lib/*.jar`
