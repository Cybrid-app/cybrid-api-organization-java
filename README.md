...
- Build date: 2025-03-31T19:38:19.032779Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.344"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.344.jar`
- `target/lib/*.jar`
