...
- Build date: 2024-08-14T13:11:07.897895Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.18.jar`
- `target/lib/*.jar`
