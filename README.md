...
- Build date: 2023-06-02T13:14:40.440441Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.65.jar`
- `target/lib/*.jar`
