...
- Build date: 2025-04-16T22:18:50.763223Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.401"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.401.jar`
- `target/lib/*.jar`
