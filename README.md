...
- Build date: 2024-12-06T16:07:09.417213Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.62"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.62.jar`
- `target/lib/*.jar`
