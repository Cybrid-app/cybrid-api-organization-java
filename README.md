...
- API version: v0.118.51

- Build date: 2024-06-26T21:31:43.441254Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.51.jar`
- `target/lib/*.jar`
