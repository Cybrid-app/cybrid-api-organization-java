...
- Build date: 2024-08-05T18:52:56.215840Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.4.jar`
- `target/lib/*.jar`
