...
- Build date: 2023-07-17T22:16:43.517340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.15.jar`
- `target/lib/*.jar`
