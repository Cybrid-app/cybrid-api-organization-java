...
- Build date: 2024-07-31T13:23:46.641856Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.113"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.113.jar`
- `target/lib/*.jar`
