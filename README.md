...
- Build date: 2025-05-15T18:18:48.386442Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.486"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.486.jar`
- `target/lib/*.jar`
