...
- Build date: 2025-03-02T12:40:39.515374Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.266"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.266.jar`
- `target/lib/*.jar`
