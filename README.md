...
- Build date: 2024-06-10T17:17:46.123070Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.15.jar`
- `target/lib/*.jar`
