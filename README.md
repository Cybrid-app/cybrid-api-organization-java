...
- Build date: 2024-01-12T14:32:48.559836Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.62"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.62.jar`
- `target/lib/*.jar`
