...
- Build date: 2025-03-24T15:12:13.015199Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.319"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.319.jar`
- `target/lib/*.jar`
