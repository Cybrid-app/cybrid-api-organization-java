...
- Build date: 2024-08-28T16:19:36.035292Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.51.jar`
- `target/lib/*.jar`
