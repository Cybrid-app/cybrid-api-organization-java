...
- Build date: 2023-12-19T18:01:07.920580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.23.jar`
- `target/lib/*.jar`
