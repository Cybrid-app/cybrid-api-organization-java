...
- Build date: 2023-10-19T11:52:49.314544Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.3.jar`
- `target/lib/*.jar`
