...
- Build date: 2023-06-04T13:22:38.507426Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.67.jar`
- `target/lib/*.jar`
