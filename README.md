...
- Build date: 2023-09-06T16:29:05.800453Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.7.jar`
- `target/lib/*.jar`
