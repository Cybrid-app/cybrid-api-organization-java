...
- Build date: 2023-11-09T12:25:02.056641Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.43.jar`
- `target/lib/*.jar`
