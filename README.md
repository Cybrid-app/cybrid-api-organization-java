...
- Build date: 2023-05-02T12:41:08.850603Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.75"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.75.jar`
- `target/lib/*.jar`
