...
- Build date: 2022-05-09T11:40:36.495042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.5.jar`
- `target/lib/*.jar`
