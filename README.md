...
- Build date: 2024-02-02T15:21:35.417577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.116"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.116.jar`
- `target/lib/*.jar`
