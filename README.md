...
- Build date: 2024-04-10T13:54:22.820060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.76"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.76.jar`
- `target/lib/*.jar`
