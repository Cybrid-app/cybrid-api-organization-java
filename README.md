...
- Build date: 2025-02-19T17:30:08.859165Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.243"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.243.jar`
- `target/lib/*.jar`
