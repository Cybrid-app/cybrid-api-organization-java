...
- Build date: 2025-05-26T20:50:20.052506Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.527"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.527.jar`
- `target/lib/*.jar`
