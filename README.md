...
- Build date: 2023-05-16T12:41:55.392220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.24.jar`
- `target/lib/*.jar`
