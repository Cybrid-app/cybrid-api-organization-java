...
- Build date: 2024-04-11T19:21:54.298988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.86"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.86.jar`
- `target/lib/*.jar`
