...
- Build date: 2024-12-09T21:45:25.678486Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.68.jar`
- `target/lib/*.jar`
