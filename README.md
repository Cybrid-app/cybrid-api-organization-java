...
- Build date: 2023-11-23T14:47:35.334206Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.22.jar`
- `target/lib/*.jar`
