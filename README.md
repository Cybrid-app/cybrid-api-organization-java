...
- Build date: 2023-04-13T15:25:51.369263Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.42.jar`
- `target/lib/*.jar`
