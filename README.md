...
- Build date: 2025-02-26T14:31:58.195840Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.259"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.259.jar`
- `target/lib/*.jar`
