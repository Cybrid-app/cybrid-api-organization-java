...
- Build date: 2023-05-09T22:16:23.073936Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.9.jar`
- `target/lib/*.jar`
