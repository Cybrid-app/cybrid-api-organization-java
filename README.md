...
- Build date: 2022-06-08T15:10:46.877633Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.23.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.23.0.jar`
- `target/lib/*.jar`
