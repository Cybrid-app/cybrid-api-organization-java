...
- Build date: 2023-08-14T20:20:36.715986Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.4.jar`
- `target/lib/*.jar`
