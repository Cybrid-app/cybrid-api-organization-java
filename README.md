...
- Build date: 2024-03-22T20:28:23.827169Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.30.jar`
- `target/lib/*.jar`
