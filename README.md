...
- Build date: 2022-06-03T18:23:46.530826Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.5.jar`
- `target/lib/*.jar`
