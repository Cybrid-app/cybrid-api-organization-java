...
- Build date: 2024-10-19T18:05:28.038969Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.28.jar`
- `target/lib/*.jar`
