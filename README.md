...
- Build date: 2025-06-19T13:15:11.721304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.604"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.604.jar`
- `target/lib/*.jar`
