...
- Build date: 2024-04-16T13:33:15.040737Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.100"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.100.jar`
- `target/lib/*.jar`
