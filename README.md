...
- Build date: 2023-10-05T16:05:50.847251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.7.jar`
- `target/lib/*.jar`
