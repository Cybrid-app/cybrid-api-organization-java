...
- Build date: 2024-02-23T15:30:36.762709Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.13.jar`
- `target/lib/*.jar`
