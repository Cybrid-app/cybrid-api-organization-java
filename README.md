...
- Build date: 2022-06-08T13:53:40.298373Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.8.jar`
- `target/lib/*.jar`
