...
- Build date: 2024-05-21T22:26:50.892835Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.2.jar`
- `target/lib/*.jar`
