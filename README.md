...
- Build date: 2023-06-14T16:36:26.464110Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.12.jar`
- `target/lib/*.jar`
