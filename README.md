...
- Build date: 2024-01-19T20:34:35.904197Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.78"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.78.jar`
- `target/lib/*.jar`
