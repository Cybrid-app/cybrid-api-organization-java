...
- Build date: 2025-05-06T19:21:19.053005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.457"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.457.jar`
- `target/lib/*.jar`
