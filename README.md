...
- Build date: 2025-05-21T15:13:42.902545Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.508"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.508.jar`
- `target/lib/*.jar`
