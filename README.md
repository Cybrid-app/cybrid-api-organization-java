...
- Build date: 2024-01-03T22:04:17.409751Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.46.jar`
- `target/lib/*.jar`
