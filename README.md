...
- Build date: 2023-09-08T11:53:14.652301Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.92.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.92.1.jar`
- `target/lib/*.jar`
