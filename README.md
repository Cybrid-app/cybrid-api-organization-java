...
- Build date: 2024-10-24T14:02:24.818009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.41.jar`
- `target/lib/*.jar`
