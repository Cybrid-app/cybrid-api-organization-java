...
- Build date: 2023-12-05T15:57:05.596371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.6.jar`
- `target/lib/*.jar`
