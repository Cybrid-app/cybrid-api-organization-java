...
- Build date: 2024-09-12T13:45:57.857001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.86"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.86.jar`
- `target/lib/*.jar`
