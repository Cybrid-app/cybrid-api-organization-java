...
- Build date: 2023-07-31T20:24:47.709559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.8.jar`
- `target/lib/*.jar`
