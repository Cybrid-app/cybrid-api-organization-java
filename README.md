...
- Build date: 2024-02-06T15:56:52.691942Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.121"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.121.jar`
- `target/lib/*.jar`
