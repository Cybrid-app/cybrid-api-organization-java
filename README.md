...
- Build date: 2025-05-20T20:28:20.057638Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.503"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.503.jar`
- `target/lib/*.jar`
