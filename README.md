...
- Build date: 2024-03-06T21:34:13.992806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.44.jar`
- `target/lib/*.jar`
