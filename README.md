...
- Build date: 2025-03-06T16:59:09.683001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.276"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.276.jar`
- `target/lib/*.jar`
