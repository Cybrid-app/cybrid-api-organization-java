...
- Build date: 2024-10-21T15:35:02.899955Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.30.jar`
- `target/lib/*.jar`
