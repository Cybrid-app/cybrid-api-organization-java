...
- Build date: 2023-05-05T12:17:53.735523Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.88"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.88.jar`
- `target/lib/*.jar`
