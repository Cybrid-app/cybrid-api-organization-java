...
- Build date: 2025-04-07T19:28:23.402948Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.363"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.363.jar`
- `target/lib/*.jar`
