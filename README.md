...
- Build date: 2024-10-29T23:13:30.799364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.55.jar`
- `target/lib/*.jar`
