...
- Build date: 2022-05-04T11:13:10.582075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.27.jar`
- `target/lib/*.jar`
