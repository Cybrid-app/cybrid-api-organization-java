...
- API version: v0.123.157

- Build date: 2025-01-22T16:47:53.250371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.157"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.157.jar`
- `target/lib/*.jar`
