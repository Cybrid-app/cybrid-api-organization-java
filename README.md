...
- Build date: 2023-09-07T11:59:34.247849Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.10.jar`
- `target/lib/*.jar`
