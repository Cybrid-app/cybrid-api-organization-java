...
- Build date: 2023-05-09T15:18:19.181467Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.4.jar`
- `target/lib/*.jar`
