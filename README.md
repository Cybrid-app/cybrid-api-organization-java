...
- Build date: 2024-03-09T04:39:02.460953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.5.jar`
- `target/lib/*.jar`
