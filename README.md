...
- Build date: 2024-10-03T13:45:15.848342Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.166"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.166.jar`
- `target/lib/*.jar`
