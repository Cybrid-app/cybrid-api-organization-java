...
- Build date: 2024-05-02T15:24:23.352302Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.134"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.134.jar`
- `target/lib/*.jar`
