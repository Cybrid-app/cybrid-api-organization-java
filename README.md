...
- Build date: 2024-01-30T21:21:09.424280Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.109"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.109.jar`
- `target/lib/*.jar`
