...
- Build date: 2024-10-30T13:49:03.274593Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.3.jar`
- `target/lib/*.jar`
