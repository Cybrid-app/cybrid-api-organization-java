...
- Build date: 2025-03-14T12:56:04.672086Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.296"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.296.jar`
- `target/lib/*.jar`
