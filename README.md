...
- Build date: 2024-03-25T22:32:08.331238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.37.jar`
- `target/lib/*.jar`
