...
- Build date: 2025-02-03T18:07:40.917342Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.189"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.189.jar`
- `target/lib/*.jar`
