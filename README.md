...
- Build date: 2023-05-24T12:10:34.082538Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.37.jar`
- `target/lib/*.jar`
