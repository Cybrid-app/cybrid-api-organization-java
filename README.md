...
- Build date: 2024-07-26T18:03:11.827391Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.102"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.102.jar`
- `target/lib/*.jar`
