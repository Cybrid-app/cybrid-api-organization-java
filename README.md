...
- Build date: 2024-10-19T13:52:47.536804Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.26.jar`
- `target/lib/*.jar`
