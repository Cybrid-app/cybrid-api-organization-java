...
- Build date: 2023-11-14T17:34:44.743897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.58"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.58.jar`
- `target/lib/*.jar`
