...
- Build date: 2024-09-12T19:17:59.101221Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.91.jar`
- `target/lib/*.jar`
