...
- Build date: 2024-09-26T17:32:40.173817Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.144"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.144.jar`
- `target/lib/*.jar`
