...
- Build date: 2023-07-10T17:41:39.482149Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.9.jar`
- `target/lib/*.jar`
