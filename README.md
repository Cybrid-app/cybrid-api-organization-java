...
- Build date: 2024-09-10T20:52:35.343911Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.83"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.83.jar`
- `target/lib/*.jar`
