...
- Build date: 2022-05-13T17:45:33.990028Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.7.jar`
- `target/lib/*.jar`
