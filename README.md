...
- Build date: 2023-05-22T15:59:43.489247Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.30.jar`
- `target/lib/*.jar`
