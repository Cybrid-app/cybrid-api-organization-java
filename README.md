...
- Build date: 2023-06-07T13:58:14.805750Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.72.jar`
- `target/lib/*.jar`
