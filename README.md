...
- Build date: 2024-06-26T19:00:25.920753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.50.jar`
- `target/lib/*.jar`
