...
- Build date: 2023-09-29T17:32:14.817514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.49.jar`
- `target/lib/*.jar`
