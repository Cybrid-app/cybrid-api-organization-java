...
- Build date: 2022-05-31T10:30:43.785255Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.16.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.16.2.jar`
- `target/lib/*.jar`
