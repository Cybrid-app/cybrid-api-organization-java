...
- Build date: 2022-05-17T15:34:13.433647Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.9.jar`
- `target/lib/*.jar`
