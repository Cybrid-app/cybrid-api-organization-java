...
- Build date: 2025-01-14T23:24:41.533519Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.143"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.143.jar`
- `target/lib/*.jar`
