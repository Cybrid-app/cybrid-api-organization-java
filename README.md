...
- Build date: 2024-11-12T16:33:37.388222Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.59.jar`
- `target/lib/*.jar`
