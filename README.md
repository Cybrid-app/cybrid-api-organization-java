...
- Build date: 2024-02-02T17:28:31.029170Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.118"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.118.jar`
- `target/lib/*.jar`
