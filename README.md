...
- Build date: 2023-06-28T18:36:56.468261Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.22.jar`
- `target/lib/*.jar`
