...
- Build date: 2025-04-21T16:47:58.727755Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.407"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.407.jar`
- `target/lib/*.jar`
