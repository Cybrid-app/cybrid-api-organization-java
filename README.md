...
- Build date: 2024-02-20T16:47:40.080931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.2.jar`
- `target/lib/*.jar`
