...
- Build date: 2024-02-14T23:29:04.821980Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.148"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.148.jar`
- `target/lib/*.jar`
