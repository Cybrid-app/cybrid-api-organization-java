...
- Build date: 2024-01-23T16:13:44.684078Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.89"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.89.jar`
- `target/lib/*.jar`
