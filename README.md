...
- Build date: 2023-05-23T12:04:31.395805Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.31.jar`
- `target/lib/*.jar`
