...
- Build date: 2024-10-10T15:34:46.537926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.18.jar`
- `target/lib/*.jar`
