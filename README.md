...
- Build date: 2023-11-15T20:29:47.177268Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.1.jar`
- `target/lib/*.jar`
