...
- Build date: 2025-05-14T21:33:56.987509Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.481"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.481.jar`
- `target/lib/*.jar`
