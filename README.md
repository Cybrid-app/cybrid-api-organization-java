...
- Build date: 2024-09-19T20:20:58.817456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.119"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.119.jar`
- `target/lib/*.jar`
