...
- Build date: 2023-07-11T19:09:52.737231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.1.jar`
- `target/lib/*.jar`
