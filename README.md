...
- Build date: 2023-11-20T17:15:21.331107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.10.jar`
- `target/lib/*.jar`
