...
- Build date: 2025-04-07T13:39:01.666734Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.359"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.359.jar`
- `target/lib/*.jar`
