...
- Build date: 2023-05-13T15:07:35.954916Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.20.jar`
- `target/lib/*.jar`
