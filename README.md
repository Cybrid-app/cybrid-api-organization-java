...
- Build date: 2024-07-25T17:49:57.528135Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.96"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.96.jar`
- `target/lib/*.jar`
