...
- Build date: 2024-06-04T19:11:42.636257Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.2.jar`
- `target/lib/*.jar`
