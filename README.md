...
- Build date: 2024-02-27T20:03:20.716954Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.21.jar`
- `target/lib/*.jar`
