...
- Build date: 2024-02-20T19:42:58.858758Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.3.jar`
- `target/lib/*.jar`
