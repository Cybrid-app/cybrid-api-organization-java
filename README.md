...
- Build date: 2023-10-03T16:01:18.324029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.55.jar`
- `target/lib/*.jar`
