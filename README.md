...
- Build date: 2024-05-30T15:41:30.159573Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.21.jar`
- `target/lib/*.jar`
