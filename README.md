...
- Build date: 2025-01-20T15:35:55.030445Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.153"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.153.jar`
- `target/lib/*.jar`
