...
- Build date: 2024-01-26T15:35:53.299508Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.100"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.100.jar`
- `target/lib/*.jar`
