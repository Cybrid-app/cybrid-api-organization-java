...
- Build date: 2024-03-21T15:53:44.830542Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.24.jar`
- `target/lib/*.jar`
