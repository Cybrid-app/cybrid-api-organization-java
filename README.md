...
- API version: v0.78.12

- Build date: 2023-07-17T13:24:51.984947Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.12.jar`
- `target/lib/*.jar`
