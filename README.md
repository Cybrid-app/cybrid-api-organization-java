...
- Build date: 2022-05-16T10:44:24.238287Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.1.jar`
- `target/lib/*.jar`
