...
- API version: v0.117.19

- Build date: 2024-05-28T12:33:28.757515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.19.jar`
- `target/lib/*.jar`
