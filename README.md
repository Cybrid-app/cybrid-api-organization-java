...
- Build date: 2023-10-11T19:11:10.149546Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.103.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.103.1.jar`
- `target/lib/*.jar`
