...
- Build date: 2024-08-20T15:17:21.369435Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.35.jar`
- `target/lib/*.jar`
