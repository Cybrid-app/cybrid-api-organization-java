...
- Build date: 2022-05-20T13:47:43.066830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.3.jar`
- `target/lib/*.jar`
