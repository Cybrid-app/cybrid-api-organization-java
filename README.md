...
- Build date: 2024-05-22T13:58:09.718186Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.4.jar`
- `target/lib/*.jar`
