...
- Build date: 2025-06-13T11:43:24.842318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.581"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.581.jar`
- `target/lib/*.jar`
