...
- Build date: 2025-02-24T21:20:29.810449Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.251"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.251.jar`
- `target/lib/*.jar`
