...
- Build date: 2024-12-03T15:35:13.974173Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.48.jar`
- `target/lib/*.jar`
