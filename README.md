...
- Build date: 2024-10-04T19:02:58.830684Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.2.jar`
- `target/lib/*.jar`
