...
- Build date: 2022-05-04T10:11:47.853800Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.24.jar`
- `target/lib/*.jar`
