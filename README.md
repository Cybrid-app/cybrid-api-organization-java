...
- Build date: 2024-04-08T00:39:30.944007Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.64.jar`
- `target/lib/*.jar`
