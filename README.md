...
- Build date: 2023-05-15T14:41:46.899168Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.22.jar`
- `target/lib/*.jar`
