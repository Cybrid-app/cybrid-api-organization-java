...
- Build date: 2024-10-07T15:30:36.594710Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.9.jar`
- `target/lib/*.jar`
