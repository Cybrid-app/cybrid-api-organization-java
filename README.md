...
- Build date: 2023-06-15T18:24:43.749640Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.18.jar`
- `target/lib/*.jar`
