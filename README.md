...
- Build date: 2024-09-04T17:56:45.523084Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.65.jar`
- `target/lib/*.jar`
