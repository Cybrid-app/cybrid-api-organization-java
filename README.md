...
- Build date: 2024-11-04T15:39:21.584719Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.24.jar`
- `target/lib/*.jar`
