...
- Build date: 2023-11-30T12:10:07.606770Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.15.jar`
- `target/lib/*.jar`
