...
- Build date: 2024-03-27T14:07:17.771199Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.42.jar`
- `target/lib/*.jar`
