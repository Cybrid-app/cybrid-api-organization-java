...
- Build date: 2024-08-02T19:38:29.464622Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.120"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.120.jar`
- `target/lib/*.jar`
