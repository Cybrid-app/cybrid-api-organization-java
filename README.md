...
- Build date: 2023-05-01T12:38:29.184077Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.73"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.73.jar`
- `target/lib/*.jar`
