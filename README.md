...
- Build date: 2023-10-19T16:57:10.252829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.7.jar`
- `target/lib/*.jar`
