...
- Build date: 2024-03-08T20:51:42.279255Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.0.jar`
- `target/lib/*.jar`
