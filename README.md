...
- Build date: 2024-09-28T01:43:47.410461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.150"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.150.jar`
- `target/lib/*.jar`
