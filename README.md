...
- Build date: 2024-11-06T13:39:41.393039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.33.jar`
- `target/lib/*.jar`
