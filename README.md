...
- Build date: 2023-06-15T12:01:08.588534Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.14.jar`
- `target/lib/*.jar`
