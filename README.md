...
- Build date: 2024-01-24T13:57:03.456456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.91.jar`
- `target/lib/*.jar`
