...
- Build date: 2024-09-11T14:15:31.124214Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.84"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.84.jar`
- `target/lib/*.jar`
