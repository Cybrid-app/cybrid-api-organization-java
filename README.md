...
- Build date: 2025-03-30T13:19:45.640237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.341"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.341.jar`
- `target/lib/*.jar`
