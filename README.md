...
- Build date: 2025-06-19T12:34:23.764629Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.603"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.603.jar`
- `target/lib/*.jar`
