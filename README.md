...
- Build date: 2024-07-22T19:50:35.059072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.86"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.86.jar`
- `target/lib/*.jar`
