...
- Build date: 2024-04-17T13:42:28.435518Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.105"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.105.jar`
- `target/lib/*.jar`
