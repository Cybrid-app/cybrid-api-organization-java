...
- Build date: 2022-05-31T10:51:11.871947Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.16.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.16.3.jar`
- `target/lib/*.jar`
