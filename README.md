...
- API version: v0.115.135

- Build date: 2024-05-02T16:27:08.078353Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.135"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.135.jar`
- `target/lib/*.jar`
