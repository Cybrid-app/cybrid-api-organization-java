...
- Build date: 2025-06-26T00:13:36.364452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.642"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.642.jar`
- `target/lib/*.jar`
