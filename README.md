...
- Build date: 2024-03-09T02:07:37.893213Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.4.jar`
- `target/lib/*.jar`
