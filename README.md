...
- Build date: 2023-08-08T03:03:05.976082Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.5.jar`
- `target/lib/*.jar`
