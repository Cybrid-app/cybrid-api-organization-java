...
- Build date: 2023-04-17T12:58:40.401931Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.51.jar`
- `target/lib/*.jar`
