...
- Build date: 2023-12-15T22:25:00.999697Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.11.jar`
- `target/lib/*.jar`
