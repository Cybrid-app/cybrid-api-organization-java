...
- Build date: 2024-04-26T12:36:27.472069Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.124"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.124.jar`
- `target/lib/*.jar`
