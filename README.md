...
- Build date: 2024-08-14T20:34:29.058284Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.22.jar`
- `target/lib/*.jar`
