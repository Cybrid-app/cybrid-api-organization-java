...
- Build date: 2024-11-13T22:46:43.958106Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.66"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.66.jar`
- `target/lib/*.jar`
