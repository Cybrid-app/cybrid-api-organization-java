...
- Build date: 2025-06-27T13:41:59.356438Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.648"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.648.jar`
- `target/lib/*.jar`
