...
- Build date: 2024-02-29T18:43:15.524749Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.28.jar`
- `target/lib/*.jar`
