...
- Build date: 2022-05-13T18:57:37.098564Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.9.jar`
- `target/lib/*.jar`
