...
- Build date: 2024-07-25T13:41:05.624834Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.92"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.92.jar`
- `target/lib/*.jar`
