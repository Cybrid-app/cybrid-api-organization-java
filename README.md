...
- Build date: 2023-04-25T12:05:40.963075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.62"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.62.jar`
- `target/lib/*.jar`
