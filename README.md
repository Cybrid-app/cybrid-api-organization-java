...
- Build date: 2025-02-26T01:44:54.724715Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.258"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.258.jar`
- `target/lib/*.jar`
