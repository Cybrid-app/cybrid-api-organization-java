...
- Build date: 2024-06-03T20:43:05.195610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.1.jar`
- `target/lib/*.jar`
