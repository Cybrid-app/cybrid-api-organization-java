...
- Build date: 2023-05-30T18:55:21.910317Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.59.jar`
- `target/lib/*.jar`
