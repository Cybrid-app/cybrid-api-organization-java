...
- Build date: 2023-08-23T20:03:00.033896Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.6.jar`
- `target/lib/*.jar`
