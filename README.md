...
- Build date: 2022-05-26T13:57:22.703305Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.18.jar`
- `target/lib/*.jar`
