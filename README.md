...
- Build date: 2024-08-05T12:21:20.632223Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.1.jar`
- `target/lib/*.jar`
