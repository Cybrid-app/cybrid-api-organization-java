...
- Build date: 2024-11-05T19:08:22.158762Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.32.jar`
- `target/lib/*.jar`
