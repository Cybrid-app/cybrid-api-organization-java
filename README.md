...
- Build date: 2023-05-17T15:01:16.609406Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.25.jar`
- `target/lib/*.jar`
