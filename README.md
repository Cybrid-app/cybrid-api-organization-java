...
- Build date: 2022-06-06T14:03:20.055989Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.14.jar`
- `target/lib/*.jar`
