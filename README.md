...
- Build date: 2023-12-17T23:27:47.575247Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.12.jar`
- `target/lib/*.jar`
