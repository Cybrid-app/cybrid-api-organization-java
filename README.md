...
- Build date: 2023-12-12T18:15:35.219001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.37.jar`
- `target/lib/*.jar`
