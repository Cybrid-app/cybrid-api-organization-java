...
- Build date: 2023-06-21T12:00:27.344375Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.35.jar`
- `target/lib/*.jar`
