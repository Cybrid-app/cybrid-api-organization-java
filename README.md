...
- Build date: 2025-02-26T20:52:01.441643Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.263"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.263.jar`
- `target/lib/*.jar`
