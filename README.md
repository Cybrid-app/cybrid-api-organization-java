...
- Build date: 2023-09-12T15:29:26.255593Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.0.jar`
- `target/lib/*.jar`
