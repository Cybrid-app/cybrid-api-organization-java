...
- Build date: 2024-08-21T16:10:19.782076Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.38.jar`
- `target/lib/*.jar`
