...
- Build date: 2025-06-28T17:04:49.447754Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.650"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.650.jar`
- `target/lib/*.jar`
