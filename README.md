...
- Build date: 2025-04-21T20:59:18.926816Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.409"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.409.jar`
- `target/lib/*.jar`
