...
- Build date: 2024-10-05T18:07:57.099361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.5.jar`
- `target/lib/*.jar`
