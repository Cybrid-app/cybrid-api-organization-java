...
- Build date: 2025-02-04T21:06:41.390682Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.203"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.203.jar`
- `target/lib/*.jar`
