...
- Build date: 2023-09-04T21:44:04.004893Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.90.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.90.9.jar`
- `target/lib/*.jar`
