...
- Build date: 2025-05-05T20:44:18.228862Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.451"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.451.jar`
- `target/lib/*.jar`
