...
- Build date: 2024-01-16T22:53:28.855602Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.68.jar`
- `target/lib/*.jar`
