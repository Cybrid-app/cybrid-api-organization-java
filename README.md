...
- Build date: 2024-12-07T02:41:22.570685Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.65.jar`
- `target/lib/*.jar`
