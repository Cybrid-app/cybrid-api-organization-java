...
- Build date: 2023-06-22T12:11:34.024391Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.41.jar`
- `target/lib/*.jar`
