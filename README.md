...
- Build date: 2024-08-14T14:33:06.121672Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.19.jar`
- `target/lib/*.jar`
