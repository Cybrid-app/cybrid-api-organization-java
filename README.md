...
- Build date: 2023-09-04T11:15:01.822903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.90.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.90.8.jar`
- `target/lib/*.jar`
