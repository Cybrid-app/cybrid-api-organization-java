...
- Build date: 2022-05-24T14:03:37.710068Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.6.jar`
- `target/lib/*.jar`
