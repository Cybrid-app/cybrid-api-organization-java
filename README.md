...
- Build date: 2024-12-04T16:26:54.796096Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.53.jar`
- `target/lib/*.jar`
