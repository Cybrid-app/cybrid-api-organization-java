...
- Build date: 2024-02-27T13:50:27.117684Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.19.jar`
- `target/lib/*.jar`
