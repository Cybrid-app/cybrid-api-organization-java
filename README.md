...
- Build date: 2023-05-02T15:45:33.840057Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.77"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.77.jar`
- `target/lib/*.jar`
