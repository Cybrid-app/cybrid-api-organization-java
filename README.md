...
- Build date: 2024-11-04T14:40:10.701661Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.23.jar`
- `target/lib/*.jar`
