...
- Build date: 2022-05-21T05:42:40.618008Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.5.jar`
- `target/lib/*.jar`
