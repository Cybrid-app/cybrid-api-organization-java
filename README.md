...
- Build date: 2025-05-13T14:24:41.454478Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.477"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.477.jar`
- `target/lib/*.jar`
