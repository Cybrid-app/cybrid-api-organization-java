...
- Build date: 2024-01-11T03:06:53.763102Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.60"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.60.jar`
- `target/lib/*.jar`
