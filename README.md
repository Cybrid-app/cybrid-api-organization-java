...
- Build date: 2024-10-15T14:21:15.083443Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.5.jar`
- `target/lib/*.jar`
