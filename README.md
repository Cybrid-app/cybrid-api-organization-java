...
- Build date: 2025-06-09T15:42:09.623138Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.563"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.563.jar`
- `target/lib/*.jar`
