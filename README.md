...
- Build date: 2023-10-05T21:55:56.479479Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.96.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.96.0.jar`
- `target/lib/*.jar`
