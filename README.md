...
- Build date: 2025-05-16T20:03:02.870594Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.496"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.496.jar`
- `target/lib/*.jar`
