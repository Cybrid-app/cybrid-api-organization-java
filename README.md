...
- Build date: 2025-05-29T15:31:34.442570Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.535"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.535.jar`
- `target/lib/*.jar`
