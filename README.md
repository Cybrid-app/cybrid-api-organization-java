...
- Build date: 2024-09-17T20:41:34.025789Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.107"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.107.jar`
- `target/lib/*.jar`
