...
- Build date: 2023-10-23T15:20:44.987086Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.10.jar`
- `target/lib/*.jar`
