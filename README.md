...
- Build date: 2022-06-08T13:00:45.710514Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.7.jar`
- `target/lib/*.jar`
