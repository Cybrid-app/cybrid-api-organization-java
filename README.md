...
- API version: v0.115.140

- Build date: 2024-05-06T19:29:16.389090Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.140"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.140.jar`
- `target/lib/*.jar`
