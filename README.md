...
- Build date: 2024-06-07T20:56:41.943807Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.13.jar`
- `target/lib/*.jar`
