...
- Build date: 2023-04-24T19:02:42.781622Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.61.jar`
- `target/lib/*.jar`
