...
- Build date: 2024-07-25T15:37:10.713987Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.94"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.94.jar`
- `target/lib/*.jar`
