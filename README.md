...
- Build date: 2023-10-16T13:10:12.845210Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.5.jar`
- `target/lib/*.jar`
