...
- Build date: 2025-06-11T19:28:43.620552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.577"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.577.jar`
- `target/lib/*.jar`
