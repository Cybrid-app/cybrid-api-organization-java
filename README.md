...
- Build date: 2023-08-03T15:05:59.819202Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.28.jar`
- `target/lib/*.jar`
