...
- Build date: 2024-11-16T20:06:34.107945Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.72.jar`
- `target/lib/*.jar`
