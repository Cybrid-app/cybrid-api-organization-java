...
- Build date: 2025-05-23T13:58:47.317319Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.519"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.519.jar`
- `target/lib/*.jar`
