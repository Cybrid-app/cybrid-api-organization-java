...
- Build date: 2024-10-04T15:38:26.329410Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.171"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.171.jar`
- `target/lib/*.jar`
