...
- Build date: 2024-12-18T17:02:11.860813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.96"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.96.jar`
- `target/lib/*.jar`
