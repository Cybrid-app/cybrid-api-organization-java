...
- Build date: 2023-12-04T19:17:57.196561Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.3.jar`
- `target/lib/*.jar`
