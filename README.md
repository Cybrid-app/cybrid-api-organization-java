...
- Build date: 2022-06-06T12:57:59.334406Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.13.jar`
- `target/lib/*.jar`
