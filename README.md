...
- Build date: 2024-10-05T19:05:55.153471Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.6.jar`
- `target/lib/*.jar`
