...
- Build date: 2023-11-03T19:02:40.378933Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.36.jar`
- `target/lib/*.jar`
