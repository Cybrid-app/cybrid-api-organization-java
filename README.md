...
- Build date: 2023-06-22T23:37:38.482663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.2.jar`
- `target/lib/*.jar`
