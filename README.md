...
- Build date: 2024-09-24T16:23:11.455891Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.136"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.136.jar`
- `target/lib/*.jar`
