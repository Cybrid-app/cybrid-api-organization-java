...
- Build date: 2025-02-03T21:11:43.235111Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.191"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.191.jar`
- `target/lib/*.jar`
