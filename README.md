...
- Build date: 2024-06-26T18:22:10.133420Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.49.jar`
- `target/lib/*.jar`
