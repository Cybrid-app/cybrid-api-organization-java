...
- Build date: 2025-06-19T19:48:41.222596Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.611"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.611.jar`
- `target/lib/*.jar`
