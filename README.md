...
- Build date: 2024-03-22T14:57:57.624864Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.26.jar`
- `target/lib/*.jar`
