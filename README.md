...
- Build date: 2023-10-06T13:31:04.382901Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.97.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.97.0.jar`
- `target/lib/*.jar`
