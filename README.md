...
- Build date: 2023-11-24T13:17:37.723073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.26.jar`
- `target/lib/*.jar`
