...
- Build date: 2025-01-20T14:41:44.226261Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.152"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.152.jar`
- `target/lib/*.jar`
