...
- Build date: 2024-08-01T18:17:37.545629Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.118"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.118.jar`
- `target/lib/*.jar`
