...
- Build date: 2024-03-04T13:49:05.930837Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.35.jar`
- `target/lib/*.jar`
