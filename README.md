...
- Build date: 2023-06-14T11:38:47.309735Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.9.jar`
- `target/lib/*.jar`
