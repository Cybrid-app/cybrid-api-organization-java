...
- Build date: 2022-05-05T15:11:38.947432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.4.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.4.1.jar`
- `target/lib/*.jar`
