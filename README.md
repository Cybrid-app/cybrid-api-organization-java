...
- Build date: 2025-05-26T14:25:09.773546Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.523"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.523.jar`
- `target/lib/*.jar`
