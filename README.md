...
- Build date: 2023-12-22T14:56:25.641454Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.38.jar`
- `target/lib/*.jar`
