...
- Build date: 2024-10-30T13:07:35.129354Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.2.jar`
- `target/lib/*.jar`
