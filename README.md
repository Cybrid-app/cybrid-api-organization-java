...
- Build date: 2023-06-22T00:01:49.253850Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.39.jar`
- `target/lib/*.jar`
