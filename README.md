...
- Build date: 2022-06-14T14:26:04.976069Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.25.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.25.2.jar`
- `target/lib/*.jar`
