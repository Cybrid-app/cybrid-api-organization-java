...
- Build date: 2025-06-30T15:22:10.899708Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.652"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.652.jar`
- `target/lib/*.jar`
