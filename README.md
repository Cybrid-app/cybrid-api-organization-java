...
- Build date: 2025-06-26T16:03:31.181643Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.644"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.644.jar`
- `target/lib/*.jar`
