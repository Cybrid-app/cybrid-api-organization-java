...
- Build date: 2022-05-05T13:18:51.546541Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.32.jar`
- `target/lib/*.jar`
