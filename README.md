...
- Build date: 2023-05-03T18:54:58.143198Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.84"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.84.jar`
- `target/lib/*.jar`
