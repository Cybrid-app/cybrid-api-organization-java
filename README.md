...
- Build date: 2022-05-18T19:51:02.620610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.12.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.12.0.jar`
- `target/lib/*.jar`
