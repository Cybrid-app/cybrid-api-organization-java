...
- Build date: 2022-05-10T12:56:52.181257Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.12.jar`
- `target/lib/*.jar`
