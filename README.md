...
- Build date: 2023-06-02T14:11:19.043361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.66"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.66.jar`
- `target/lib/*.jar`
