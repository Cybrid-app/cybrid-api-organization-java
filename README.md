...
- Build date: 2025-02-19T16:42:33.000996Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.242"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.242.jar`
- `target/lib/*.jar`
