...
- Build date: 2023-08-10T18:12:49.057158Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.7.jar`
- `target/lib/*.jar`
