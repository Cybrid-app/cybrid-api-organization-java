...
- Build date: 2025-02-21T22:50:23.916291Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.247"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.247.jar`
- `target/lib/*.jar`
