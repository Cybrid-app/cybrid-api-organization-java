...
- Build date: 2023-09-20T16:04:00.557728Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.23.jar`
- `target/lib/*.jar`
