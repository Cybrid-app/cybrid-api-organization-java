...
- Build date: 2025-04-23T10:38:03.939342Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.413"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.413.jar`
- `target/lib/*.jar`
