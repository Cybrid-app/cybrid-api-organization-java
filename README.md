...
- Build date: 2023-04-18T17:13:52.724845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.55.jar`
- `target/lib/*.jar`
