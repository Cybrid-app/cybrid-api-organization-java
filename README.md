...
- Build date: 2023-08-11T17:57:09.285177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.12.jar`
- `target/lib/*.jar`
