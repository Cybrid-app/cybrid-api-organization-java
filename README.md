...
- Build date: 2024-09-19T02:16:37.954621Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.116"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.116.jar`
- `target/lib/*.jar`
