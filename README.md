...
- Build date: 2025-05-08T22:26:58.423304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.468"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.468.jar`
- `target/lib/*.jar`
