...
- Build date: 2024-10-04T20:08:21.293495Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.3.jar`
- `target/lib/*.jar`
