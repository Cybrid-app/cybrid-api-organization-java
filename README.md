...
- Build date: 2023-08-24T17:29:12.867237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.1.jar`
- `target/lib/*.jar`
