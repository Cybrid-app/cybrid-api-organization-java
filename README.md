...
- Build date: 2024-09-30T13:55:28.849762Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.152"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.152.jar`
- `target/lib/*.jar`
