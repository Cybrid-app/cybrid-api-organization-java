...
- Build date: 2024-03-27T17:53:12.898713Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.44.jar`
- `target/lib/*.jar`
