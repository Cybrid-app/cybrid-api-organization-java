...
- Build date: 2024-07-30T15:37:03.652526Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.110"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.110.jar`
- `target/lib/*.jar`
