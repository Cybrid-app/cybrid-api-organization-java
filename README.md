...
- Build date: 2024-02-23T20:06:59.968351Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.16.jar`
- `target/lib/*.jar`
