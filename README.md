...
- Build date: 2023-11-02T23:50:19.698563Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.33.jar`
- `target/lib/*.jar`
