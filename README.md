...
- Build date: 2025-03-12T13:25:05.728834Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.290"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.290.jar`
- `target/lib/*.jar`
