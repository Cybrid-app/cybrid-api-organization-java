...
- Build date: 2024-01-23T14:44:18.518359Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.88"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.88.jar`
- `target/lib/*.jar`
