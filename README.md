...
- Build date: 2023-11-22T13:21:51.952803Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.17.jar`
- `target/lib/*.jar`
