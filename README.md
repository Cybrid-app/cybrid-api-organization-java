...
- Build date: 2023-08-12T14:21:13.403301Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.13.jar`
- `target/lib/*.jar`
