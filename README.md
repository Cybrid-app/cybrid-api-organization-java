...
- Build date: 2023-10-31T13:58:46.954977Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.27.jar`
- `target/lib/*.jar`
