...
- Build date: 2025-05-08T20:16:00.665577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.466"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.466.jar`
- `target/lib/*.jar`
