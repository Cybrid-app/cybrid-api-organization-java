...
- Build date: 2024-06-03T18:03:28.910664Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.0.jar`
- `target/lib/*.jar`
