...
- Build date: 2022-05-24T11:34:36.112569Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.3.jar`
- `target/lib/*.jar`
