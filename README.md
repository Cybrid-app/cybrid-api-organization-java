...
- Build date: 2025-04-23T13:49:02.557661Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.415"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.415.jar`
- `target/lib/*.jar`
