...
- Build date: 2024-10-12T17:55:54.890476Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.2.jar`
- `target/lib/*.jar`
