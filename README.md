...
- Build date: 2023-09-27T13:02:24.681361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.41.jar`
- `target/lib/*.jar`
