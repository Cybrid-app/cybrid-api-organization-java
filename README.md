...
- Build date: 2023-11-29T12:48:23.624398Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.7.jar`
- `target/lib/*.jar`
