...
- Build date: 2023-11-29T01:36:45.216290Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.5.jar`
- `target/lib/*.jar`
