...
- Build date: 2023-08-25T15:18:54.517195Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.8.jar`
- `target/lib/*.jar`
