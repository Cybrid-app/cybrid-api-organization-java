...
- Build date: 2023-07-05T20:20:44.754631Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.3.jar`
- `target/lib/*.jar`
