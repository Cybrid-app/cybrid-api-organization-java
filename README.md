...
- Build date: 2025-04-01T12:57:45.878439Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.346"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.346.jar`
- `target/lib/*.jar`
