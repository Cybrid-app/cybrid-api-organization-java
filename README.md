...
- Build date: 2024-07-16T11:59:00.812546Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.79"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.79.jar`
- `target/lib/*.jar`
