...
- Build date: 2025-06-09T16:17:22.757551Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.564"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.564.jar`
- `target/lib/*.jar`
