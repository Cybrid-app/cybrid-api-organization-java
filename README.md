...
- Build date: 2023-10-04T17:01:19.598153Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.2.jar`
- `target/lib/*.jar`
