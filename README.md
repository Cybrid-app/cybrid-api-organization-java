...
- Build date: 2023-07-05T21:38:34.116977Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.4.jar`
- `target/lib/*.jar`
