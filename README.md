...
- Build date: 2025-03-10T16:29:51.106071Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.288"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.288.jar`
- `target/lib/*.jar`
