...
- Build date: 2025-04-15T16:04:30.520864Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.389"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.389.jar`
- `target/lib/*.jar`
