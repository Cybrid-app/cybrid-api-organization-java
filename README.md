...
- Build date: 2025-03-26T10:56:37.120873Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.326"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.326.jar`
- `target/lib/*.jar`
