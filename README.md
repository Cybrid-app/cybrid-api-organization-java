...
- Build date: 2024-01-24T20:56:47.230186Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.93"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.93.jar`
- `target/lib/*.jar`
