...
- Build date: 2024-04-30T12:57:46.923038Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.129"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.129.jar`
- `target/lib/*.jar`
