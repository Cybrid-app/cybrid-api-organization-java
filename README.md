...
- Build date: 2024-10-18T18:41:52.647428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.24.jar`
- `target/lib/*.jar`
