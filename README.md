...
- Build date: 2023-06-27T15:13:59.732648Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.15.jar`
- `target/lib/*.jar`
