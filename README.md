...
- Build date: 2023-04-13T18:25:13.677396Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.45.jar`
- `target/lib/*.jar`
