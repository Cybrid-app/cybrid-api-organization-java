...
- Build date: 2025-04-28T16:42:33.597872Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.432"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.432.jar`
- `target/lib/*.jar`
