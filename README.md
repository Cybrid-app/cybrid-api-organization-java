...
- API version: v0.115.128

- Build date: 2024-04-29T20:28:25.674142Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.128"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.128.jar`
- `target/lib/*.jar`
