...
- Build date: 2023-04-19T17:11:07.071841Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.57.jar`
- `target/lib/*.jar`
