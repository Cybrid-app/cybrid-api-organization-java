...
- Build date: 2025-04-15T12:00:15.796883Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.385"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.385.jar`
- `target/lib/*.jar`
