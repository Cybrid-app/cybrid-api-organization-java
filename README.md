...
- Build date: 2023-09-18T11:15:51.789283Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.14.jar`
- `target/lib/*.jar`
