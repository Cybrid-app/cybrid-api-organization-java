...
- Build date: 2023-08-03T17:48:02.060042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.0.jar`
- `target/lib/*.jar`
