...
- Build date: 2025-03-18T14:21:45.880970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.305"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.305.jar`
- `target/lib/*.jar`
