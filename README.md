...
- Build date: 2024-08-14T18:40:31.508040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.21.jar`
- `target/lib/*.jar`
