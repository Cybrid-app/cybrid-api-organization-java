...
- API version: v0.123.161

- Build date: 2025-01-23T15:55:21.739482Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.161"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.161.jar`
- `target/lib/*.jar`
