...
- Build date: 2024-05-17T19:10:00.550362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.7.jar`
- `target/lib/*.jar`
