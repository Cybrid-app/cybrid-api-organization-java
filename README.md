...
- Build date: 2022-05-13T14:26:21.925594Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.4.jar`
- `target/lib/*.jar`
