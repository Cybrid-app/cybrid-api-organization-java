...
- Build date: 2023-07-04T19:22:33.004362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.3.jar`
- `target/lib/*.jar`
