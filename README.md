...
- Build date: 2024-06-05T18:10:27.331972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.4.jar`
- `target/lib/*.jar`
