...
- Build date: 2024-01-22T21:34:00.282599Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.86"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.86.jar`
- `target/lib/*.jar`
