...
- Build date: 2025-05-26T17:37:53.748106Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.524"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.524.jar`
- `target/lib/*.jar`
