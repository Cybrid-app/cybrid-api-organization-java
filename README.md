...
- Build date: 2025-06-16T13:19:22.261509Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.589"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.589.jar`
- `target/lib/*.jar`
