...
- Build date: 2024-02-14T15:50:33.645282Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.144"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.144.jar`
- `target/lib/*.jar`
