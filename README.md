...
- Build date: 2022-06-14T14:52:26.240131Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.25.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.25.3.jar`
- `target/lib/*.jar`
