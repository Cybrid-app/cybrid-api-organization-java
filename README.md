...
- Build date: 2024-04-09T17:02:53.527794Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.72.jar`
- `target/lib/*.jar`
