...
- Build date: 2023-08-27T13:56:02.456964Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.9.jar`
- `target/lib/*.jar`
