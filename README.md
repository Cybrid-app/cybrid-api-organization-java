...
- Build date: 2025-02-24T19:12:39.520903Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.250"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.250.jar`
- `target/lib/*.jar`
