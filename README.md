...
- Build date: 2023-12-19T18:31:05.240238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.24.jar`
- `target/lib/*.jar`
