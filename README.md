...
- Build date: 2025-03-18T15:01:37.284369Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.306"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.306.jar`
- `target/lib/*.jar`
