...
- Build date: 2025-04-30T21:23:29.049242Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.441"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.441.jar`
- `target/lib/*.jar`
