...
- Build date: 2025-05-16T11:15:40.363417Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.491"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.491.jar`
- `target/lib/*.jar`
