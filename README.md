...
- Build date: 2023-07-20T12:05:52.585094Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.5.jar`
- `target/lib/*.jar`
