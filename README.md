...
- Build date: 2025-02-01T17:44:27.333287Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.186"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.186.jar`
- `target/lib/*.jar`
