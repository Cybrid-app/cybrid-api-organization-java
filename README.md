...
- Build date: 2024-10-15T16:11:27.465362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.6.jar`
- `target/lib/*.jar`
