...
- Build date: 2025-05-15T13:23:08.926604Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.483"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.483.jar`
- `target/lib/*.jar`
