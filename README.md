...
- Build date: 2022-05-30T18:52:16.470244Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.16.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.16.1.jar`
- `target/lib/*.jar`
