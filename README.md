...
- Build date: 2024-08-19T19:27:22.575325Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.32.jar`
- `target/lib/*.jar`
