...
- Build date: 2024-08-21T14:20:29.347993Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.37.jar`
- `target/lib/*.jar`
