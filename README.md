...
- Build date: 2024-02-14T18:31:20.865269Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.145"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.145.jar`
- `target/lib/*.jar`
