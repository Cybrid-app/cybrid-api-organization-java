...
- Build date: 2024-07-05T14:27:42.460250Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.68.jar`
- `target/lib/*.jar`
