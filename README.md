...
- Build date: 2023-06-14T14:23:55.156140Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.10.jar`
- `target/lib/*.jar`
