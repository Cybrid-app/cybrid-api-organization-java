...
- Build date: 2023-04-24T12:38:56.193869Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.60"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.60.jar`
- `target/lib/*.jar`
