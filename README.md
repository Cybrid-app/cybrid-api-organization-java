...
- Build date: 2024-06-07T15:16:37.731496Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.8.jar`
- `target/lib/*.jar`
