...
- Build date: 2024-10-30T00:46:58.495755Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.56.jar`
- `target/lib/*.jar`
