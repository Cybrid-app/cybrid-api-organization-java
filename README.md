...
- Build date: 2024-11-06T18:09:51.234104Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.34.jar`
- `target/lib/*.jar`
