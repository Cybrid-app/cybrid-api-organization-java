...
- API version: v0.123.175

- Build date: 2025-01-28T22:26:41.909229Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.175"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.175.jar`
- `target/lib/*.jar`
