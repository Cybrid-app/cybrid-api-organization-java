...
- Build date: 2024-07-28T16:37:54.492901Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.105"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.105.jar`
- `target/lib/*.jar`
