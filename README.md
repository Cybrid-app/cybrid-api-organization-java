...
- Build date: 2023-11-28T16:15:43.846261Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.3.jar`
- `target/lib/*.jar`
