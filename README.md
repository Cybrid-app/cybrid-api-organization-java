...
- Build date: 2025-03-07T15:41:09.635177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.283"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.283.jar`
- `target/lib/*.jar`
