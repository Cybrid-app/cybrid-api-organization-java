...
- Build date: 2025-05-12T13:58:58.232601Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.475"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.475.jar`
- `target/lib/*.jar`
