...
- Build date: 2024-03-18T14:53:56.070884Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.17.jar`
- `target/lib/*.jar`
