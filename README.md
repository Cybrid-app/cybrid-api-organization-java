...
- Build date: 2024-03-22T16:30:30.157235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.28.jar`
- `target/lib/*.jar`
