...
- Build date: 2023-07-20T18:52:17.061265Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.9.jar`
- `target/lib/*.jar`
