...
- Build date: 2025-04-29T20:51:32.407505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.438"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.438.jar`
- `target/lib/*.jar`
