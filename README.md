...
- Build date: 2023-05-25T22:05:56.278032Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.46.jar`
- `target/lib/*.jar`
