...
- Build date: 2022-05-11T14:17:46.122798Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.14.jar`
- `target/lib/*.jar`
