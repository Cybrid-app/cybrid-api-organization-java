...
- Build date: 2022-06-14T18:31:44.106796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.26.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.26.2.jar`
- `target/lib/*.jar`
