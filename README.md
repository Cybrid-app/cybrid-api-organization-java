...
- Build date: 2025-05-22T12:43:33.371797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.513"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.513.jar`
- `target/lib/*.jar`
