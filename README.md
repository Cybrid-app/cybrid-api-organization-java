...
- Build date: 2023-04-13T20:01:46.498605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.46.jar`
- `target/lib/*.jar`
