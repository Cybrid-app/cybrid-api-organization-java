...
- Build date: 2024-05-31T16:07:46.281803Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.25.jar`
- `target/lib/*.jar`
