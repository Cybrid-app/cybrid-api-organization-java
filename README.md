...
- Build date: 2023-04-18T11:17:11.401091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.52.jar`
- `target/lib/*.jar`
