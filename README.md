...
- Build date: 2024-12-23T15:59:24.331096Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.103"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.103.jar`
- `target/lib/*.jar`
