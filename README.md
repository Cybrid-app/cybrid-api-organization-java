...
- Build date: 2023-06-19T19:19:00.539875Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.29.jar`
- `target/lib/*.jar`
