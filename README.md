...
- Build date: 2023-11-30T22:01:28.693815Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.17.jar`
- `target/lib/*.jar`
