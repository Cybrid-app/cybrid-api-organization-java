...
- Build date: 2024-08-23T16:21:26.527290Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.44.jar`
- `target/lib/*.jar`
