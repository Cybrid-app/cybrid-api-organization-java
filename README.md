...
- Build date: 2024-01-05T16:42:37.017602Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.52.jar`
- `target/lib/*.jar`
