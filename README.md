...
- Build date: 2022-05-27T13:30:55.607381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.2.jar`
- `target/lib/*.jar`
