...
- Build date: 2024-06-13T15:36:17.884288Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.23.jar`
- `target/lib/*.jar`
