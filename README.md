...
- Build date: 2024-10-01T18:35:15.293202Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.158"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.158.jar`
- `target/lib/*.jar`
