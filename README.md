...
- Build date: 2022-05-03T12:44:57.997840Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.17.jar`
- `target/lib/*.jar`
