...
- Build date: 2023-11-24T14:35:05.401893Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.27.jar`
- `target/lib/*.jar`
