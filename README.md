...
- Build date: 2025-03-18T23:34:48.666861Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.309"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.309.jar`
- `target/lib/*.jar`
