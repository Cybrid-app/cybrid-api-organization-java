...
- Build date: 2024-08-24T13:51:23.582987Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.45.jar`
- `target/lib/*.jar`
