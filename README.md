...
- Build date: 2024-05-31T19:01:26.936971Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.27.jar`
- `target/lib/*.jar`
