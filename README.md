...
- Build date: 2025-02-07T17:13:12.872776Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.219"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.219.jar`
- `target/lib/*.jar`
