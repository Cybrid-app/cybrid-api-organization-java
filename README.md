...
- Build date: 2022-05-30T13:03:05.909001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.9.jar`
- `target/lib/*.jar`
