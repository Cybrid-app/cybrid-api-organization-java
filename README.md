...
- Build date: 2024-11-02T02:26:14.365784Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.22.jar`
- `target/lib/*.jar`
