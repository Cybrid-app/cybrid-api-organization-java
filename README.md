...
- Build date: 2022-06-08T01:57:05.256822Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.3.jar`
- `target/lib/*.jar`
