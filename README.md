...
- Build date: 2023-05-08T13:31:25.001237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.90"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.90.jar`
- `target/lib/*.jar`
