...
- Build date: 2023-09-05T19:13:54.145160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.4.jar`
- `target/lib/*.jar`
