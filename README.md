...
- Build date: 2025-02-21T19:10:57.920403Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.246"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.246.jar`
- `target/lib/*.jar`
