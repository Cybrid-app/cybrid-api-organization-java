...
- Build date: 2024-03-22T15:56:28.518416Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.27.jar`
- `target/lib/*.jar`
