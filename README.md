...
- Build date: 2025-03-25T14:21:46.962497Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.324"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.324.jar`
- `target/lib/*.jar`
