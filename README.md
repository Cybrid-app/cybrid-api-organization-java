...
- Build date: 2024-06-12T19:08:15.143311Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.21.jar`
- `target/lib/*.jar`
