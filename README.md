...
- Build date: 2025-02-03T20:18:26.026704Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.190"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.190.jar`
- `target/lib/*.jar`
