...
- Build date: 2024-03-08T22:06:43.728783Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.2.jar`
- `target/lib/*.jar`
