...
- Build date: 2024-04-12T22:38:46.647124Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.93"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.93.jar`
- `target/lib/*.jar`
