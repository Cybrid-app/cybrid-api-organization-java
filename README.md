...
- Build date: 2024-03-03T23:05:49.546029Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.34.jar`
- `target/lib/*.jar`
