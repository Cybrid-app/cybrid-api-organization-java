...
- Build date: 2025-04-29T14:34:16.185453Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.434"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.434.jar`
- `target/lib/*.jar`
