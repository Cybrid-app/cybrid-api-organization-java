...
- Build date: 2022-05-04T10:32:03.732741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.25.jar`
- `target/lib/*.jar`
