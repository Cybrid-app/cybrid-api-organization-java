...
- Build date: 2023-09-18T17:07:20.440786Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.16.jar`
- `target/lib/*.jar`
