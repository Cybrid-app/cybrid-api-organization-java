...
- Build date: 2022-05-21T05:59:01.294108Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.6.jar`
- `target/lib/*.jar`
