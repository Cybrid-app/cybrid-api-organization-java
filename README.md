...
- Build date: 2023-10-11T15:55:19.745297Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.101.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.101.0.jar`
- `target/lib/*.jar`
