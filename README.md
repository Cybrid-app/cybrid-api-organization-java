...
- Build date: 2024-12-11T14:00:02.990439Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.75"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.75.jar`
- `target/lib/*.jar`
