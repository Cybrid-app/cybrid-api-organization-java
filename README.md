...
- Build date: 2022-06-09T04:55:41.983947Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.24.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.24.1.jar`
- `target/lib/*.jar`
