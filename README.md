...
- Build date: 2024-04-15T15:00:59.227160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.95"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.95.jar`
- `target/lib/*.jar`
