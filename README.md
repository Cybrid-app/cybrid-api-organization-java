...
- Build date: 2024-01-23T19:08:23.451189Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.90"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.90.jar`
- `target/lib/*.jar`
