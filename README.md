...
- Build date: 2025-05-16T01:29:18.553005Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.490"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.490.jar`
- `target/lib/*.jar`
