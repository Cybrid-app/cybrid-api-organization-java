...
- Build date: 2025-04-09T13:00:48.883055Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.369"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.369.jar`
- `target/lib/*.jar`
