...
- Build date: 2023-11-15T13:14:01.445355Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.61.jar`
- `target/lib/*.jar`
