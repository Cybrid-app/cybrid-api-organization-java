...
- Build date: 2024-11-08T15:30:30.952073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.44.jar`
- `target/lib/*.jar`
