...
- Build date: 2024-03-28T19:20:30.104832Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.48.jar`
- `target/lib/*.jar`
