...
- Build date: 2025-05-20T19:23:32.230516Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.502"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.502.jar`
- `target/lib/*.jar`
