...
- Build date: 2024-12-27T21:46:34.877299Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.110"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.110.jar`
- `target/lib/*.jar`
