...
- Build date: 2024-02-01T15:20:09.491790Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.114"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.114.jar`
- `target/lib/*.jar`
