...
- Build date: 2024-11-08T19:53:29.417284Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.48.jar`
- `target/lib/*.jar`
