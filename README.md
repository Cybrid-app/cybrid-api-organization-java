...
- Build date: 2024-10-16T14:26:38.595864Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.9.jar`
- `target/lib/*.jar`
