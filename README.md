...
- Build date: 2023-12-05T17:41:24.171567Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.7.jar`
- `target/lib/*.jar`
