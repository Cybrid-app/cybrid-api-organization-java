...
- Build date: 2024-09-20T22:31:04.781257Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.128"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.128.jar`
- `target/lib/*.jar`
