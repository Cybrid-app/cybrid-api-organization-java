...
- Build date: 2023-05-08T16:02:18.427288Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.69.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.69.1.jar`
- `target/lib/*.jar`
