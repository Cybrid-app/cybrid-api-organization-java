...
- Build date: 2025-01-10T12:25:42.955972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.134"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.134.jar`
- `target/lib/*.jar`
