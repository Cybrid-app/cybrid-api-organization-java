...
- Build date: 2025-01-15T22:15:58.576016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.144"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.144.jar`
- `target/lib/*.jar`
