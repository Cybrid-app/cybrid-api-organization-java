...
- Build date: 2025-05-12T16:25:13.278721Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.476"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.476.jar`
- `target/lib/*.jar`
