...
- Build date: 2025-02-04T15:33:20.449565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.196"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.196.jar`
- `target/lib/*.jar`
