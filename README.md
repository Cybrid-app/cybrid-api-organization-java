...
- API version: v0.113.110

- Build date: 2024-01-30T22:00:40.885722Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.110"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.110.jar`
- `target/lib/*.jar`
