...
- Build date: 2024-08-19T21:39:28.426384Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.34.jar`
- `target/lib/*.jar`
