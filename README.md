...
- Build date: 2024-09-23T23:30:19.173745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.134"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.134.jar`
- `target/lib/*.jar`
