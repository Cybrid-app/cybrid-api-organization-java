...
- Build date: 2023-06-09T12:22:18.007456Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.6.jar`
- `target/lib/*.jar`
