...
- Build date: 2025-01-10T22:57:17.778013Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.137"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.137.jar`
- `target/lib/*.jar`
