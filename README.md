...
- Build date: 2024-10-25T13:47:40.907265Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.44.jar`
- `target/lib/*.jar`
