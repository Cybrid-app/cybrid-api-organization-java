...
- Build date: 2024-10-15T18:17:13.304323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.8.jar`
- `target/lib/*.jar`
