...
- Build date: 2024-09-09T21:29:19.453988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.78"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.78.jar`
- `target/lib/*.jar`
