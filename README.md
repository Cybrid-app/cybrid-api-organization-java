...
- Build date: 2024-10-07T12:50:14.851329Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.7.jar`
- `target/lib/*.jar`
