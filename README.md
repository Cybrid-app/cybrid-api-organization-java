...
- Build date: 2024-06-12T15:51:30.249280Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.19.jar`
- `target/lib/*.jar`
