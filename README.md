...
- Build date: 2025-05-21T13:50:52.860085Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.507"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.507.jar`
- `target/lib/*.jar`
