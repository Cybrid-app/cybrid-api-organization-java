...
- Build date: 2024-06-06T00:39:41.548798Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.6.jar`
- `target/lib/*.jar`
