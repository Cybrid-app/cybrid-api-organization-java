...
- API version: v0.123.172

- Build date: 2025-01-28T02:56:21.894698Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.172"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.172.jar`
- `target/lib/*.jar`
