...
- Build date: 2023-09-12T19:04:17.677095Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.2.jar`
- `target/lib/*.jar`
