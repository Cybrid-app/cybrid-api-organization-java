...
- API version: v0.117.10

- Build date: 2024-05-24T14:59:06.121236Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.10.jar`
- `target/lib/*.jar`
