...
- Build date: 2023-04-27T14:24:45.736021Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.69.jar`
- `target/lib/*.jar`
