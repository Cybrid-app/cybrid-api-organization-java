...
- Build date: 2023-10-23T14:44:06.799787Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.9.jar`
- `target/lib/*.jar`
