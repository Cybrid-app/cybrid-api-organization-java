...
- Build date: 2025-06-02T17:41:05.517327Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.542"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.542.jar`
- `target/lib/*.jar`
