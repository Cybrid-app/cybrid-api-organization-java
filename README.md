...
- Build date: 2024-10-01T13:44:20.966892Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.156"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.156.jar`
- `target/lib/*.jar`
