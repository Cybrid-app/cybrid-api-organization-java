...
- Build date: 2024-04-10T14:59:39.172847Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.77"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.77.jar`
- `target/lib/*.jar`
