...
- Build date: 2024-01-05T15:34:51.218700Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.51.jar`
- `target/lib/*.jar`
