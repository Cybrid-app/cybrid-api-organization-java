...
- Build date: 2023-12-04T16:06:54.778063Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.1.jar`
- `target/lib/*.jar`
