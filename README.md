...
- Build date: 2024-07-05T13:56:03.327670Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.67.jar`
- `target/lib/*.jar`
