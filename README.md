...
- Build date: 2024-01-05T21:58:36.647950Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.54.jar`
- `target/lib/*.jar`
