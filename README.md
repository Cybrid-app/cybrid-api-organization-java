...
- API version: v0.123.171

- Build date: 2025-01-28T00:45:41.493074Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.171"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.171.jar`
- `target/lib/*.jar`
