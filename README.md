...
- Build date: 2024-12-23T18:04:03.001744Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.105"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.105.jar`
- `target/lib/*.jar`
