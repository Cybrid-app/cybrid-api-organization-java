...
- Build date: 2023-05-25T16:15:33.857111Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.43.jar`
- `target/lib/*.jar`
