...
- Build date: 2022-05-09T10:02:46.082637Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.2.jar`
- `target/lib/*.jar`
