...
- Build date: 2024-07-09T18:53:42.078174Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.73"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.73.jar`
- `target/lib/*.jar`
