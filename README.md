...
- Build date: 2023-07-12T12:10:30.098850Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.2.jar`
- `target/lib/*.jar`
