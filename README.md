...
- Build date: 2023-05-11T15:03:38.451826Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.15.jar`
- `target/lib/*.jar`
