...
- Build date: 2024-08-29T00:38:38.246010Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.53.jar`
- `target/lib/*.jar`
