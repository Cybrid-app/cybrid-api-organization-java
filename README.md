...
- Build date: 2024-01-10T02:19:57.235750Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.58"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.58.jar`
- `target/lib/*.jar`
