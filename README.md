...
- Build date: 2023-11-23T14:18:14.461411Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.21.jar`
- `target/lib/*.jar`
