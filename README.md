...
- Build date: 2024-08-13T17:06:16.533925Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.13.jar`
- `target/lib/*.jar`
