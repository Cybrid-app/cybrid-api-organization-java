...
- Build date: 2023-06-26T20:44:13.150205Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.11.jar`
- `target/lib/*.jar`
