...
- Build date: 2022-06-07T15:10:39.532757Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.20.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.20.2.jar`
- `target/lib/*.jar`
