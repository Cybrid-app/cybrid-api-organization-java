...
- Build date: 2025-03-28T13:05:15.478868Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.336"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.336.jar`
- `target/lib/*.jar`
