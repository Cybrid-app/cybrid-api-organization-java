...
- Build date: 2025-06-16T14:41:02.253174Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.590"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.590.jar`
- `target/lib/*.jar`
