...
- Build date: 2023-07-04T20:16:22.987399Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.4.jar`
- `target/lib/*.jar`
