...
- Build date: 2024-05-14T11:01:20.030764Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.0.jar`
- `target/lib/*.jar`
