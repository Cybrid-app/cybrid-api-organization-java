...
- Build date: 2025-05-14T20:28:51.554995Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.480"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.480.jar`
- `target/lib/*.jar`
