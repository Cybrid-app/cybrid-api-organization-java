...
- Build date: 2023-11-13T16:33:59.179666Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.54.jar`
- `target/lib/*.jar`
