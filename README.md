...
- Build date: 2023-08-15T17:22:14.351696Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.7.jar`
- `target/lib/*.jar`
