...
- Build date: 2023-05-23T14:27:11.493505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.33.jar`
- `target/lib/*.jar`
