...
- Build date: 2023-08-23T17:48:57.877091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.5.jar`
- `target/lib/*.jar`
