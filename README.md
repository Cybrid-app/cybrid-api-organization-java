...
- Build date: 2022-05-16T11:30:46.104741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.3.jar`
- `target/lib/*.jar`
