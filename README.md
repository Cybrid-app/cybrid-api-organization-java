...
- Build date: 2025-03-08T15:20:25.008341Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.285"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.285.jar`
- `target/lib/*.jar`
