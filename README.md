...
- Build date: 2025-06-20T15:37:55.854178Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.616"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.616.jar`
- `target/lib/*.jar`
