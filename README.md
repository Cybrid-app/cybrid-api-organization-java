...
- Build date: 2022-06-03T19:20:12.320484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.6.jar`
- `target/lib/*.jar`
