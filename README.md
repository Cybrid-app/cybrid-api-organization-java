...
- Build date: 2022-05-13T15:54:01.514957Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.5.jar`
- `target/lib/*.jar`
