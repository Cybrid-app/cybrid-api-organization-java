...
- Build date: 2022-05-24T13:26:26.813915Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.5.jar`
- `target/lib/*.jar`
