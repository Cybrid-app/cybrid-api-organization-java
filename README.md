...
- Build date: 2025-04-25T19:15:13.518058Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.429"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.429.jar`
- `target/lib/*.jar`
