...
- Build date: 2022-05-19T14:42:57.682511Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.0.jar`
- `target/lib/*.jar`
