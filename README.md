...
- Build date: 2023-08-21T19:18:35.813685Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.5.jar`
- `target/lib/*.jar`
