...
- Build date: 2023-06-26T14:47:23.530252Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.8.jar`
- `target/lib/*.jar`
