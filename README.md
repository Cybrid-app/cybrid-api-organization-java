...
- Build date: 2023-10-05T16:35:15.855166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.8.jar`
- `target/lib/*.jar`
