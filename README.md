...
- Build date: 2022-05-05T10:59:17.047179Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.30.jar`
- `target/lib/*.jar`
