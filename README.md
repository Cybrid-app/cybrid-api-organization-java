...
- Build date: 2023-12-13T18:59:51.050466Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.40"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.40.jar`
- `target/lib/*.jar`
