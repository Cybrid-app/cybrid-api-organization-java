...
- Build date: 2023-11-21T14:50:43.614033Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.13.jar`
- `target/lib/*.jar`
