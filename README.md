...
- Build date: 2024-03-11T17:07:44.349433Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.8.jar`
- `target/lib/*.jar`
