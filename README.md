...
- Build date: 2024-08-13T15:25:07.273534Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.12.jar`
- `target/lib/*.jar`
