...
- Build date: 2024-12-30T19:34:10.218109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.113"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.113.jar`
- `target/lib/*.jar`
