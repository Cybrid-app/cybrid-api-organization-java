...
- Build date: 2024-04-17T14:24:25.806166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.106"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.106.jar`
- `target/lib/*.jar`
