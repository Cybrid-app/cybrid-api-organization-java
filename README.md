...
- Build date: 2025-02-04T23:53:52.972663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.205"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.205.jar`
- `target/lib/*.jar`
