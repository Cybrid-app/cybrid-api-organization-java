...
- Build date: 2024-11-19T15:06:20.712435Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.7.jar`
- `target/lib/*.jar`
