...
- Build date: 2023-12-28T13:25:19.114091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.41.jar`
- `target/lib/*.jar`
