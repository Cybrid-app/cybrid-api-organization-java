...
- Build date: 2023-05-29T13:48:45.289311Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.56.jar`
- `target/lib/*.jar`
