...
- Build date: 2023-06-16T16:29:15.545646Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.21.jar`
- `target/lib/*.jar`
