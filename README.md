...
- Build date: 2023-06-14T20:09:01.382635Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.13.jar`
- `target/lib/*.jar`
