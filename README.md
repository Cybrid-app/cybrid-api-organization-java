...
- Build date: 2023-05-09T13:37:45.178178Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.2.jar`
- `target/lib/*.jar`
