...
- Build date: 2023-09-26T17:41:51.923224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.39.jar`
- `target/lib/*.jar`
