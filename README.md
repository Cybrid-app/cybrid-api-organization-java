...
- Build date: 2024-11-08T18:34:49.310803Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.47.jar`
- `target/lib/*.jar`
