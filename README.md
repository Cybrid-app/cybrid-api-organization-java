...
- Build date: 2025-06-02T19:27:40.137045Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.544"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.544.jar`
- `target/lib/*.jar`
