...
- Build date: 2024-03-07T16:25:46.744153Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.45.jar`
- `target/lib/*.jar`
