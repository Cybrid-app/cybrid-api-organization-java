...
- Build date: 2024-04-25T15:28:36.779360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.122"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.122.jar`
- `target/lib/*.jar`
