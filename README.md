...
- Build date: 2023-11-17T00:28:02.337255Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.6.jar`
- `target/lib/*.jar`
