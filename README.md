...
- Build date: 2022-05-24T12:58:44.282872Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.4.jar`
- `target/lib/*.jar`
