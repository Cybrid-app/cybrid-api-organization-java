...
- Build date: 2022-06-06T16:05:11.725473Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.16.jar`
- `target/lib/*.jar`
