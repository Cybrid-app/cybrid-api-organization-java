...
- Build date: 2024-01-02T16:14:35.055364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.43.jar`
- `target/lib/*.jar`
