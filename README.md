...
- Build date: 2025-02-14T13:34:59.410229Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.233"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.233.jar`
- `target/lib/*.jar`
