...
- Build date: 2024-07-08T21:10:51.498587Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.71.jar`
- `target/lib/*.jar`
