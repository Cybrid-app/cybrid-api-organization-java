...
- Build date: 2023-12-01T12:29:20.895710Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.19.jar`
- `target/lib/*.jar`
