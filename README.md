...
- Build date: 2022-05-04T00:34:38.444033Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.23.jar`
- `target/lib/*.jar`
