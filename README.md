...
- Build date: 2023-12-22T14:19:01.605866Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.37.jar`
- `target/lib/*.jar`
