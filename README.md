...
- Build date: 2023-08-22T19:17:08.553499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.0.jar`
- `target/lib/*.jar`
