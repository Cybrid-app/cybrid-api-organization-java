...
- Build date: 2022-05-20T12:31:05.905355Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.1.jar`
- `target/lib/*.jar`
