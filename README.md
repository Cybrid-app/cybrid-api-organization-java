...
- Build date: 2023-08-24T13:02:35.818505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.87.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.87.0.jar`
- `target/lib/*.jar`
