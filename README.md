...
- Build date: 2022-05-10T10:45:09.855897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.8.jar`
- `target/lib/*.jar`
