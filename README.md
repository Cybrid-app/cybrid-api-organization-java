...
- Build date: 2023-11-15T15:43:25.878719Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.0.jar`
- `target/lib/*.jar`
