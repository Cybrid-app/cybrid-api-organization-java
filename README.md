...
- Build date: 2023-09-09T14:27:04.003492Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.92.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.92.4.jar`
- `target/lib/*.jar`
