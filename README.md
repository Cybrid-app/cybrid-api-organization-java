...
- Build date: 2025-06-02T17:04:46.468455Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.541"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.541.jar`
- `target/lib/*.jar`
