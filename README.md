...
- Build date: 2022-05-25T10:10:02.298745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.9.jar`
- `target/lib/*.jar`
