...
- Build date: 2023-09-21T13:23:47.468446Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.25.jar`
- `target/lib/*.jar`
