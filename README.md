...
- Build date: 2025-05-05T14:12:31.411941Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.447"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.447.jar`
- `target/lib/*.jar`
