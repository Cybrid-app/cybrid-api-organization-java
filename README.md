...
- Build date: 2023-08-24T18:48:41.305127Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.2.jar`
- `target/lib/*.jar`
