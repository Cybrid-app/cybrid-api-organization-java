...
- Build date: 2025-04-04T14:00:45.822322Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.357"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.357.jar`
- `target/lib/*.jar`
