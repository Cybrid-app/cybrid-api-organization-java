...
- Build date: 2023-11-17T23:05:05.549119Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.8.jar`
- `target/lib/*.jar`
