...
- Build date: 2023-08-28T19:19:08.732530Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.1.jar`
- `target/lib/*.jar`
