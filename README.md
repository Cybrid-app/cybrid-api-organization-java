...
- Build date: 2024-10-21T14:33:33.311676Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.29.jar`
- `target/lib/*.jar`
