...
- Build date: 2023-11-02T12:13:06.755724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.32.jar`
- `target/lib/*.jar`
