...
- Build date: 2023-09-12T12:05:05.569363Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.93.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.93.4.jar`
- `target/lib/*.jar`
