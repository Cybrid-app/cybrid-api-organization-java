...
- Build date: 2023-09-28T15:23:26.126377Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.44.jar`
- `target/lib/*.jar`
