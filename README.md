...
- Build date: 2024-09-06T15:48:04.203219Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.70.jar`
- `target/lib/*.jar`
