...
- Build date: 2023-09-26T13:19:20.460327Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.37.jar`
- `target/lib/*.jar`
