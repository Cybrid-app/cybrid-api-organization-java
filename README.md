...
- Build date: 2024-09-10T18:47:09.159600Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.82"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.82.jar`
- `target/lib/*.jar`
