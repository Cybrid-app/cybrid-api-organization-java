...
- Build date: 2022-05-14T17:31:25.057503Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.11.jar`
- `target/lib/*.jar`
