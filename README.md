...
- Build date: 2023-07-22T21:42:13.371791Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.14.jar`
- `target/lib/*.jar`
