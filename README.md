...
- Build date: 2023-08-24T16:59:05.989091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.0.jar`
- `target/lib/*.jar`
