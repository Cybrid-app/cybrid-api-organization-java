...
- Build date: 2024-12-24T15:41:47.966878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.107"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.107.jar`
- `target/lib/*.jar`
