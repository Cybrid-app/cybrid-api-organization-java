...
- Build date: 2025-05-20T21:36:15.352116Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.504"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.504.jar`
- `target/lib/*.jar`
