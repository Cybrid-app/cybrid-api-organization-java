...
- Build date: 2023-09-07T18:35:18.443407Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.13.jar`
- `target/lib/*.jar`
