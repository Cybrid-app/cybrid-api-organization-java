...
- Build date: 2024-10-01T22:03:00.310626Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.159"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.159.jar`
- `target/lib/*.jar`
