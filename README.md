...
- Build date: 2022-06-01T04:01:17.688340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.0.jar`
- `target/lib/*.jar`
