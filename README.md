...
- Build date: 2024-09-06T17:01:35.586372Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.71.jar`
- `target/lib/*.jar`
