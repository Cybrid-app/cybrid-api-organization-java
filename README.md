...
- Build date: 2022-05-02T17:41:12.793653Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.10.jar`
- `target/lib/*.jar`
