...
- Build date: 2024-12-05T01:37:56.949048Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.58"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.58.jar`
- `target/lib/*.jar`
