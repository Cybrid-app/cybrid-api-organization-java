...
- Build date: 2025-06-11T16:29:26.719748Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.575"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.575.jar`
- `target/lib/*.jar`
