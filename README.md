...
- Build date: 2024-11-18T16:03:55.926957Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.2.jar`
- `target/lib/*.jar`
