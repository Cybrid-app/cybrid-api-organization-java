...
- Build date: 2023-05-25T20:08:22.955496Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.45.jar`
- `target/lib/*.jar`
