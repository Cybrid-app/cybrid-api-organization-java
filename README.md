...
- Build date: 2025-03-10T15:04:46.463329Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.287"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.287.jar`
- `target/lib/*.jar`
