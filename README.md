...
- Build date: 2023-10-31T17:18:32.596980Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.29.jar`
- `target/lib/*.jar`
