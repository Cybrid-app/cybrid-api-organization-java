...
- Build date: 2022-05-13T16:27:06.150614Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.6.jar`
- `target/lib/*.jar`
