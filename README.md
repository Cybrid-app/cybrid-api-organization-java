...
- Build date: 2024-09-04T21:42:03.065152Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.68"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.68.jar`
- `target/lib/*.jar`
