...
- Build date: 2022-06-08T20:31:56.656578Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.24.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.24.0.jar`
- `target/lib/*.jar`
