...
- Build date: 2024-10-16T16:45:21.498107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.11.jar`
- `target/lib/*.jar`
