...
- Build date: 2024-08-08T17:50:17.208882Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.10.jar`
- `target/lib/*.jar`
