...
- Build date: 2025-04-22T22:03:59.521963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.412"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.412.jar`
- `target/lib/*.jar`
