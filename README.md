...
- Build date: 2024-10-10T13:53:13.186142Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.17.jar`
- `target/lib/*.jar`
