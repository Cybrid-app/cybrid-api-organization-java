...
- Build date: 2023-10-18T20:10:32.032468Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.2.jar`
- `target/lib/*.jar`
