...
- Build date: 2022-05-27T14:22:11.548054Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.3.jar`
- `target/lib/*.jar`
