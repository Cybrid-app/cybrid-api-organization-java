...
- Build date: 2025-05-08T13:26:55.121081Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.464"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.464.jar`
- `target/lib/*.jar`
