...
- Build date: 2025-06-11T15:10:38.154583Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.573"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.573.jar`
- `target/lib/*.jar`
