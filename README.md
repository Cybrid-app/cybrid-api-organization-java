...
- Build date: 2024-05-21T23:50:47.383972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.3.jar`
- `target/lib/*.jar`
