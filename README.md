...
- Build date: 2024-03-22T12:32:25.640726Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.25.jar`
- `target/lib/*.jar`
