...
- Build date: 2023-10-11T16:30:51.840009Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.102.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.102.0.jar`
- `target/lib/*.jar`
