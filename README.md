...
- Build date: 2025-06-19T16:14:16.942356Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.607"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.607.jar`
- `target/lib/*.jar`
