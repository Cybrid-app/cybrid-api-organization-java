...
- Build date: 2024-02-29T20:09:16.898212Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.29.jar`
- `target/lib/*.jar`
