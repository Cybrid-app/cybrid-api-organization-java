...
- Build date: 2024-12-09T14:06:11.328917Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.66"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.66.jar`
- `target/lib/*.jar`
