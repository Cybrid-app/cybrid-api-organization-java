...
- Build date: 2023-07-27T12:40:26.084163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.1.jar`
- `target/lib/*.jar`
