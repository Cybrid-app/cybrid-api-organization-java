...
- Build date: 2024-09-26T15:04:52.347567Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.142"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.142.jar`
- `target/lib/*.jar`
