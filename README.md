...
- Build date: 2025-05-01T19:36:58.188383Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.444"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.444.jar`
- `target/lib/*.jar`
