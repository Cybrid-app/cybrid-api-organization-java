...
- Build date: 2023-09-19T16:51:53.486031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.20.jar`
- `target/lib/*.jar`
