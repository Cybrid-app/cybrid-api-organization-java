...
- Build date: 2024-08-22T13:58:59.721969Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.40"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.40.jar`
- `target/lib/*.jar`
