...
- Build date: 2024-03-25T17:45:58.586794Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.36.jar`
- `target/lib/*.jar`
