...
- Build date: 2025-04-14T10:44:39.844310Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.382"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.382.jar`
- `target/lib/*.jar`
