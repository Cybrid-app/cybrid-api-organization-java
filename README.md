...
- Build date: 2024-04-09T18:15:45.859841Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.73"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.73.jar`
- `target/lib/*.jar`
