...
- Build date: 2024-03-20T00:35:24.394043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.20.jar`
- `target/lib/*.jar`
