...
- Build date: 2024-03-25T15:37:17.020609Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.35.jar`
- `target/lib/*.jar`
