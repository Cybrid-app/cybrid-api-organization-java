...
- Build date: 2025-02-05T20:37:44.561500Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.212"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.212.jar`
- `target/lib/*.jar`
