...
- Build date: 2023-12-11T18:56:43.985814Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.28.jar`
- `target/lib/*.jar`
