...
- API version: v0.123.158

- Build date: 2025-01-23T11:05:32.976791Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.158"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.158.jar`
- `target/lib/*.jar`
