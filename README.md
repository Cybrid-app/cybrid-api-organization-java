...
- Build date: 2024-04-11T12:52:08.110072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.83"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.83.jar`
- `target/lib/*.jar`
