...
- Build date: 2023-11-14T01:11:01.201162Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.55.jar`
- `target/lib/*.jar`
