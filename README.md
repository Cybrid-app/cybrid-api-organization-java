...
- Build date: 2023-11-23T15:59:20.634845Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.23.jar`
- `target/lib/*.jar`
