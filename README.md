...
- Build date: 2024-08-19T12:57:06.616783Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.29.jar`
- `target/lib/*.jar`
