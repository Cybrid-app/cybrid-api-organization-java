...
- Build date: 2023-12-21T19:01:39.512521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.31.jar`
- `target/lib/*.jar`
