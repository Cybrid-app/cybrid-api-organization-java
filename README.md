...
- Build date: 2025-05-05T19:10:35.051288Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.450"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.450.jar`
- `target/lib/*.jar`
