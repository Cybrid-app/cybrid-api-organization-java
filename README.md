...
- Build date: 2023-12-08T14:52:31.755602Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.17.jar`
- `target/lib/*.jar`
