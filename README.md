...
- Build date: 2025-01-17T14:34:28.616271Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.149"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.149.jar`
- `target/lib/*.jar`
