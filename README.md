...
- Build date: 2022-06-06T17:34:23.658318Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.19.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.19.0.jar`
- `target/lib/*.jar`
