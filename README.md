...
- Build date: 2025-06-05T16:38:22.817970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.555"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.555.jar`
- `target/lib/*.jar`
