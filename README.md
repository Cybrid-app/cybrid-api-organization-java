...
- Build date: 2024-12-23T23:34:48.839993Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.106"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.106.jar`
- `target/lib/*.jar`
