...
- API version: v0.123.176

- Build date: 2025-01-29T00:09:00.316067Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.176"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.176.jar`
- `target/lib/*.jar`
