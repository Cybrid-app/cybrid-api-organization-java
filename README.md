...
- Build date: 2024-09-17T15:31:19.670039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.104"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.104.jar`
- `target/lib/*.jar`
