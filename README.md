...
- Build date: 2022-05-05T17:41:49.072414Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.4.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.4.2.jar`
- `target/lib/*.jar`
