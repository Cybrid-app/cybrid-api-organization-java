...
- Build date: 2025-04-01T18:30:46.403790Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.349"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.349.jar`
- `target/lib/*.jar`
