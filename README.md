...
- Build date: 2023-12-11T19:45:20.372667Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.30.jar`
- `target/lib/*.jar`
