...
- Build date: 2023-05-10T13:02:51.127852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.11.jar`
- `target/lib/*.jar`
