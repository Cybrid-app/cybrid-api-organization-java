...
- Build date: 2025-06-26T14:51:50.676486Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.643"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.643.jar`
- `target/lib/*.jar`
