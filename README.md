...
- Build date: 2024-07-02T17:36:55.981550Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.56.jar`
- `target/lib/*.jar`
