...
- Build date: 2025-03-23T13:37:41.277890Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.318"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.318.jar`
- `target/lib/*.jar`
