...
- API version: v0.123.177

- Build date: 2025-01-29T01:36:23.665397Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.177"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.177.jar`
- `target/lib/*.jar`
