...
- Build date: 2024-08-13T20:52:17.453570Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.16.jar`
- `target/lib/*.jar`
