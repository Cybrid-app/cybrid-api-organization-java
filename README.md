...
- Build date: 2025-05-16T21:15:29.026386Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.497"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.497.jar`
- `target/lib/*.jar`
