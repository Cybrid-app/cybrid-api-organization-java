...
- Build date: 2024-03-04T16:49:05.838716Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.36.jar`
- `target/lib/*.jar`
