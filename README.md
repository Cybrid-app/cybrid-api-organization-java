...
- Build date: 2023-07-20T16:43:46.298973Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.8.jar`
- `target/lib/*.jar`
