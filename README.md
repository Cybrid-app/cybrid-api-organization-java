...
- Build date: 2023-10-18T16:18:42.565465Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.108.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.108.2.jar`
- `target/lib/*.jar`
