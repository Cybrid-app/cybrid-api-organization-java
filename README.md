...
- Build date: 2023-09-11T20:23:17.603223Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.93.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.93.1.jar`
- `target/lib/*.jar`
