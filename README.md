...
- Build date: 2025-05-20T16:27:12.348152Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.499"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.499.jar`
- `target/lib/*.jar`
