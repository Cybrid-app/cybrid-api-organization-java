...
- Build date: 2023-05-23T13:37:37.374151Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.32.jar`
- `target/lib/*.jar`
