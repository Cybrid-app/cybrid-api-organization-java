...
- Build date: 2024-05-02T14:33:20.104400Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.133"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.133.jar`
- `target/lib/*.jar`
