...
- Build date: 2024-09-20T15:07:16.123827Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.124"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.124.jar`
- `target/lib/*.jar`
