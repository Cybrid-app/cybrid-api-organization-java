...
- Build date: 2024-02-06T00:51:42.658085Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.119"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.119.jar`
- `target/lib/*.jar`
