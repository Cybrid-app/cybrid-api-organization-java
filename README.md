...
- Build date: 2025-05-20T17:50:52.543754Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.500"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.500.jar`
- `target/lib/*.jar`
