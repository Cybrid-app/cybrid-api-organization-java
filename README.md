...
- API version: v0.123.174

- Build date: 2025-01-28T16:32:50.640499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.174"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.174.jar`
- `target/lib/*.jar`
