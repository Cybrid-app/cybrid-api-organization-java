...
- Build date: 2024-01-22T19:14:06.696736Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.85"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.85.jar`
- `target/lib/*.jar`
