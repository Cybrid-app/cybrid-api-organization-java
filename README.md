...
- Build date: 2025-04-10T15:40:27.161702Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.375"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.375.jar`
- `target/lib/*.jar`
