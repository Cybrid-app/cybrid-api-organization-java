...
- Build date: 2024-10-08T13:18:49.543592Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.11.jar`
- `target/lib/*.jar`
