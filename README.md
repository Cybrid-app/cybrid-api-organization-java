...
- Build date: 2025-01-09T13:03:10.210033Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.131"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.131.jar`
- `target/lib/*.jar`
