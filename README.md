...
- Build date: 2023-12-19T16:26:18.606122Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.22.jar`
- `target/lib/*.jar`
