...
- Build date: 2024-03-02T00:38:34.617018Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.33.jar`
- `target/lib/*.jar`
