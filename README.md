...
- Build date: 2023-09-13T11:21:08.069945Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.4.jar`
- `target/lib/*.jar`
