...
- Build date: 2024-11-04T17:26:08.048689Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.25.jar`
- `target/lib/*.jar`
