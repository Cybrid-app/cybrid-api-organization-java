...
- Build date: 2024-10-15T13:40:00.498753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.4.jar`
- `target/lib/*.jar`
