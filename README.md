...
- Build date: 2023-10-17T20:40:16.693154Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.107.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.107.2.jar`
- `target/lib/*.jar`
