...
- Build date: 2024-10-07T13:45:33.048112Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.8.jar`
- `target/lib/*.jar`
