...
- Build date: 2023-06-21T16:41:30.238671Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.38.jar`
- `target/lib/*.jar`
