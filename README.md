...
- Build date: 2024-05-22T15:22:17.710490Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.5.jar`
- `target/lib/*.jar`
