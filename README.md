...
- Build date: 2023-10-31T19:23:14.036037Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.30.jar`
- `target/lib/*.jar`
