...
- Build date: 2024-08-29T16:41:58.349886Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.55.jar`
- `target/lib/*.jar`
