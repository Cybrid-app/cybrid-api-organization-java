...
- Build date: 2025-05-14T15:26:23.932625Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.479"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.479.jar`
- `target/lib/*.jar`
