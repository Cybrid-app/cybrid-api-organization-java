...
- Build date: 2023-09-14T11:29:22.003666Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.6.jar`
- `target/lib/*.jar`
