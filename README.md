...
- Build date: 2024-03-06T02:01:33.877841Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.41.jar`
- `target/lib/*.jar`
