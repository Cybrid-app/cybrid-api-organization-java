...
- Build date: 2023-05-25T19:36:22.058530Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.44.jar`
- `target/lib/*.jar`
