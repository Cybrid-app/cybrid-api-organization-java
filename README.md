...
- Build date: 2025-01-31T19:05:08.221335Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.183"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.183.jar`
- `target/lib/*.jar`
