...
- API version: v0.123.156

- Build date: 2025-01-22T15:42:08.150263Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.156"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.156.jar`
- `target/lib/*.jar`
