...
- Build date: 2023-08-03T19:20:12.318649Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.1.jar`
- `target/lib/*.jar`
