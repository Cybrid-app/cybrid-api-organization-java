...
- Build date: 2024-03-28T18:24:13.043339Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.47.jar`
- `target/lib/*.jar`
