...
- Build date: 2023-07-17T13:54:24.381386Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.13.jar`
- `target/lib/*.jar`
