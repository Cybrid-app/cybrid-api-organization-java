...
- Build date: 2023-08-04T14:19:29.418147Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.2.jar`
- `target/lib/*.jar`
