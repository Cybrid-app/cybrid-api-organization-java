...
- Build date: 2023-08-12T16:10:57.485425Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.14.jar`
- `target/lib/*.jar`
