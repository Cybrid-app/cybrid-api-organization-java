...
- Build date: 2024-10-28T13:01:59.693667Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.48.jar`
- `target/lib/*.jar`
