...
- Build date: 2025-04-02T21:31:30.286302Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.352"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.352.jar`
- `target/lib/*.jar`
