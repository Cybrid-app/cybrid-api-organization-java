...
- Build date: 2023-06-28T13:20:43.319541Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.21.jar`
- `target/lib/*.jar`
