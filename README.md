...
- Build date: 2025-03-05T12:28:10.404057Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.271"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.271.jar`
- `target/lib/*.jar`
