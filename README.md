...
- Build date: 2023-08-19T13:11:23.366265Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.2.jar`
- `target/lib/*.jar`
