...
- Build date: 2024-02-09T14:52:36.182042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.129"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.129.jar`
- `target/lib/*.jar`
