...
- Build date: 2024-10-04T10:30:01.078429Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.169"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.169.jar`
- `target/lib/*.jar`
