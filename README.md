...
- Build date: 2023-05-08T14:32:09.021887Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.91.jar`
- `target/lib/*.jar`
