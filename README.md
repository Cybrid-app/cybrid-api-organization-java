...
- Build date: 2024-07-08T17:49:02.614430Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.70.jar`
- `target/lib/*.jar`
