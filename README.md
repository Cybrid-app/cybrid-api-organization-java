...
- Build date: 2023-06-01T16:15:08.568464Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.63.jar`
- `target/lib/*.jar`
