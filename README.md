...
- Build date: 2024-03-26T12:45:49.091651Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.38.jar`
- `target/lib/*.jar`
