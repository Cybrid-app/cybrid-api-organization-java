...
- Build date: 2023-06-19T17:57:47.581676Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.28.jar`
- `target/lib/*.jar`
