...
- Build date: 2022-05-16T01:54:04.086757Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.0.jar`
- `target/lib/*.jar`
