...
- Build date: 2023-05-15T12:26:39.730427Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.21.jar`
- `target/lib/*.jar`
