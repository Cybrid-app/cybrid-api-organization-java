...
- Build date: 2023-09-08T14:35:58.401677Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.92.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.92.2.jar`
- `target/lib/*.jar`
