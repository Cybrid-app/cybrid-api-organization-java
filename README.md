...
- Build date: 2024-08-27T20:54:58.613400Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.48.jar`
- `target/lib/*.jar`
