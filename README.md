...
- Build date: 2023-08-02T17:40:37.335370Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.25.jar`
- `target/lib/*.jar`
