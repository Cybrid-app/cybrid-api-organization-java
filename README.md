...
- Build date: 2025-03-12T17:13:26.381643Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.291"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.291.jar`
- `target/lib/*.jar`
