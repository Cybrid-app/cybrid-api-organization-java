...
- Build date: 2023-05-17T15:53:45.953104Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.26.jar`
- `target/lib/*.jar`
