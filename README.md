...
- Build date: 2023-08-18T19:38:06.420189Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.16.jar`
- `target/lib/*.jar`
