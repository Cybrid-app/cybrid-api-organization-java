...
- Build date: 2023-11-14T15:38:56.195016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.57.jar`
- `target/lib/*.jar`
