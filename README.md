...
- Build date: 2023-06-08T11:56:12.070120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.1.jar`
- `target/lib/*.jar`
