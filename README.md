...
- Build date: 2023-07-12T12:43:24.957290Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.3.jar`
- `target/lib/*.jar`
