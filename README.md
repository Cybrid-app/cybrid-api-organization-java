...
- Build date: 2023-09-12T22:29:27.266128Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.3.jar`
- `target/lib/*.jar`
