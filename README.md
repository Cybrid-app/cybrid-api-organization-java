...
- API version: v0.118.42

- Build date: 2024-06-25T13:19:16.199179Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.42.jar`
- `target/lib/*.jar`
