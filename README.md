...
- Build date: 2024-09-03T18:28:27.397849Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.61.jar`
- `target/lib/*.jar`
