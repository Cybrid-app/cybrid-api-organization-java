...
- Build date: 2025-06-02T18:30:48.750361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.543"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.543.jar`
- `target/lib/*.jar`
