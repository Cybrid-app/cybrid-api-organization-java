...
- Build date: 2023-12-14T03:48:01.315560Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.3.jar`
- `target/lib/*.jar`
