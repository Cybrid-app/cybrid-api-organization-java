...
- Build date: 2023-11-22T19:40:59.298530Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.18.jar`
- `target/lib/*.jar`
