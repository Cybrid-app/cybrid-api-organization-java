...
- Build date: 2025-03-28T12:11:13.719361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.335"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.335.jar`
- `target/lib/*.jar`
