...
- API version: v0.123.173

- Build date: 2025-01-28T14:35:36.131523Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.173"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.173.jar`
- `target/lib/*.jar`
