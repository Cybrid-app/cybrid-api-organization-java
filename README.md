...
- Build date: 2025-06-04T19:03:34.932719Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.551"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.551.jar`
- `target/lib/*.jar`
