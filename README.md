...
- Build date: 2024-04-11T14:45:13.099782Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.84"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.84.jar`
- `target/lib/*.jar`
