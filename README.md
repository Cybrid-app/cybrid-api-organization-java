...
- Build date: 2023-08-18T20:00:16.240400Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.0.jar`
- `target/lib/*.jar`
