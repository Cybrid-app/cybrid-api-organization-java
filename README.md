...
- Build date: 2025-04-10T12:13:59.583066Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.374"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.374.jar`
- `target/lib/*.jar`
