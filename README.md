...
- Build date: 2023-06-26T18:07:52.435483Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.10.jar`
- `target/lib/*.jar`
