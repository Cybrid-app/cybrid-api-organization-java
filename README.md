...
- Build date: 2023-06-13T12:10:35.237971Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.8.jar`
- `target/lib/*.jar`
