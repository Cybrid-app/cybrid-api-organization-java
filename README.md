...
- Build date: 2024-10-11T14:12:00.351639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.19.jar`
- `target/lib/*.jar`
