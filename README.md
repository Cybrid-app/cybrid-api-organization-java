...
- Build date: 2023-04-13T12:17:55.747760Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.41.jar`
- `target/lib/*.jar`
