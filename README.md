...
- Build date: 2023-11-08T19:41:08.414897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.42.jar`
- `target/lib/*.jar`
