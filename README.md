...
- Build date: 2023-10-04T16:05:18.428544Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.1.jar`
- `target/lib/*.jar`
