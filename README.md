...
- Build date: 2024-04-09T12:58:38.723940Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.70.jar`
- `target/lib/*.jar`
