...
- Build date: 2024-05-15T21:45:52.742236Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.4.jar`
- `target/lib/*.jar`
