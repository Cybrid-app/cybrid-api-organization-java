...
- Build date: 2022-05-26T14:18:51.490194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.19.jar`
- `target/lib/*.jar`
