...
- Build date: 2024-02-29T22:18:36.667922Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.30.jar`
- `target/lib/*.jar`
