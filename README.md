...
- Build date: 2024-12-18T13:34:27.323002Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.95"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.95.jar`
- `target/lib/*.jar`
