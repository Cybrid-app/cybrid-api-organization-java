...
- Build date: 2023-10-04T14:02:48.979295Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.57.jar`
- `target/lib/*.jar`
