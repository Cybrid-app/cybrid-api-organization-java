...
- Build date: 2023-09-29T15:42:29.009930Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.48.jar`
- `target/lib/*.jar`
