...
- Build date: 2023-04-12T21:16:43.979672Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.40"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.40.jar`
- `target/lib/*.jar`
