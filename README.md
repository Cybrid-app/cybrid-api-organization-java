...
- Build date: 2023-05-03T19:30:22.413946Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.85"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.85.jar`
- `target/lib/*.jar`
