...
- Build date: 2024-09-21T22:21:22.929040Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.130"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.130.jar`
- `target/lib/*.jar`
