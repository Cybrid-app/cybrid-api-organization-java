...
- Build date: 2024-06-28T19:28:00.604914Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.54.jar`
- `target/lib/*.jar`
