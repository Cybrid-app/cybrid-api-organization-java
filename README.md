...
- Build date: 2023-12-15T16:07:22.951724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.9.jar`
- `target/lib/*.jar`
