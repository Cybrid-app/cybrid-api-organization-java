...
- Build date: 2024-07-03T15:39:43.195332Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.61.jar`
- `target/lib/*.jar`
