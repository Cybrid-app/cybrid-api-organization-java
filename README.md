...
- Build date: 2022-05-11T15:51:55.164466Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.7.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.7.0.jar`
- `target/lib/*.jar`
