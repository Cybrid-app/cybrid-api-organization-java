...
- Build date: 2024-10-25T16:20:22.007807Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.46.jar`
- `target/lib/*.jar`
