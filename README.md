...
- Build date: 2023-12-15T15:05:28.546746Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.8.jar`
- `target/lib/*.jar`
