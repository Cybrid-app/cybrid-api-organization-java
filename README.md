...
- Build date: 2024-07-25T19:29:09.249894Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.98"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.98.jar`
- `target/lib/*.jar`
