...
- Build date: 2023-11-14T22:16:59.965Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.60"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.60.jar`
- `target/lib/*.jar`
