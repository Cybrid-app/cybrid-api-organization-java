...
- Build date: 2023-09-15T16:36:56.812210Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.11.jar`
- `target/lib/*.jar`
