...
- Build date: 2023-12-12T11:14:00.406765Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.33.jar`
- `target/lib/*.jar`
