...
- Build date: 2025-05-01T17:51:17.285487Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.443"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.443.jar`
- `target/lib/*.jar`
