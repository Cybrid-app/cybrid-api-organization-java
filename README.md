...
- Build date: 2023-05-02T19:00:38.688220Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.80"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.80.jar`
- `target/lib/*.jar`
