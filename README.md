...
- Build date: 2023-10-11T19:42:19.313179Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.104.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.104.0.jar`
- `target/lib/*.jar`
