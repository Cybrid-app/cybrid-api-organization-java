...
- Build date: 2024-05-14T15:51:23.328666Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.1.jar`
- `target/lib/*.jar`
