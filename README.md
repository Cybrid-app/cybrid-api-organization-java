...
- Build date: 2023-05-02T14:28:13.864873Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.76"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.76.jar`
- `target/lib/*.jar`
