...
- Build date: 2024-05-08T15:44:03.626501Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.144"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.144.jar`
- `target/lib/*.jar`
