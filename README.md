...
- Build date: 2024-07-29T17:47:13.431673Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.108"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.108.jar`
- `target/lib/*.jar`
