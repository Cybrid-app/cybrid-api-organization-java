...
- Build date: 2023-07-04T15:10:35.038224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.27.jar`
- `target/lib/*.jar`
