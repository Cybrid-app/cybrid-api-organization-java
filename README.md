...
- Build date: 2023-10-16T15:30:17.002844Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.8.jar`
- `target/lib/*.jar`
