...
- Build date: 2024-02-21T13:50:32.746378Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.4.jar`
- `target/lib/*.jar`
