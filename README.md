...
- Build date: 2023-09-06T16:07:17.288631Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.6.jar`
- `target/lib/*.jar`
