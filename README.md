...
- Build date: 2023-06-27T20:21:30.327390Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.18.jar`
- `target/lib/*.jar`
