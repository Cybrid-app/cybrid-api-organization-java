...
- Build date: 2024-11-12T12:59:35.955740Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.58"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.58.jar`
- `target/lib/*.jar`
