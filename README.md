...
- Build date: 2023-10-16T13:48:13.523103Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.6.jar`
- `target/lib/*.jar`
