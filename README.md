...
- Build date: 2024-06-05T16:41:56.759354Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.3.jar`
- `target/lib/*.jar`
