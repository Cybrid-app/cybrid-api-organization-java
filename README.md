...
- Build date: 2025-06-25T17:24:13.776377Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.641"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.641.jar`
- `target/lib/*.jar`
