...
- Build date: 2022-06-08T03:18:36.553527Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.4.jar`
- `target/lib/*.jar`
