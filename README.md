...
- Build date: 2023-07-11T13:40:27.623717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.77.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.77.0.jar`
- `target/lib/*.jar`
