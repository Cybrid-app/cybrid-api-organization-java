...
- Build date: 2023-09-29T14:45:54.765428Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.47.jar`
- `target/lib/*.jar`
