...
- Build date: 2024-09-13T23:40:59.330001Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.96"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.96.jar`
- `target/lib/*.jar`
