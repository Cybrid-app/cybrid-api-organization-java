...
- Build date: 2024-04-10T11:34:59.131656Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.74"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.74.jar`
- `target/lib/*.jar`
