...
- Build date: 2024-07-25T18:51:51.048914Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.97"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.97.jar`
- `target/lib/*.jar`
