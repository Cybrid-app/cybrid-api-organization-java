...
- Build date: 2023-12-13T22:21:27.473412Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.2.jar`
- `target/lib/*.jar`
