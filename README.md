...
- Build date: 2023-06-15T14:55:55.523854Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.16.jar`
- `target/lib/*.jar`
