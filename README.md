...
- Build date: 2023-10-12T18:35:45.101867Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.0.jar`
- `target/lib/*.jar`
