...
- Build date: 2024-09-04T20:36:00.070294Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.67.jar`
- `target/lib/*.jar`
