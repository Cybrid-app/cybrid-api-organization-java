...
- Build date: 2024-09-24T17:14:28.108112Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.137"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.137.jar`
- `target/lib/*.jar`
