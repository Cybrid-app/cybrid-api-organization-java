...
- Build date: 2025-03-03T14:49:41.635462Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.267"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.267.jar`
- `target/lib/*.jar`
