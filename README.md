...
- Build date: 2024-09-21T13:52:29.831309Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.129"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.129.jar`
- `target/lib/*.jar`
