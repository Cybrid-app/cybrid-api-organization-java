...
- Build date: 2025-06-13T19:53:40.338361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.585"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.585.jar`
- `target/lib/*.jar`
