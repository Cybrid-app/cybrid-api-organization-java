...
- Build date: 2025-06-05T14:22:11.264166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.554"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.554.jar`
- `target/lib/*.jar`
