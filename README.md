...
- Build date: 2024-11-20T16:51:43.340160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.11.jar`
- `target/lib/*.jar`
