...
- Build date: 2024-11-04T21:55:14.170773Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.27.jar`
- `target/lib/*.jar`
