...
- Build date: 2024-04-10T13:01:01.992811Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.75"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.75.jar`
- `target/lib/*.jar`
