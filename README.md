...
- Build date: 2024-03-13T14:18:40.186236Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.10.jar`
- `target/lib/*.jar`
