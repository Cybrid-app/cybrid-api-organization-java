...
- Build date: 2023-08-29T12:59:31.530175Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.4.jar`
- `target/lib/*.jar`
