...
- Build date: 2025-05-22T19:52:51.143449Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.518"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.518.jar`
- `target/lib/*.jar`
