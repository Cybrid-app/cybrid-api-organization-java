...
- Build date: 2023-07-28T16:44:18.879010Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.4.jar`
- `target/lib/*.jar`
