...
- Build date: 2025-05-29T13:11:14.640973Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.534"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.534.jar`
- `target/lib/*.jar`
