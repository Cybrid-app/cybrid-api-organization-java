...
- Build date: 2024-09-09T19:04:44.204371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.77"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.77.jar`
- `target/lib/*.jar`
