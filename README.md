...
- Build date: 2025-06-19T14:53:42.934014Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.606"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.606.jar`
- `target/lib/*.jar`
