...
- Build date: 2024-08-20T17:10:12.530984Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.36.jar`
- `target/lib/*.jar`
