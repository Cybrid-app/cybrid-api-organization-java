...
- Build date: 2023-07-24T12:16:41.003574Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.15.jar`
- `target/lib/*.jar`
