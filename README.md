...
- Build date: 2024-04-29T14:53:30.722628Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.127"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.127.jar`
- `target/lib/*.jar`
