...
- Build date: 2024-10-30T04:05:02.315039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.60"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.60.jar`
- `target/lib/*.jar`
