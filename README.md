...
- Build date: 2024-04-16T12:51:12.420083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.99"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.99.jar`
- `target/lib/*.jar`
