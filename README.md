...
- Build date: 2023-11-03T14:41:55.640690Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.35.jar`
- `target/lib/*.jar`
