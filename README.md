...
- Build date: 2023-09-26T12:33:10.185262Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.36.jar`
- `target/lib/*.jar`
