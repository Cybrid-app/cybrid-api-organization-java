...
- Build date: 2024-07-11T14:26:34.849954Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.76"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.76.jar`
- `target/lib/*.jar`
