...
- Build date: 2025-05-23T17:50:53.849357Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.520"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.520.jar`
- `target/lib/*.jar`
