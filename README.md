...
- Build date: 2025-03-27T17:36:25.984299Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.333"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.333.jar`
- `target/lib/*.jar`
