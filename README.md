...
- Build date: 2024-09-03T23:21:46.110364Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.62"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.62.jar`
- `target/lib/*.jar`
