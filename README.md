...
- Build date: 2025-04-24T21:51:48.475433Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.423"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.423.jar`
- `target/lib/*.jar`
