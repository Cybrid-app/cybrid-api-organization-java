...
- API version: v0.123.160

- Build date: 2025-01-23T14:25:33.555461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.160"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.160.jar`
- `target/lib/*.jar`
