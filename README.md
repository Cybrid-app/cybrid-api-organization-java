...
- Build date: 2024-06-26T17:43:53.166639Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.48.jar`
- `target/lib/*.jar`
