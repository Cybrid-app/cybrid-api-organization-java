...
- Build date: 2024-05-27T21:28:16.174921Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.18.jar`
- `target/lib/*.jar`
