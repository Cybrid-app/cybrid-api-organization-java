...
- Build date: 2024-04-25T12:58:38.012544Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.121"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.121.jar`
- `target/lib/*.jar`
