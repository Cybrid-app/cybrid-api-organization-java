...
- Build date: 2023-08-28T12:09:13.294236Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.10.jar`
- `target/lib/*.jar`
