...
- Build date: 2023-08-08T04:35:11.526366Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.7.jar`
- `target/lib/*.jar`
