...
- Build date: 2025-04-16T19:05:44.231208Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.400"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.400.jar`
- `target/lib/*.jar`
