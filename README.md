...
- Build date: 2025-06-16T20:44:07.032926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.596"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.596.jar`
- `target/lib/*.jar`
