...
- Build date: 2023-05-02T20:40:24.056494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.81"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.81.jar`
- `target/lib/*.jar`
