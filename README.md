...
- Build date: 2024-09-19T19:24:28.751881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.118"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.118.jar`
- `target/lib/*.jar`
