...
- Build date: 2023-10-26T14:25:24.161315Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.19.jar`
- `target/lib/*.jar`
