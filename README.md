...
- Build date: 2024-04-11T20:52:39.671665Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.87"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.87.jar`
- `target/lib/*.jar`
