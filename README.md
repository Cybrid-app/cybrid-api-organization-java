...
- Build date: 2025-03-28T16:03:24.872091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.338"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.338.jar`
- `target/lib/*.jar`
