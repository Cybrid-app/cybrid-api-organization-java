...
- Build date: 2023-10-17T21:46:34.952289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.108.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.108.0.jar`
- `target/lib/*.jar`
