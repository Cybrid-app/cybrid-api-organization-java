...
- Build date: 2025-05-21T12:12:29.229387Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.506"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.506.jar`
- `target/lib/*.jar`
