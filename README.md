...
- Build date: 2022-06-08T03:43:04.637411Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.5.jar`
- `target/lib/*.jar`
