...
- Build date: 2025-02-12T17:44:22.836627Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.228"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.228.jar`
- `target/lib/*.jar`
