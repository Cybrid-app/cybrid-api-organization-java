...
- Build date: 2023-10-04T17:40:36.475707Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.3.jar`
- `target/lib/*.jar`
