...
- Build date: 2025-05-22T15:31:30.982200Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.515"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.515.jar`
- `target/lib/*.jar`
