...
- Build date: 2023-12-11T18:35:22.154992Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.27.jar`
- `target/lib/*.jar`
