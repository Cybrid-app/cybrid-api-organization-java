...
- Build date: 2025-05-27T10:42:17.881494Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.528"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.528.jar`
- `target/lib/*.jar`
