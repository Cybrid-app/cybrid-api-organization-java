...
- Build date: 2024-07-25T14:14:52.373982Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.93"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.93.jar`
- `target/lib/*.jar`
