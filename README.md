...
- Build date: 2024-08-19T13:40:05.620163Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.30.jar`
- `target/lib/*.jar`
