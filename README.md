...
- Build date: 2024-01-08T13:58:54.946831Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.55.jar`
- `target/lib/*.jar`
