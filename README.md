...
- Build date: 2024-10-18T15:45:13.229381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.22.jar`
- `target/lib/*.jar`
