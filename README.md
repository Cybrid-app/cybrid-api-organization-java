...
- Build date: 2024-02-16T14:36:57.404926Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.154"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.154.jar`
- `target/lib/*.jar`
