...
- Build date: 2025-02-04T21:46:01.427344Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.204"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.204.jar`
- `target/lib/*.jar`
