...
- Build date: 2023-08-23T12:28:18.492804Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.4.jar`
- `target/lib/*.jar`
