...
- Build date: 2022-06-07T18:09:54.729938Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.21.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.21.0.jar`
- `target/lib/*.jar`
