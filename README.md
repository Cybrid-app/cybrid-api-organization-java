...
- Build date: 2023-05-26T15:17:52.934361Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.52.jar`
- `target/lib/*.jar`
