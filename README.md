...
- Build date: 2024-01-18T21:48:16.177041Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.72.jar`
- `target/lib/*.jar`
