...
- Build date: 2023-11-28T23:30:43.946017Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.4.jar`
- `target/lib/*.jar`
