...
- Build date: 2022-05-03T11:20:56.001264Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.15.jar`
- `target/lib/*.jar`
