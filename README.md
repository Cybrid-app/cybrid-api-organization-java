...
- Build date: 2024-03-05T16:44:44.827934Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.39.jar`
- `target/lib/*.jar`
