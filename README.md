...
- Build date: 2024-03-23T15:45:41.360598Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.33.jar`
- `target/lib/*.jar`
