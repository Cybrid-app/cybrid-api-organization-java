...
- Build date: 2024-12-04T22:21:35.648148Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.56.jar`
- `target/lib/*.jar`
