...
- Build date: 2023-07-18T14:00:44.841963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.18.jar`
- `target/lib/*.jar`
