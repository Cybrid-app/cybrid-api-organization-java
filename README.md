...
- Build date: 2024-08-27T21:00:04.313138Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.49.jar`
- `target/lib/*.jar`
