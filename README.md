...
- Build date: 2024-05-22T21:36:18.427677Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.7.jar`
- `target/lib/*.jar`
