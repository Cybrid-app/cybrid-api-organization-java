...
- Build date: 2025-06-16T21:32:03.613837Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.597"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.597.jar`
- `target/lib/*.jar`
