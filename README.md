...
- Build date: 2025-06-04T18:10:46.666791Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.550"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.550.jar`
- `target/lib/*.jar`
