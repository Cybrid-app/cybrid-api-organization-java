...
- Build date: 2024-09-04T15:23:18.074891Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.64.jar`
- `target/lib/*.jar`
