...
- Build date: 2025-06-09T15:00:51.934843Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.562"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.562.jar`
- `target/lib/*.jar`
