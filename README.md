...
- Build date: 2024-01-25T14:59:45.004043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.96"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.96.jar`
- `target/lib/*.jar`
