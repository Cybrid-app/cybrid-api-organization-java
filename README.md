...
- Build date: 2022-05-27T19:32:16.014118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.7.jar`
- `target/lib/*.jar`
