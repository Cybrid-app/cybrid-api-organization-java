...
- Build date: 2023-06-29T20:29:07.695101Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.24.jar`
- `target/lib/*.jar`
