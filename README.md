...
- Build date: 2023-08-12T22:12:56.706559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.0.jar`
- `target/lib/*.jar`
