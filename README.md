...
- Build date: 2025-02-25T23:54:21.849753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.257"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.257.jar`
- `target/lib/*.jar`
