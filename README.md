...
- Build date: 2025-05-09T22:35:02.400121Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.473"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.473.jar`
- `target/lib/*.jar`
