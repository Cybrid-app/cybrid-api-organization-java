...
- Build date: 2023-11-13T15:36:54.638688Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.53.jar`
- `target/lib/*.jar`
