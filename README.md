...
- Build date: 2025-06-11T18:50:41.626537Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.576"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.576.jar`
- `target/lib/*.jar`
