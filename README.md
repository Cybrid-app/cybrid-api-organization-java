...
- Build date: 2024-05-24T22:46:16.851742Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.13.jar`
- `target/lib/*.jar`
