...
- Build date: 2023-08-10T19:02:57.191392Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.8.jar`
- `target/lib/*.jar`
