...
- API version: v0.118.20

- Build date: 2024-06-12T16:47:46.695843Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.20.jar`
- `target/lib/*.jar`
