...
- Build date: 2022-05-17T16:40:00.966072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.10.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.10.0.jar`
- `target/lib/*.jar`
