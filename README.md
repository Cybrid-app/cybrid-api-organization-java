...
- Build date: 2024-06-11T12:22:41.107649Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.16.jar`
- `target/lib/*.jar`
