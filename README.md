...
- Build date: 2024-10-31T22:30:22.556752Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.16.jar`
- `target/lib/*.jar`
