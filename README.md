...
- Build date: 2024-02-14T15:17:19.975074Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.143"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.143.jar`
- `target/lib/*.jar`
