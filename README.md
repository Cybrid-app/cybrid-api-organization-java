...
- Build date: 2024-02-22T19:12:51.490477Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.12.jar`
- `target/lib/*.jar`
