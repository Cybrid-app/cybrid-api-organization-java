...
- Build date: 2025-03-19T16:57:31.286329Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.310"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.310.jar`
- `target/lib/*.jar`
