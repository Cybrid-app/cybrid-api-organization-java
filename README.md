...
- Build date: 2025-06-05T12:27:08.078015Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.553"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.553.jar`
- `target/lib/*.jar`
