...
- Build date: 2025-05-21T18:54:04.628905Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.509"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.509.jar`
- `target/lib/*.jar`
