...
- Build date: 2023-05-23T21:39:20.001537Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.35.jar`
- `target/lib/*.jar`
