...
- Build date: 2024-12-12T21:59:04.050515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.84"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.84.jar`
- `target/lib/*.jar`
