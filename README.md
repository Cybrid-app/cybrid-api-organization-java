...
- Build date: 2023-06-29T17:37:33.884674Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.23.jar`
- `target/lib/*.jar`
