...
- Build date: 2023-09-20T14:28:51.670687Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.22.jar`
- `target/lib/*.jar`
