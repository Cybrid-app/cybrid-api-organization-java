...
- Build date: 2022-05-24T11:11:29.811883Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.2.jar`
- `target/lib/*.jar`
