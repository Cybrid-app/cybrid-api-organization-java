...
- Build date: 2024-11-08T23:05:14.794389Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.51"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.51.jar`
- `target/lib/*.jar`
