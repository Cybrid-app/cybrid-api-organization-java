...
- Build date: 2025-05-20T18:43:43.384424Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.501"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.501.jar`
- `target/lib/*.jar`
