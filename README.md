...
- Build date: 2023-09-05T18:08:26.075230Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.2.jar`
- `target/lib/*.jar`
