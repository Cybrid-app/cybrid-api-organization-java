...
- Build date: 2025-06-02T15:30:01.507162Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.540"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.540.jar`
- `target/lib/*.jar`
