...
- Build date: 2024-01-18T15:11:57.619252Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.70.jar`
- `target/lib/*.jar`
