...
- Build date: 2024-05-03T13:49:33.542076Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.137"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.137.jar`
- `target/lib/*.jar`
