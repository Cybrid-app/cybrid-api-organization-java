...
- Build date: 2023-10-26T19:51:42.273780Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.23.jar`
- `target/lib/*.jar`
