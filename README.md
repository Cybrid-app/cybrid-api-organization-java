...
- Build date: 2024-05-31T14:02:12.467499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.23.jar`
- `target/lib/*.jar`
