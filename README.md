...
- Build date: 2024-09-20T13:21:15.642371Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.122"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.122.jar`
- `target/lib/*.jar`
