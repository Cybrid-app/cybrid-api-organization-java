...
- Build date: 2024-11-01T12:39:33.133183Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.18.jar`
- `target/lib/*.jar`
