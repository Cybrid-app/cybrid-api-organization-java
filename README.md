...
- Build date: 2024-09-20T02:31:33.113303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.121"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.121.jar`
- `target/lib/*.jar`
