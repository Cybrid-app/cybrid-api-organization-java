...
- Build date: 2023-06-27T17:28:15.193796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.16.jar`
- `target/lib/*.jar`
