...
- Build date: 2023-12-22T13:45:45.575671Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.36.jar`
- `target/lib/*.jar`
