...
- Build date: 2023-09-13T21:38:38.214360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.5.jar`
- `target/lib/*.jar`
