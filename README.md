...
- Build date: 2025-06-03T14:23:12.005345Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.547"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.547.jar`
- `target/lib/*.jar`
