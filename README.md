...
- Build date: 2025-06-09T17:56:02.319942Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.565"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.565.jar`
- `target/lib/*.jar`
