...
- Build date: 2024-01-15T20:00:07.019726Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.63.jar`
- `target/lib/*.jar`
