...
- Build date: 2024-12-30T17:09:02.703865Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.111"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.111.jar`
- `target/lib/*.jar`
