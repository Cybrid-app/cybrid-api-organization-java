...
- Build date: 2022-05-31T14:13:16.552262Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.17.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.17.0.jar`
- `target/lib/*.jar`
