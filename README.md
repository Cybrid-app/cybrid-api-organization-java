...
- Build date: 2024-02-22T16:12:21.518474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.10.jar`
- `target/lib/*.jar`
