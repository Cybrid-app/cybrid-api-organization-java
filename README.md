...
- Build date: 2025-02-04T14:17:12.881498Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.195"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.195.jar`
- `target/lib/*.jar`
