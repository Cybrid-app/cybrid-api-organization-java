...
- Build date: 2022-05-03T11:40:38.459660Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.3.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.3.16.jar`
- `target/lib/*.jar`
