...
- Build date: 2024-10-02T17:02:34.676365Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.163"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.163.jar`
- `target/lib/*.jar`
