...
- Build date: 2025-02-18T22:24:04.002665Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.239"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.239.jar`
- `target/lib/*.jar`
