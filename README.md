...
- Build date: 2024-05-17T17:37:12.747397Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.6.jar`
- `target/lib/*.jar`
