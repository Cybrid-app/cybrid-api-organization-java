...
- Build date: 2023-04-28T19:21:23.002777Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.72.jar`
- `target/lib/*.jar`
