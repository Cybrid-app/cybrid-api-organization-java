...
- Build date: 2023-04-10T16:27:31.056497Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.30.jar`
- `target/lib/*.jar`
