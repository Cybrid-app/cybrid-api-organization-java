...
- Build date: 2024-12-10T18:22:52.391947Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.72"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.72.jar`
- `target/lib/*.jar`
