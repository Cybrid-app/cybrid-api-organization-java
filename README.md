...
- Build date: 2025-03-27T15:20:48.111425Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.332"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.332.jar`
- `target/lib/*.jar`
