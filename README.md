...
- Build date: 2025-06-09T14:08:27.214777Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.561"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.561.jar`
- `target/lib/*.jar`
