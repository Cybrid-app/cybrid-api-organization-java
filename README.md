...
- Build date: 2023-06-27T12:01:47.019925Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.13.jar`
- `target/lib/*.jar`
