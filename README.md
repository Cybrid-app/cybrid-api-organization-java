...
- Build date: 2023-09-07T00:15:19.957306Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.8.jar`
- `target/lib/*.jar`
