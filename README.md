...
- Build date: 2025-04-23T11:27:13.498376Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.414"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.414.jar`
- `target/lib/*.jar`
