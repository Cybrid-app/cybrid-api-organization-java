...
- Build date: 2025-05-21T20:28:29.717813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.511"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.511.jar`
- `target/lib/*.jar`
