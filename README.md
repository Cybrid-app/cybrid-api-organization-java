...
- Build date: 2025-01-07T17:09:53.370384Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.127"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.127.jar`
- `target/lib/*.jar`
