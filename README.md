...
- Build date: 2023-07-12T19:51:16.018016Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.6.jar`
- `target/lib/*.jar`
