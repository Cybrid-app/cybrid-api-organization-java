...
- Build date: 2023-05-26T12:21:14.457928Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.49.jar`
- `target/lib/*.jar`
