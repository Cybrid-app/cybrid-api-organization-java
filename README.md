...
- Build date: 2023-07-04T14:17:07.478206Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.26.jar`
- `target/lib/*.jar`
