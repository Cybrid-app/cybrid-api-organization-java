...
- Build date: 2023-06-26T13:23:41.461279Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.7.jar`
- `target/lib/*.jar`
