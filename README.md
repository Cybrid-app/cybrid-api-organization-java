...
- Build date: 2025-04-10T20:45:05.909489Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.377"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.377.jar`
- `target/lib/*.jar`
