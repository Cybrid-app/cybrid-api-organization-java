...
- Build date: 2023-05-26T13:26:05.599813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.50.jar`
- `target/lib/*.jar`
