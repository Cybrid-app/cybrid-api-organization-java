...
- Build date: 2023-08-08T02:14:45.761699Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.82.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.82.4.jar`
- `target/lib/*.jar`
