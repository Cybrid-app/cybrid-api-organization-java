...
- Build date: 2023-09-04T22:35:28.451848Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.0.jar`
- `target/lib/*.jar`
