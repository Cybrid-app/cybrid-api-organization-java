...
- Build date: 2025-04-30T15:48:26.771614Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.439"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.439.jar`
- `target/lib/*.jar`
