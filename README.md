...
- Build date: 2023-08-18T19:05:58.031455Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.15.jar`
- `target/lib/*.jar`
