...
- Build date: 2024-07-30T16:17:14.128154Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.111"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.111.jar`
- `target/lib/*.jar`
