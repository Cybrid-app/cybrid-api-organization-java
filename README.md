...
- Build date: 2025-06-10T21:22:21.525894Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.571"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.571.jar`
- `target/lib/*.jar`
