...
- Build date: 2024-11-05T14:45:16.212278Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.30.jar`
- `target/lib/*.jar`
