...
- Build date: 2024-01-19T19:06:23.236605Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.76"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.76.jar`
- `target/lib/*.jar`
