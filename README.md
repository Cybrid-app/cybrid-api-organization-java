...
- Build date: 2024-10-01T14:31:27.108580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.157"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.157.jar`
- `target/lib/*.jar`
