...
- Build date: 2023-08-03T12:32:28.354342Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.26.jar`
- `target/lib/*.jar`
