...
- Build date: 2023-09-04T10:46:15.293108Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.90.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.90.7.jar`
- `target/lib/*.jar`
