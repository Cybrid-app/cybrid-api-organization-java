...
- Build date: 2022-05-10T10:27:15.443850Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.7.jar`
- `target/lib/*.jar`
