...
- Build date: 2023-12-13T12:14:36.692556Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.38.jar`
- `target/lib/*.jar`
