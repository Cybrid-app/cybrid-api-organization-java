...
- Build date: 2022-05-05T18:51:15.235033Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.5.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.5.0.jar`
- `target/lib/*.jar`
