...
- Build date: 2025-04-03T18:23:39.405573Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.356"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.356.jar`
- `target/lib/*.jar`
