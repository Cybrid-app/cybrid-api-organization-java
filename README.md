...
- Build date: 2023-10-12T12:31:44.387722Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.104.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.104.2.jar`
- `target/lib/*.jar`
