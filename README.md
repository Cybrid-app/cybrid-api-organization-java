...
- Build date: 2025-05-26T18:22:40.232631Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.525"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.525.jar`
- `target/lib/*.jar`
