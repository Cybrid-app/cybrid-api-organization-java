...
- Build date: 2023-12-12T16:23:40.435360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.36.jar`
- `target/lib/*.jar`
