...
- Build date: 2024-01-27T18:52:33.559652Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.104"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.104.jar`
- `target/lib/*.jar`
