...
- Build date: 2025-03-06T17:42:35.636134Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.277"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.277.jar`
- `target/lib/*.jar`
