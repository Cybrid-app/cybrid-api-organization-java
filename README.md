...
- Build date: 2025-02-10T19:10:42.874540Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.224"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.224.jar`
- `target/lib/*.jar`
