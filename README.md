...
- Build date: 2024-12-10T20:49:11.032535Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.74"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.74.jar`
- `target/lib/*.jar`
