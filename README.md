...
- Build date: 2025-04-21T19:12:56.242077Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.408"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.408.jar`
- `target/lib/*.jar`
