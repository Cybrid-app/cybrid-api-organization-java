...
- Build date: 2024-03-25T14:01:18.685825Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.34.jar`
- `target/lib/*.jar`
