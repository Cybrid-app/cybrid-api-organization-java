...
- Build date: 2025-02-05T18:42:25.193461Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.211"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.211.jar`
- `target/lib/*.jar`
