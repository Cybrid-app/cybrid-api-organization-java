...
- Build date: 2025-02-21T16:48:36.507610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.245"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.245.jar`
- `target/lib/*.jar`
