...
- Build date: 2024-11-20T19:36:32.576485Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.12.jar`
- `target/lib/*.jar`
