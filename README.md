...
- Build date: 2024-08-27T14:41:11.148569Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.46.jar`
- `target/lib/*.jar`
