...
- Build date: 2024-05-27T13:19:15.466432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.15.jar`
- `target/lib/*.jar`
