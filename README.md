...
- Build date: 2022-05-17T14:51:44.524753Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.8.jar`
- `target/lib/*.jar`
