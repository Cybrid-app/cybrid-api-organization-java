...
- Build date: 2023-08-22T21:38:24.513655Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.86.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.86.2.jar`
- `target/lib/*.jar`
