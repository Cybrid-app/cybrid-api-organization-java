...
- Build date: 2023-08-02T11:23:59.354042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.23.jar`
- `target/lib/*.jar`
