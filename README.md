...
- Build date: 2022-05-30T14:30:42.105853Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.16.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.16.0.jar`
- `target/lib/*.jar`
