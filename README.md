...
- Build date: 2023-06-01T12:44:39.318183Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.62"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.62.jar`
- `target/lib/*.jar`
