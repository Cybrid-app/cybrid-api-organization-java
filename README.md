...
- Build date: 2024-11-13T18:13:43.815988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.64.jar`
- `target/lib/*.jar`
