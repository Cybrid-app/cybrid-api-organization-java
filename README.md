...
- Build date: 2023-05-19T11:36:10.530491Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.28"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.28.jar`
- `target/lib/*.jar`
