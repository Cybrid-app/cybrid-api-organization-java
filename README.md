...
- Build date: 2024-09-18T00:55:54.907346Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.109"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.109.jar`
- `target/lib/*.jar`
