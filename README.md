...
- Build date: 2025-04-28T14:39:56.810830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.431"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.431.jar`
- `target/lib/*.jar`
