...
- Build date: 2024-04-10T16:09:27.552471Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.79"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.79.jar`
- `target/lib/*.jar`
