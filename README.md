...
- Build date: 2024-09-10T14:42:59.867932Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.80"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.80.jar`
- `target/lib/*.jar`
