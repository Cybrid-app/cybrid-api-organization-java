...
- Build date: 2025-02-11T13:44:46.706710Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.225"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.225.jar`
- `target/lib/*.jar`
