...
- Build date: 2024-03-26T17:13:46.531398Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.40"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.40.jar`
- `target/lib/*.jar`
