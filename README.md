...
- Build date: 2022-05-11T15:18:01.962724Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.17.jar`
- `target/lib/*.jar`
