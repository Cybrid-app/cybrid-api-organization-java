...
- Build date: 2024-08-16T00:46:13.441996Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.27.jar`
- `target/lib/*.jar`
