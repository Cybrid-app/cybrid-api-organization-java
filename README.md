...
- Build date: 2023-08-18T22:02:30.368339Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.1.jar`
- `target/lib/*.jar`
