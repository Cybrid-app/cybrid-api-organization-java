...
- Build date: 2024-04-11T15:15:07.592269Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.85"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.85.jar`
- `target/lib/*.jar`
