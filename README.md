...
- Build date: 2023-08-30T12:40:39.580332Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.5.jar`
- `target/lib/*.jar`
