...
- Build date: 2023-05-02T23:03:02.877290Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.82"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.82.jar`
- `target/lib/*.jar`
