...
- Build date: 2024-09-20T14:19:39.647595Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.123"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.123.jar`
- `target/lib/*.jar`
