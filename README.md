...
- Build date: 2024-09-23T20:25:05.751154Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.133"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.133.jar`
- `target/lib/*.jar`
