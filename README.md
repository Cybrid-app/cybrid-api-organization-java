...
- Build date: 2022-05-26T14:44:11.374577Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.20.jar`
- `target/lib/*.jar`
