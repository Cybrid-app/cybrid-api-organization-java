...
- Build date: 2023-07-28T13:19:57.003376Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.3.jar`
- `target/lib/*.jar`
