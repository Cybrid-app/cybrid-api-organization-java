...
- Build date: 2023-09-25T14:11:50.952295Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.33.jar`
- `target/lib/*.jar`
