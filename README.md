...
- Build date: 2024-09-18T18:31:48.300921Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.113"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.113.jar`
- `target/lib/*.jar`
