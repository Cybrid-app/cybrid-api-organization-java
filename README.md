...
- Build date: 2024-08-28T13:43:11.286251Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.50.jar`
- `target/lib/*.jar`
