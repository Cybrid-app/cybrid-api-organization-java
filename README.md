...
- Build date: 2023-10-18T16:27:55.462219Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.0.jar`
- `target/lib/*.jar`
