...
- Build date: 2023-08-15T19:52:03.049749Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.8.jar`
- `target/lib/*.jar`
