...
- Build date: 2024-02-09T13:34:01.882525Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.128"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.128.jar`
- `target/lib/*.jar`
