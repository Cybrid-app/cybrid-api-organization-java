...
- Build date: 2024-12-12T21:28:30.833407Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.83"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.83.jar`
- `target/lib/*.jar`
