...
- Build date: 2025-05-05T17:53:27.417918Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.449"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.449.jar`
- `target/lib/*.jar`
