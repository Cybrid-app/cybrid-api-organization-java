...
- Build date: 2025-03-17T21:37:44.548235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.300"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.300.jar`
- `target/lib/*.jar`
