...
- Build date: 2024-09-19T15:26:28.278964Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.117"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.117.jar`
- `target/lib/*.jar`
