...
- Build date: 2023-05-03T14:31:25.167648Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.83"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.83.jar`
- `target/lib/*.jar`
