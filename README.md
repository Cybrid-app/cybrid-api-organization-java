...
- Build date: 2024-12-30T18:27:49.295584Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.112"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.112.jar`
- `target/lib/*.jar`
