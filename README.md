...
- Build date: 2023-06-19T21:39:29.404940Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.30.jar`
- `target/lib/*.jar`
