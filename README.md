...
- Build date: 2023-08-30T13:56:00.892489Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.6.jar`
- `target/lib/*.jar`
