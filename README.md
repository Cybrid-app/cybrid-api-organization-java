...
- Build date: 2024-10-23T13:40:05.379729Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.36.jar`
- `target/lib/*.jar`
