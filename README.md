...
- Build date: 2024-06-03T15:38:05.437595Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.30"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.30.jar`
- `target/lib/*.jar`
