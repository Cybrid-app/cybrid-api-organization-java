...
- Build date: 2024-05-20T14:30:51.998815Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.116.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.116.8.jar`
- `target/lib/*.jar`
