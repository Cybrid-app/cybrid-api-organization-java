...
- Build date: 2023-05-10T19:02:24.761304Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.12.jar`
- `target/lib/*.jar`
