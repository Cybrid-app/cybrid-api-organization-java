...
- Build date: 2025-06-17T15:09:15.578681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.598"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.598.jar`
- `target/lib/*.jar`
