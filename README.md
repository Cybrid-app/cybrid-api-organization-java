...
- Build date: 2024-02-23T17:16:38.447340Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.15.jar`
- `target/lib/*.jar`
