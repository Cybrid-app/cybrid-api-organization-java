...
- Build date: 2023-05-10T20:23:15.211224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.13.jar`
- `target/lib/*.jar`
