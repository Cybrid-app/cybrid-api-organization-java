...
- Build date: 2024-10-15T17:19:36.341041Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.7.jar`
- `target/lib/*.jar`
