...
- Build date: 2023-11-09T16:33:58.425119Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.44"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.44.jar`
- `target/lib/*.jar`
