...
- Build date: 2023-09-18T12:33:23.899379Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.15.jar`
- `target/lib/*.jar`
