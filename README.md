...
- Build date: 2023-10-16T12:33:54.695224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.4.jar`
- `target/lib/*.jar`
