...
- API version: v0.115.123

- Build date: 2024-04-25T16:10:40.857815Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.123"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.123.jar`
- `target/lib/*.jar`
