...
- Build date: 2024-09-10T15:52:18.622185Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.81"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.81.jar`
- `target/lib/*.jar`
