...
- Build date: 2024-02-09T16:58:56.708158Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.132"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.132.jar`
- `target/lib/*.jar`
