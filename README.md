...
- Build date: 2025-06-02T10:31:42.988546Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.539"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.539.jar`
- `target/lib/*.jar`
