...
- Build date: 2025-02-04T17:21:31.915042Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.198"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.198.jar`
- `target/lib/*.jar`
