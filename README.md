...
- Build date: 2024-05-21T18:49:10.058881Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.1.jar`
- `target/lib/*.jar`
