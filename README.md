...
- Build date: 2025-05-20T11:46:32.377623Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.498"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.498.jar`
- `target/lib/*.jar`
