...
- Build date: 2024-10-24T21:40:41.339136Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.43.jar`
- `target/lib/*.jar`
