...
- Build date: 2022-05-14T19:12:22.781930Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.12.jar`
- `target/lib/*.jar`
