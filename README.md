...
- Build date: 2025-04-16T18:06:15.139154Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.399"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.399.jar`
- `target/lib/*.jar`
