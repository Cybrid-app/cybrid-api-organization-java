...
- Build date: 2022-05-20T13:25:29.441797Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.13.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.13.2.jar`
- `target/lib/*.jar`
