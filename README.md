...
- Build date: 2022-06-04T16:22:44.790596Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.8.jar`
- `target/lib/*.jar`
