...
- Build date: 2023-12-04T23:34:42.418949Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.5.jar`
- `target/lib/*.jar`
