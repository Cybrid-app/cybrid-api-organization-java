...
- Build date: 2024-04-02T14:51:52.421453Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.56.jar`
- `target/lib/*.jar`
