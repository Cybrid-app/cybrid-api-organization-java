...
- Build date: 2025-03-13T17:37:34.091918Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.293"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.293.jar`
- `target/lib/*.jar`
