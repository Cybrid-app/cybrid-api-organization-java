...
- Build date: 2023-08-28T20:29:43.804087Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.2.jar`
- `target/lib/*.jar`
