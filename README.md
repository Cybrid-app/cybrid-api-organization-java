...
- Build date: 2025-02-06T14:04:14.556294Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.214"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.214.jar`
- `target/lib/*.jar`
