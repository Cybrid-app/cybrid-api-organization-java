...
- Build date: 2024-09-12T20:54:19.112972Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.93"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.93.jar`
- `target/lib/*.jar`
