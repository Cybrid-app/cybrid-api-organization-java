...
- Build date: 2025-06-14T12:21:32.556690Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.587"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.587.jar`
- `target/lib/*.jar`
