...
- Build date: 2022-05-07T02:32:38.897182Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.0.jar`
- `target/lib/*.jar`
