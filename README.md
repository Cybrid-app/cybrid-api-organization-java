...
- Build date: 2023-05-12T14:37:36.239279Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.19.jar`
- `target/lib/*.jar`
