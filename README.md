...
- Build date: 2024-08-07T00:15:17.698737Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.6.jar`
- `target/lib/*.jar`
