...
- Build date: 2024-10-04T16:52:59.878072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.0.jar`
- `target/lib/*.jar`
