...
- Build date: 2025-01-04T18:13:15.702270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.122"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.122.jar`
- `target/lib/*.jar`
