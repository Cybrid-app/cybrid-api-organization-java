...
- Build date: 2025-04-17T18:34:28.325962Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.405"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.405.jar`
- `target/lib/*.jar`
