...
- Build date: 2022-06-06T10:25:40.946976Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.11.jar`
- `target/lib/*.jar`
