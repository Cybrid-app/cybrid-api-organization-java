...
- Build date: 2024-01-04T14:18:03.461891Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.47.jar`
- `target/lib/*.jar`
