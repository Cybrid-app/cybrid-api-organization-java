...
- Build date: 2023-05-31T11:58:35.831778Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.61.jar`
- `target/lib/*.jar`
