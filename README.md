...
- Build date: 2024-11-01T01:06:19.304982Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.17.jar`
- `target/lib/*.jar`
