...
- Build date: 2024-04-30T18:47:02.485637Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.130"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.130.jar`
- `target/lib/*.jar`
