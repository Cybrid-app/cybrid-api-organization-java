...
- Build date: 2024-07-04T19:54:00.985044Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.66"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.66.jar`
- `target/lib/*.jar`
