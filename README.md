...
- Build date: 2023-06-21T15:29:14.003678Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.37.jar`
- `target/lib/*.jar`
