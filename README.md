...
- Build date: 2023-04-14T13:16:15.516046Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.48"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.48.jar`
- `target/lib/*.jar`
