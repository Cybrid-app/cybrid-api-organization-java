...
- Build date: 2024-01-22T16:33:04.172923Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.84"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.84.jar`
- `target/lib/*.jar`
