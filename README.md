...
- Build date: 2023-11-23T17:57:45.727768Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.24.jar`
- `target/lib/*.jar`
