...
- Build date: 2024-12-10T16:14:15.125718Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.70"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.70.jar`
- `target/lib/*.jar`
