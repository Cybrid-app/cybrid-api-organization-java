...
- Build date: 2022-05-10T11:43:36.099559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.11.jar`
- `target/lib/*.jar`
