...
- Build date: 2023-04-11T14:24:45.039964Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.33"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.33.jar`
- `target/lib/*.jar`
