...
- Build date: 2024-09-09T17:44:15.626218Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.76"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.76.jar`
- `target/lib/*.jar`
