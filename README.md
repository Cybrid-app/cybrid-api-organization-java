...
- Build date: 2023-10-26T18:18:30.845792Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.22.jar`
- `target/lib/*.jar`
