...
- Build date: 2023-07-18T20:05:09.039705Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.21.jar`
- `target/lib/*.jar`
