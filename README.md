...
- Build date: 2025-04-22T18:42:56.022932Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.410"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.410.jar`
- `target/lib/*.jar`
