...
- API version: v0.115.113

- Build date: 2024-04-22T12:28:30.222963Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.113"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.113.jar`
- `target/lib/*.jar`
