...
- Build date: 2023-12-19T13:19:32.606208Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.19.jar`
- `target/lib/*.jar`
