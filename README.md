...
- Build date: 2024-09-18T14:57:22.747176Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.111"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.111.jar`
- `target/lib/*.jar`
