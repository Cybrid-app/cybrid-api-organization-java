...
- Build date: 2025-05-22T13:22:41.511930Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.514"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.514.jar`
- `target/lib/*.jar`
