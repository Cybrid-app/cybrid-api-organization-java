...
- Build date: 2024-12-05T22:06:17.682628Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.61"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.61.jar`
- `target/lib/*.jar`
