...
- Build date: 2023-09-07T13:12:58.276118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.11.jar`
- `target/lib/*.jar`
