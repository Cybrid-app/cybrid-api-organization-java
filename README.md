...
- Build date: 2022-05-11T14:39:21.624469Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.15.jar`
- `target/lib/*.jar`
