...
- Build date: 2024-12-03T16:21:24.361126Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.49.jar`
- `target/lib/*.jar`
