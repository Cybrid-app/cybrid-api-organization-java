...
- Build date: 2024-10-04T13:23:31.976701Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.170"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.170.jar`
- `target/lib/*.jar`
