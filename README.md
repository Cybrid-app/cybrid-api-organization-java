...
- API version: v0.123.170

- Build date: 2025-01-27T20:48:26.017788Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.170"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.170.jar`
- `target/lib/*.jar`
