...
- Build date: 2024-09-16T16:27:23.286758Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.98"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.98.jar`
- `target/lib/*.jar`
