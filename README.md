...
- Build date: 2023-09-07T15:08:35.628303Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.12.jar`
- `target/lib/*.jar`
