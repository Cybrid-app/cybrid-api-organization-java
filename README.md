...
- Build date: 2024-05-23T18:19:52.891896Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.9.jar`
- `target/lib/*.jar`
