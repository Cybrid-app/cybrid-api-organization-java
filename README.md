...
- Build date: 2024-08-23T14:51:40.600640Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.43.jar`
- `target/lib/*.jar`
