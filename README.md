...
- Build date: 2024-01-15T21:19:56.928382Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.65.jar`
- `target/lib/*.jar`
