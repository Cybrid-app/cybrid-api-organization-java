...
- Build date: 2023-12-08T14:17:38.710520Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.16.jar`
- `target/lib/*.jar`
