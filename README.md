...
- Build date: 2023-08-19T21:41:27.269012Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.85.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.85.4.jar`
- `target/lib/*.jar`
