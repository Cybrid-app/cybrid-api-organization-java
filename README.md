...
- Build date: 2022-05-24T15:02:13.678900Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.7.jar`
- `target/lib/*.jar`
