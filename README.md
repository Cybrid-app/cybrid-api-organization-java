...
- Build date: 2024-04-16T18:21:41.524231Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.102"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.102.jar`
- `target/lib/*.jar`
