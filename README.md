...
- Build date: 2023-09-22T21:18:31.354552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.31.jar`
- `target/lib/*.jar`
