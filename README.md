...
- Build date: 2024-01-22T14:06:25.321449Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.83"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.83.jar`
- `target/lib/*.jar`
