...
- Build date: 2022-05-25T11:25:18.293895Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.11.jar`
- `target/lib/*.jar`
