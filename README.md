...
- Build date: 2025-06-16T17:20:05.056509Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.592"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.592.jar`
- `target/lib/*.jar`
