...
- Build date: 2022-05-19T12:33:14.809365Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.12.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.12.4.jar`
- `target/lib/*.jar`
