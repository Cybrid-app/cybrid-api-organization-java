...
- Build date: 2025-01-06T12:52:13.582751Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.123"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.123.jar`
- `target/lib/*.jar`
