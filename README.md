...
- Build date: 2024-12-09T15:24:10.630270Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.67"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.67.jar`
- `target/lib/*.jar`
