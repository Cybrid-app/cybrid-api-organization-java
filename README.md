...
- Build date: 2023-11-21T17:44:45.266427Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.16.jar`
- `target/lib/*.jar`
