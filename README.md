...
- Build date: 2024-11-18T16:38:14.542738Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.3.jar`
- `target/lib/*.jar`
