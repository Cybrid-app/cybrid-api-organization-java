...
- Build date: 2024-11-01T21:45:58.028970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.20.jar`
- `target/lib/*.jar`
