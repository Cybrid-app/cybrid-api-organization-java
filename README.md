...
- Build date: 2023-05-08T18:17:45.707093Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.0.jar`
- `target/lib/*.jar`
