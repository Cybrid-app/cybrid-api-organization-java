...
- Build date: 2024-02-16T13:31:00.875075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.153"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.153.jar`
- `target/lib/*.jar`
