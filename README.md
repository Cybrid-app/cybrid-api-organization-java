...
- Build date: 2024-02-28T13:44:32.381451Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.25.jar`
- `target/lib/*.jar`
