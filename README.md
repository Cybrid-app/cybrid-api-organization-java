...
- Build date: 2023-04-18T15:29:18.605269Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.53"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.53.jar`
- `target/lib/*.jar`
