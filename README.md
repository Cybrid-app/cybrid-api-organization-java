...
- Build date: 2024-11-08T17:34:33.170609Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.46.jar`
- `target/lib/*.jar`
