...
- Build date: 2025-06-16T16:40:06.822064Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.591"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.591.jar`
- `target/lib/*.jar`
