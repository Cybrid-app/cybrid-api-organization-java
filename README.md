...
- Build date: 2024-09-17T21:22:16.598132Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.108"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.108.jar`
- `target/lib/*.jar`
