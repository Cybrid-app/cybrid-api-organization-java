...
- Build date: 2024-09-17T20:02:19.333193Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.106"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.106.jar`
- `target/lib/*.jar`
