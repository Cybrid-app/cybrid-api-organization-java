...
- Build date: 2023-06-19T13:42:36.304446Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.24.jar`
- `target/lib/*.jar`
