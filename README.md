...
- Build date: 2022-05-11T21:56:24.493959Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.1.jar`
- `target/lib/*.jar`
