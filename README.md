...
- Build date: 2024-09-30T19:28:41.776004Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.155"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.155.jar`
- `target/lib/*.jar`
