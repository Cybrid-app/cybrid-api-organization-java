...
- Build date: 2025-04-14T13:31:28.082324Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.383"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.383.jar`
- `target/lib/*.jar`
