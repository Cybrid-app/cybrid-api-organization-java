...
- Build date: 2022-05-11T14:57:34.386575Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.16.jar`
- `target/lib/*.jar`
