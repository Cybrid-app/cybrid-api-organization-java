...
- Build date: 2023-10-25T20:51:06.694177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.17.jar`
- `target/lib/*.jar`
