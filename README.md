...
- Build date: 2022-05-18T18:17:28.817974Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.11.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.11.0.jar`
- `target/lib/*.jar`
