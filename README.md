...
- Build date: 2022-06-14T15:19:03.006865Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.26.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.26.0.jar`
- `target/lib/*.jar`
