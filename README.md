...
- Build date: 2023-08-31T16:20:40.875853Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.90.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.90.2.jar`
- `target/lib/*.jar`
