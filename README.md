...
- Build date: 2024-01-10T19:32:45.601813Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.59"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.59.jar`
- `target/lib/*.jar`
