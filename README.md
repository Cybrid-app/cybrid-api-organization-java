...
- Build date: 2025-06-13T19:09:39.565280Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.584"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.584.jar`
- `target/lib/*.jar`
