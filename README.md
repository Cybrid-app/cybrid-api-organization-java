...
- Build date: 2024-10-09T14:10:42.964082Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.14.jar`
- `target/lib/*.jar`
