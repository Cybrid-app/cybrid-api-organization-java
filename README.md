...
- Build date: 2023-10-05T22:36:38.463669Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.96.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.96.1.jar`
- `target/lib/*.jar`
