...
- Build date: 2025-06-26T17:13:22.974697Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.645"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.645.jar`
- `target/lib/*.jar`
