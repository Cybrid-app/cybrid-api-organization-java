...
- Build date: 2023-11-06T15:15:53.878199Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.38"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.38.jar`
- `target/lib/*.jar`
