...
- Build date: 2025-05-26T10:11:28.588043Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.522"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.522.jar`
- `target/lib/*.jar`
