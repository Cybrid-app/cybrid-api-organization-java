...
- Build date: 2024-07-02T19:31:15.181590Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.57.jar`
- `target/lib/*.jar`
