...
- Build date: 2023-08-01T18:47:48.465764Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.19.jar`
- `target/lib/*.jar`
