...
- Build date: 2025-03-17T22:16:17.993580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.301"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.301.jar`
- `target/lib/*.jar`
