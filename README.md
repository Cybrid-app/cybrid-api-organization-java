...
- Build date: 2025-02-05T22:16:58.006673Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.213"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.213.jar`
- `target/lib/*.jar`
