...
- Build date: 2023-10-04T14:34:27.909851Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.0.jar`
- `target/lib/*.jar`
