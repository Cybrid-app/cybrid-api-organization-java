...
- Build date: 2023-07-31T23:03:46.030592Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.13.jar`
- `target/lib/*.jar`
