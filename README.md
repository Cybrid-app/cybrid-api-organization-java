...
- Build date: 2022-05-10T13:49:08.237356Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.13.jar`
- `target/lib/*.jar`
