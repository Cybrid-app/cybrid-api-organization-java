...
- Build date: 2023-09-14T20:35:07.930350Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.8.jar`
- `target/lib/*.jar`
