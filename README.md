...
- Build date: 2024-02-06T17:36:08.464503Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.122"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.122.jar`
- `target/lib/*.jar`
