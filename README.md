...
- Build date: 2025-05-15T19:57:35.140662Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.488"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.488.jar`
- `target/lib/*.jar`
