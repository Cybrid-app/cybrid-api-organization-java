...
- Build date: 2024-10-02T15:48:10.004658Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.162"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.162.jar`
- `target/lib/*.jar`
