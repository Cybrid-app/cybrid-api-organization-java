...
- Build date: 2025-02-13T14:10:17.187097Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.230"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.230.jar`
- `target/lib/*.jar`
