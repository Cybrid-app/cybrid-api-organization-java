...
- Build date: 2023-12-04T18:04:56.884060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.2.jar`
- `target/lib/*.jar`
