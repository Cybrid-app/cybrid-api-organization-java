...
- Build date: 2024-05-07T13:06:17.910789Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.141"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.141.jar`
- `target/lib/*.jar`
