...
- Build date: 2024-12-03T17:27:14.182580Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.50.jar`
- `target/lib/*.jar`
