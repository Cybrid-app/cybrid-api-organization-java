...
- Build date: 2023-12-15T20:42:42.660109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.10.jar`
- `target/lib/*.jar`
