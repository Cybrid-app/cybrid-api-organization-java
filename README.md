...
- Build date: 2025-05-22T17:58:18.202565Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.516"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.516.jar`
- `target/lib/*.jar`
