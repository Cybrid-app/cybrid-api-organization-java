...
- Build date: 2025-02-10T13:56:54.599440Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.221"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.221.jar`
- `target/lib/*.jar`
