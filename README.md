...
- Build date: 2024-10-17T14:01:47.615643Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.16.jar`
- `target/lib/*.jar`
