...
- Build date: 2025-03-31T16:57:05.225103Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.343"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.343.jar`
- `target/lib/*.jar`
