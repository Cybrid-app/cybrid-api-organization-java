...
- Build date: 2023-09-19T12:30:43.296107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.19"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.19.jar`
- `target/lib/*.jar`
