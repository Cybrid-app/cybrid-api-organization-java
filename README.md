...
- Build date: 2023-09-22T14:40:48.744222Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.29.jar`
- `target/lib/*.jar`
