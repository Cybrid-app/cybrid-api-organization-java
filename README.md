...
- Build date: 2023-07-27T11:46:42.114681Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.0.jar`
- `target/lib/*.jar`
