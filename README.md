...
- Build date: 2023-06-01T18:15:39.411432Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.64.jar`
- `target/lib/*.jar`
