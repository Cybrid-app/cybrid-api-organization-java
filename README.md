...
- Build date: 2023-08-25T14:49:27.408633Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.7.jar`
- `target/lib/*.jar`
