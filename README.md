...
- Build date: 2025-05-09T17:28:55.503362Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.470"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.470.jar`
- `target/lib/*.jar`
