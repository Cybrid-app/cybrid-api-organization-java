...
- Build date: 2023-09-29T13:22:55.910452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.46.jar`
- `target/lib/*.jar`
