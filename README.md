...
- Build date: 2024-10-03T18:43:06.776356Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.167"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.167.jar`
- `target/lib/*.jar`
