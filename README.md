...
- API version: v0.115.153

- Build date: 2024-05-14T00:54:52.639031Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.153"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.153.jar`
- `target/lib/*.jar`
