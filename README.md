...
- Build date: 2025-04-11T12:54:09.641562Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.379"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.379.jar`
- `target/lib/*.jar`
