...
- Build date: 2024-06-25T12:16:03.877107Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.41.jar`
- `target/lib/*.jar`
