...
- Build date: 2022-06-01T21:32:18.088843Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.1.jar`
- `target/lib/*.jar`
