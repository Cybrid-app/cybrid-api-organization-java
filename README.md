...
- Build date: 2024-12-12T20:23:39.660312Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.82"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.82.jar`
- `target/lib/*.jar`
