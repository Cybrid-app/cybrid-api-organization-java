...
- Build date: 2024-03-21T13:49:55.641515Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.22.jar`
- `target/lib/*.jar`
