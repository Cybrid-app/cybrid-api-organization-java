...
- Build date: 2023-08-29T02:05:06.812538Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.89.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.89.3.jar`
- `target/lib/*.jar`
