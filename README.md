...
- Build date: 2023-07-05T14:06:23.665914Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.76.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.76.1.jar`
- `target/lib/*.jar`
