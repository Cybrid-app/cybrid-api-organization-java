...
- Build date: 2024-04-07T23:37:50.475819Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.63.jar`
- `target/lib/*.jar`
