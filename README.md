...
- Build date: 2024-10-29T01:55:49.829097Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.50"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.50.jar`
- `target/lib/*.jar`
