...
- Build date: 2023-08-10T00:32:50.295012Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.1.jar`
- `target/lib/*.jar`
