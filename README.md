...
- Build date: 2025-02-24T15:07:32.631706Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.248"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.248.jar`
- `target/lib/*.jar`
