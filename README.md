...
- Build date: 2024-01-19T22:07:05.784177Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.80"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.80.jar`
- `target/lib/*.jar`
