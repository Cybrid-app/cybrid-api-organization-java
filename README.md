...
- Build date: 2024-10-23T13:19:41.258570Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.35"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.35.jar`
- `target/lib/*.jar`
