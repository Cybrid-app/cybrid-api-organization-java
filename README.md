...
- Build date: 2023-05-29T12:06:38.174719Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.54.jar`
- `target/lib/*.jar`
