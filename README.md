...
- Build date: 2024-04-02T14:08:58.037987Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.55"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.55.jar`
- `target/lib/*.jar`
