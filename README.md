...
- Build date: 2025-02-18T23:07:33.245869Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.240"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.240.jar`
- `target/lib/*.jar`
