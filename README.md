...
- Build date: 2025-05-16T14:32:01.672460Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.494"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.494.jar`
- `target/lib/*.jar`
