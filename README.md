...
- Build date: 2023-09-07T21:16:25.327271Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.92.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.92.0.jar`
- `target/lib/*.jar`
