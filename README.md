...
- Build date: 2023-04-28T13:23:09.525499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.71.jar`
- `target/lib/*.jar`
