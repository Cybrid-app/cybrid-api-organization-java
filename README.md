...
- Build date: 2023-10-26T14:52:21.107347Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.20.jar`
- `target/lib/*.jar`
