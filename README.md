...
- Build date: 2024-04-23T20:14:33.288584Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.116"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.116.jar`
- `target/lib/*.jar`
