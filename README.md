...
- Build date: 2023-09-15T15:53:07.959201Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.10.jar`
- `target/lib/*.jar`
