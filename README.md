...
- Build date: 2023-06-19T14:58:51.514072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.27.jar`
- `target/lib/*.jar`
