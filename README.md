...
- Build date: 2023-05-11T18:53:09.500872Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.17.jar`
- `target/lib/*.jar`
