...
- Build date: 2025-02-28T15:04:24.201961Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.265"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.265.jar`
- `target/lib/*.jar`
