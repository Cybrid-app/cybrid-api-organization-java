...
- Build date: 2024-09-19T21:27:26.877614Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.120"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.120.jar`
- `target/lib/*.jar`
