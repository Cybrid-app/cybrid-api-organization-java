...
- Build date: 2023-08-01T14:46:56.862098Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.16.jar`
- `target/lib/*.jar`
