...
- Build date: 2023-10-28T14:38:46.498694Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.24.jar`
- `target/lib/*.jar`
