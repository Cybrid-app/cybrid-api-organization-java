...
- Build date: 2024-11-05T16:45:08.818620Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.31.jar`
- `target/lib/*.jar`
