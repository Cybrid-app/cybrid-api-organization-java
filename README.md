...
- Build date: 2023-06-22T17:41:55.950919Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.1.jar`
- `target/lib/*.jar`
