...
- Build date: 2023-12-01T03:11:27.283240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.18.jar`
- `target/lib/*.jar`
