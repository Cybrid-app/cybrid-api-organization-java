...
- Build date: 2024-05-09T20:02:10.478240Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.146"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.146.jar`
- `target/lib/*.jar`
