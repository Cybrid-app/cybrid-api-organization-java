...
- Build date: 2023-11-09T21:32:48.488832Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.46.jar`
- `target/lib/*.jar`
