...
- Build date: 2023-10-05T14:30:58.822728Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.95.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.95.6.jar`
- `target/lib/*.jar`
