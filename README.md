...
- Build date: 2025-04-16T10:50:25.209060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.395"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.395.jar`
- `target/lib/*.jar`
