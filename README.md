...
- Build date: 2023-12-11T14:05:37.954073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.26.jar`
- `target/lib/*.jar`
