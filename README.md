...
- Build date: 2025-06-04T21:41:55.967954Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.552"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.552.jar`
- `target/lib/*.jar`
