...
- Build date: 2023-05-08T16:56:33.549945Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.70.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.70.0.jar`
- `target/lib/*.jar`
