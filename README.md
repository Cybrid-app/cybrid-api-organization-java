...
- Build date: 2025-05-15T14:05:50.821703Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.484"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.484.jar`
- `target/lib/*.jar`
