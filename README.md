...
- Build date: 2023-05-04T11:41:46.513388Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.86"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.86.jar`
- `target/lib/*.jar`
