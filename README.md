...
- Build date: 2023-12-20T18:13:49.926056Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.26.jar`
- `target/lib/*.jar`
