...
- Build date: 2024-03-11T16:19:02.542725Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.7"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.7.jar`
- `target/lib/*.jar`
