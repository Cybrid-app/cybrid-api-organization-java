...
- Build date: 2025-03-11T12:48:06.750607Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.289"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.289.jar`
- `target/lib/*.jar`
