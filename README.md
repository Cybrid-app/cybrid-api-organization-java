...
- Build date: 2025-06-13T18:14:44.011942Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.583"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.583.jar`
- `target/lib/*.jar`
