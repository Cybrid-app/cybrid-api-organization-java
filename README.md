...
- Build date: 2023-07-04T15:42:06.536051Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.0.jar`
- `target/lib/*.jar`
