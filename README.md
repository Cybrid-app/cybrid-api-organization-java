...
- Build date: 2024-03-21T12:50:53.329188Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.21.jar`
- `target/lib/*.jar`
