...
- Build date: 2022-05-10T11:23:19.501929Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.6.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.6.10.jar`
- `target/lib/*.jar`
