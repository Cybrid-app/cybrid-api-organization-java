...
- Build date: 2023-09-05T18:34:42.627256Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.91.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.91.3.jar`
- `target/lib/*.jar`
