...
- Build date: 2023-11-24T15:40:44.526313Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.0.jar`
- `target/lib/*.jar`
