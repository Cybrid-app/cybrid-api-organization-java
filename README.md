...
- Build date: 2024-09-04T19:11:16.704175Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.66"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.66.jar`
- `target/lib/*.jar`
