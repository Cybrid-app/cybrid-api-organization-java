...
- Build date: 2023-04-25T13:08:17.354664Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.63"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.63.jar`
- `target/lib/*.jar`
