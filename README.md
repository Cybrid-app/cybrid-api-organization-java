...
- Build date: 2022-05-16T11:03:49.433501Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.2.jar`
- `target/lib/*.jar`
