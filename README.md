...
- Build date: 2023-08-10T13:57:52.783613Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.5.jar`
- `target/lib/*.jar`
