...
- Build date: 2024-08-05T15:40:38.655083Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.2.jar`
- `target/lib/*.jar`
