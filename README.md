...
- Build date: 2025-06-18T23:48:31.020904Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.602"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.602.jar`
- `target/lib/*.jar`
