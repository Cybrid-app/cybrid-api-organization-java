...
- Build date: 2024-01-18T19:30:47.371023Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.71.jar`
- `target/lib/*.jar`
