...
- Build date: 2023-04-12T12:31:15.554496Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.37"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.37.jar`
- `target/lib/*.jar`
