...
- Build date: 2023-06-20T12:33:10.969806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.31.jar`
- `target/lib/*.jar`
