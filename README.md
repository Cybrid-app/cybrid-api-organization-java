...
- Build date: 2023-04-14T14:43:21.062370Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.49"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.49.jar`
- `target/lib/*.jar`
