...
- Build date: 2025-01-20T13:19:47.044235Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.151"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.151.jar`
- `target/lib/*.jar`
