...
- Build date: 2024-04-12T19:47:39.461609Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.91.jar`
- `target/lib/*.jar`
