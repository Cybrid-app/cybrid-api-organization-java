...
- Build date: 2023-07-27T14:44:37.036025Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.2.jar`
- `target/lib/*.jar`
