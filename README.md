...
- Build date: 2023-04-26T14:03:35.337576Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.65.jar`
- `target/lib/*.jar`
