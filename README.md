...
- Build date: 2022-05-16T13:25:56.983039Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.5.jar`
- `target/lib/*.jar`
