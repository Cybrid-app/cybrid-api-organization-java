...
- Build date: 2024-02-23T16:21:19.125246Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.14.jar`
- `target/lib/*.jar`
