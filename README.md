...
- Build date: 2023-11-30T15:15:22.649321Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.16"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.16.jar`
- `target/lib/*.jar`
