...
- Build date: 2023-12-01T14:23:16.931933Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.111.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.111.20.jar`
- `target/lib/*.jar`
