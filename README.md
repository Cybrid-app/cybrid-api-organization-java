...
- API version: v0.115.119

- Build date: 2024-04-25T00:22:39.926970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.119"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.119.jar`
- `target/lib/*.jar`
