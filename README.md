...
- Build date: 2024-01-30T13:55:49.993474Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.108"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.108.jar`
- `target/lib/*.jar`
