...
- Build date: 2023-12-14T17:31:07.189367Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.6.jar`
- `target/lib/*.jar`
