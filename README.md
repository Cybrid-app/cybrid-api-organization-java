...
- Build date: 2024-09-18T17:01:38.214709Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.112"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.112.jar`
- `target/lib/*.jar`
