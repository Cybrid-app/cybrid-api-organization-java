...
- Build date: 2024-09-13T14:54:15.429484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.94"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.94.jar`
- `target/lib/*.jar`
