...
- Build date: 2025-02-06T16:05:45.336552Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.215"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.215.jar`
- `target/lib/*.jar`
