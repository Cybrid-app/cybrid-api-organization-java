...
- API version: v0.118.47

- Build date: 2024-06-26T15:54:30.014949Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.47.jar`
- `target/lib/*.jar`
