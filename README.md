...
- Build date: 2025-01-16T13:39:05.652599Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.147"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.147.jar`
- `target/lib/*.jar`
