...
- Build date: 2023-07-31T21:33:24.246817Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.10.jar`
- `target/lib/*.jar`
