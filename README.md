...
- Build date: 2023-07-04T17:20:21.034610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.2.jar`
- `target/lib/*.jar`
