...
- Build date: 2022-06-02T14:20:06.803328Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.4.jar`
- `target/lib/*.jar`
