...
- Build date: 2023-05-25T15:02:40.869505Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.41"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.41.jar`
- `target/lib/*.jar`
