...
- Build date: 2024-03-08T21:28:47.377525Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.1.jar`
- `target/lib/*.jar`
