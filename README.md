...
- Build date: 2023-11-20T15:51:29.096717Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.9.jar`
- `target/lib/*.jar`
