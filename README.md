...
- Build date: 2023-09-21T12:12:48.227798Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.24"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.24.jar`
- `target/lib/*.jar`
