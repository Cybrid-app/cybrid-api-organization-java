...
- Build date: 2023-08-25T13:10:39.869707Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.6.jar`
- `target/lib/*.jar`
