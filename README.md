...
- Build date: 2024-09-25T18:45:04.308160Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.139"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.139.jar`
- `target/lib/*.jar`
