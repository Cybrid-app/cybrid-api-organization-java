...
- Build date: 2025-04-09T13:51:22.556077Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.370"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.370.jar`
- `target/lib/*.jar`
