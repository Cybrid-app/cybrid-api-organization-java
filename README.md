...
- Build date: 2025-01-13T16:20:52.165683Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.139"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.139.jar`
- `target/lib/*.jar`
