...
- Build date: 2025-06-16T18:03:23.589052Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.593"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.593.jar`
- `target/lib/*.jar`
