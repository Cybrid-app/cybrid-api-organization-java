...
- Build date: 2025-05-08T18:42:06.424178Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.465"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.465.jar`
- `target/lib/*.jar`
