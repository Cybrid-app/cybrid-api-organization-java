...
- Build date: 2024-04-25T10:22:53.474806Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.120"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.120.jar`
- `target/lib/*.jar`
