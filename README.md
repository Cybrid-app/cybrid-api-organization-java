...
- Build date: 2024-02-07T20:21:45.707878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.124"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.124.jar`
- `target/lib/*.jar`
