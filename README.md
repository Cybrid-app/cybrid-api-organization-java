...
- Build date: 2025-05-06T14:30:46.955202Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.453"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.453.jar`
- `target/lib/*.jar`
