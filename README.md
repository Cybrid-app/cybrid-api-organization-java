...
- Build date: 2025-03-24T19:07:41.808914Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.322"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.322.jar`
- `target/lib/*.jar`
