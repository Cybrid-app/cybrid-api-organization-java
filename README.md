...
- Build date: 2023-09-20T13:36:40.092379Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.21"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.21.jar`
- `target/lib/*.jar`
