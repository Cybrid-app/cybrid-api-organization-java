...
- Build date: 2025-05-02T21:48:52.568814Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.445"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.445.jar`
- `target/lib/*.jar`
