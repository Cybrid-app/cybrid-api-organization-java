...
- Build date: 2025-04-08T12:05:22.463237Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.364"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.364.jar`
- `target/lib/*.jar`
