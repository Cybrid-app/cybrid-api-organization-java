...
- Build date: 2023-08-16T15:30:42.025305Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.13.jar`
- `target/lib/*.jar`
