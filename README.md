...
- Build date: 2024-11-07T16:06:48.436852Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.36"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.36.jar`
- `target/lib/*.jar`
