...
- Build date: 2025-04-09T20:49:22.332924Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.372"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.372.jar`
- `target/lib/*.jar`
