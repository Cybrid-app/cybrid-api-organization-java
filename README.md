...
- Build date: 2024-10-08T15:16:58.683499Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.120.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.120.12.jar`
- `target/lib/*.jar`
