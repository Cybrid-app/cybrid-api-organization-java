...
- Build date: 2025-03-21T21:00:05.806894Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.316"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.316.jar`
- `target/lib/*.jar`
