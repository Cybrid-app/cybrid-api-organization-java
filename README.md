...
- Build date: 2024-04-26T15:13:54.437988Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.125"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.125.jar`
- `target/lib/*.jar`
