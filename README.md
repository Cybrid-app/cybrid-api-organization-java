...
- Build date: 2025-04-11T21:59:28.382693Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.381"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.381.jar`
- `target/lib/*.jar`
