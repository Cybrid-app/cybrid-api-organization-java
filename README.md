...
- Build date: 2024-05-08T22:13:15.043773Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.145"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.145.jar`
- `target/lib/*.jar`
