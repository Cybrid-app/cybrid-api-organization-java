...
- Build date: 2023-08-10T16:29:10.240741Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.6"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.6.jar`
- `target/lib/*.jar`
