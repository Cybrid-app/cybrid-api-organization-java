...
- Build date: 2025-04-17T16:45:35.177060Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.404"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.404.jar`
- `target/lib/*.jar`
