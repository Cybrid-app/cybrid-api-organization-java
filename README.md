...
- Build date: 2024-05-06T16:49:12.787597Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.139"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.139.jar`
- `target/lib/*.jar`
