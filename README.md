...
- Build date: 2024-04-11T09:58:19.770014Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.82"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.82.jar`
- `target/lib/*.jar`
