...
- Build date: 2025-02-18T16:58:26.264583Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.237"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.237.jar`
- `target/lib/*.jar`
