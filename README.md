...
- Build date: 2025-06-19T20:27:08.195436Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.612"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.612.jar`
- `target/lib/*.jar`
