...
- Build date: 2023-10-06T21:38:55.958780Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.98.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.98.0.jar`
- `target/lib/*.jar`
