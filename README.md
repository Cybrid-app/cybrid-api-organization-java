...
- Build date: 2024-10-16T15:47:38.202402Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.10.jar`
- `target/lib/*.jar`
