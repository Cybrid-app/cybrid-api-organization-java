...
- Build date: 2023-08-01T23:55:23.804802Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.22"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.22.jar`
- `target/lib/*.jar`
