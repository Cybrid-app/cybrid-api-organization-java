...
- Build date: 2023-05-19T18:58:06.881738Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.29"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.29.jar`
- `target/lib/*.jar`
