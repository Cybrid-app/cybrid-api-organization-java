...
- Build date: 2025-06-12T13:38:32.685835Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.578"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.578.jar`
- `target/lib/*.jar`
