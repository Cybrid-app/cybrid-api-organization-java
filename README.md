...
- Build date: 2024-10-16T18:44:03.575708Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.13"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.13.jar`
- `target/lib/*.jar`
