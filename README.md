...
- Build date: 2024-03-27T16:10:12.987389Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.43"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.43.jar`
- `target/lib/*.jar`
