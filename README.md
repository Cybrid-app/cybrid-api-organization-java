...
- Build date: 2025-06-19T17:08:27.621794Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.608"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.608.jar`
- `target/lib/*.jar`
