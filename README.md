...
- Build date: 2023-11-07T13:06:33.808655Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.109.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.109.39.jar`
- `target/lib/*.jar`
