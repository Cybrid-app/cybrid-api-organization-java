...
- Build date: 2025-06-11T14:32:36.021357Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.572"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.572.jar`
- `target/lib/*.jar`
