...
- Build date: 2025-04-29T17:23:06.333154Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.436"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.436.jar`
- `target/lib/*.jar`
