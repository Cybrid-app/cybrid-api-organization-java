...
- Build date: 2024-06-26T15:35:15.521436Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.46"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.46.jar`
- `target/lib/*.jar`
