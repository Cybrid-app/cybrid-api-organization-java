...
- Build date: 2025-06-10T13:39:04.751137Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.568"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.568.jar`
- `target/lib/*.jar`
