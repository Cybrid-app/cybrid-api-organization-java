...
- Build date: 2025-03-26T19:37:29.271973Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.330"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.330.jar`
- `target/lib/*.jar`
