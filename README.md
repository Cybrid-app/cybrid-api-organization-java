...
- Build date: 2025-04-08T15:57:05.544943Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.367"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.367.jar`
- `target/lib/*.jar`
