...
- Build date: 2024-03-05T20:06:53.921999Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.40"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.40.jar`
- `target/lib/*.jar`
