...
- Build date: 2025-03-24T16:20:39.149422Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.320"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.320.jar`
- `target/lib/*.jar`
