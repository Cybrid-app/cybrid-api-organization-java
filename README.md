...
- Build date: 2024-03-01T14:18:59.974751Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.31"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.31.jar`
- `target/lib/*.jar`
