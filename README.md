...
- Build date: 2023-08-18T18:43:31.195120Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.84.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.84.14.jar`
- `target/lib/*.jar`
