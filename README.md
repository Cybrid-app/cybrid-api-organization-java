...
- Build date: 2025-02-05T14:45:31.957248Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.208"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.208.jar`
- `target/lib/*.jar`
