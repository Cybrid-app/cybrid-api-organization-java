...
- Build date: 2023-07-19T17:32:44.999194Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.79.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.79.4.jar`
- `target/lib/*.jar`
