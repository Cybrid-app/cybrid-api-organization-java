...
- Build date: 2024-12-10T17:16:41.942227Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.71.jar`
- `target/lib/*.jar`
