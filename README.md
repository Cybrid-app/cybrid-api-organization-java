...
- Build date: 2024-10-30T01:31:53.221566Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.57.jar`
- `target/lib/*.jar`
