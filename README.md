...
- Build date: 2025-04-15T18:59:18.150252Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.391"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.391.jar`
- `target/lib/*.jar`
