...
- Build date: 2024-07-08T12:58:29.519685Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.69"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.69.jar`
- `target/lib/*.jar`
