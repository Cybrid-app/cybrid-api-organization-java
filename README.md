...
- Build date: 2023-06-20T18:30:12.272906Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.34"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.34.jar`
- `target/lib/*.jar`
