...
- Build date: 2023-06-19T14:35:19.292661Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.26"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.26.jar`
- `target/lib/*.jar`
