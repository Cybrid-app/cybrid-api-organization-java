...
- Build date: 2023-06-23T12:29:06.977713Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.3.jar`
- `target/lib/*.jar`
