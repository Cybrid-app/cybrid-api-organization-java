...
- Build date: 2024-02-26T17:51:16.140418Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.114.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.114.18.jar`
- `target/lib/*.jar`
