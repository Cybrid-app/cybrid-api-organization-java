...
- Build date: 2025-03-26T20:42:12.528938Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.331"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.331.jar`
- `target/lib/*.jar`
