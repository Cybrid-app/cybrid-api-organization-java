...
- Build date: 2025-02-03T22:45:42.017385Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.192"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.192.jar`
- `target/lib/*.jar`
