...
- Build date: 2025-03-06T15:30:50.661109Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.274"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.274.jar`
- `target/lib/*.jar`
