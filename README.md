...
- Build date: 2023-06-07T13:27:57.169144Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.71"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.71.jar`
- `target/lib/*.jar`
