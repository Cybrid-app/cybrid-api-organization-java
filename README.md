...
- Build date: 2025-06-10T17:32:49.121636Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.570"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.570.jar`
- `target/lib/*.jar`
