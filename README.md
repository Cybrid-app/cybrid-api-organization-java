...
- Build date: 2025-04-29T20:10:13.199316Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.437"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.437.jar`
- `target/lib/*.jar`
