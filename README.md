...
- Build date: 2024-05-01T12:55:42.838521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.131"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.131.jar`
- `target/lib/*.jar`
