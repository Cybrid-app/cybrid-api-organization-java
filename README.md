...
- Build date: 2023-12-04T22:51:37.539224Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.4"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.4.jar`
- `target/lib/*.jar`
