...
- Build date: 2024-12-10T20:10:21.184011Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.73"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.73.jar`
- `target/lib/*.jar`
