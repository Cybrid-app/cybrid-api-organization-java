...
- Build date: 2022-06-14T13:57:43.792091Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.25.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.25.1.jar`
- `target/lib/*.jar`
