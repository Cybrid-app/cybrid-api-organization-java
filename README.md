...
- Build date: 2025-03-06T13:44:37.208069Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.273"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.273.jar`
- `target/lib/*.jar`
