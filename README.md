...
- Build date: 2025-05-28T14:57:49.569734Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.532"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.532.jar`
- `target/lib/*.jar`
