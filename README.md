...
- Build date: 2023-06-27T14:34:18.571970Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.14.jar`
- `target/lib/*.jar`
