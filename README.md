...
- Build date: 2023-04-18T19:54:49.428937Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.56"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.56.jar`
- `target/lib/*.jar`
