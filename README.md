...
- Build date: 2023-05-12T13:44:57.068167Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.18"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.18.jar`
- `target/lib/*.jar`
