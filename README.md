...
- API version: v0.115.138

- Build date: 2024-05-06T15:58:09.918610Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.138"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.138.jar`
- `target/lib/*.jar`
