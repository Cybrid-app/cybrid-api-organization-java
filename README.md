...
- Build date: 2022-05-26T23:50:53.690137Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.15.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.15.0.jar`
- `target/lib/*.jar`
