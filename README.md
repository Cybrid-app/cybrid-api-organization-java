...
- Build date: 2024-04-12T21:06:06.088048Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.92"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.92.jar`
- `target/lib/*.jar`
