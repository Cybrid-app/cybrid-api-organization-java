...
- Build date: 2025-02-04T13:35:36.299073Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.194"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.194.jar`
- `target/lib/*.jar`
