...
- Build date: 2023-05-01T20:11:44.610646Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.74"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.74.jar`
- `target/lib/*.jar`
