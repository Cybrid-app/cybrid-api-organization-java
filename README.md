...
- Build date: 2024-07-28T18:19:51.116868Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.106"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.106.jar`
- `target/lib/*.jar`
