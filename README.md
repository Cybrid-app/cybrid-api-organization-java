...
- Build date: 2023-06-19T12:41:48.596905Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.73.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.73.23.jar`
- `target/lib/*.jar`
