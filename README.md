...
- Build date: 2024-04-08T12:47:39.596663Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.115.65"
  }
```
...
- `target/cybrid-api-organization-java-v0.115.65.jar`
- `target/lib/*.jar`
