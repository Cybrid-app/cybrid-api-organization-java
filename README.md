...
- Build date: 2024-09-25T13:49:32.985049Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.138"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.138.jar`
- `target/lib/*.jar`
