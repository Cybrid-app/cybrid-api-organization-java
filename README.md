...
- Build date: 2025-04-17T13:59:49.670532Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.403"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.403.jar`
- `target/lib/*.jar`
