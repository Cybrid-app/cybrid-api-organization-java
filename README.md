...
- Build date: 2023-05-08T20:14:45.889658Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.1.jar`
- `target/lib/*.jar`
