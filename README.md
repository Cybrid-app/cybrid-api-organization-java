...
- Build date: 2023-08-10T01:13:21.716035Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.2.jar`
- `target/lib/*.jar`
