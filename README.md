...
- Build date: 2024-08-01T17:08:01.864452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.117"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.117.jar`
- `target/lib/*.jar`
