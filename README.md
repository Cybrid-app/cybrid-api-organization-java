...
- Build date: 2023-08-01T19:13:11.933906Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.20"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.20.jar`
- `target/lib/*.jar`
