...
- Build date: 2025-06-19T17:57:23.134072Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.609"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.609.jar`
- `target/lib/*.jar`
