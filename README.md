...
- Build date: 2024-12-20T14:46:11.522763Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.101"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.101.jar`
- `target/lib/*.jar`
