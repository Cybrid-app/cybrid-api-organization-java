...
- Build date: 2022-06-07T15:46:50.142348Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.20.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.20.3.jar`
- `target/lib/*.jar`
