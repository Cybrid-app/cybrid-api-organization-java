...
- Build date: 2024-07-04T15:59:44.596830Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.64"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.64.jar`
- `target/lib/*.jar`
