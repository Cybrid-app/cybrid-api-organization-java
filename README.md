...
- Build date: 2023-04-11T13:06:11.056256Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.32.jar`
- `target/lib/*.jar`
