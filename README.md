...
- Build date: 2024-12-05T20:03:02.144559Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.60"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.60.jar`
- `target/lib/*.jar`
