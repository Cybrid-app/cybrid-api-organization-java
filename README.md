...
- Build date: 2024-10-18T17:21:56.920360Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.23"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.23.jar`
- `target/lib/*.jar`
