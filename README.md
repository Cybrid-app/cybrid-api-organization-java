...
- Build date: 2024-09-20T16:47:04.329327Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.126"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.126.jar`
- `target/lib/*.jar`
