...
- Build date: 2022-06-06T12:08:19.336829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.18.12"
  }
```
...
- `target/cybrid-api-organization-java-v0.18.12.jar`
- `target/lib/*.jar`
