...
- Build date: 2023-05-18T13:21:51.206654Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.27"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.27.jar`
- `target/lib/*.jar`
