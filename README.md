...
- Build date: 2025-02-25T18:52:06.722829Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.254"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.254.jar`
- `target/lib/*.jar`
