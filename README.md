...
- Build date: 2023-12-08T13:45:00.789547Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.15"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.15.jar`
- `target/lib/*.jar`
