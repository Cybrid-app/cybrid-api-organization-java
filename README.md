...
- Build date: 2024-11-08T16:55:14.888953Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.122.45"
  }
```
...
- `target/cybrid-api-organization-java-v0.122.45.jar`
- `target/lib/*.jar`
