...
- Build date: 2024-08-04T14:27:46.807964Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.125"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.125.jar`
- `target/lib/*.jar`
