...
- Build date: 2025-04-03T18:09:32.312776Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.355"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.355.jar`
- `target/lib/*.jar`
