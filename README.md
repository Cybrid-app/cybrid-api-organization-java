...
- Build date: 2023-08-10T21:04:19.046065Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.10.jar`
- `target/lib/*.jar`
