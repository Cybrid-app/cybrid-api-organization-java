...
- Build date: 2024-09-30T16:34:08.693075Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.153"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.153.jar`
- `target/lib/*.jar`
