...
- Build date: 2023-09-28T01:24:07.902196Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.42"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.42.jar`
- `target/lib/*.jar`
