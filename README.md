...
- Build date: 2025-04-23T22:53:36.543796Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.420"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.420.jar`
- `target/lib/*.jar`
