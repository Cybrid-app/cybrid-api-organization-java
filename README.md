...
- Build date: 2023-05-08T15:16:26.795990Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.69.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.69.0.jar`
- `target/lib/*.jar`
