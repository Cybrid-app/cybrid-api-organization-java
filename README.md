...
- Build date: 2023-09-18T17:49:58.184079Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.94.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.94.17.jar`
- `target/lib/*.jar`
