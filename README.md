...
- Build date: 2025-05-06T16:20:36.318057Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.455"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.455.jar`
- `target/lib/*.jar`
