...
- Build date: 2024-08-22T13:09:59.645105Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.39"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.39.jar`
- `target/lib/*.jar`
