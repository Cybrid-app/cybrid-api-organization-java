...
- Build date: 2022-06-07T14:41:59.822969Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.20.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.20.1.jar`
- `target/lib/*.jar`
