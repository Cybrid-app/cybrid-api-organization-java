...
- Build date: 2023-11-16T12:56:19.245050Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.2.jar`
- `target/lib/*.jar`
