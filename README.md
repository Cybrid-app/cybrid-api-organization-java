...
- Build date: 2023-07-18T03:25:41.755381Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.78.17"
  }
```
...
- `target/cybrid-api-organization-java-v0.78.17.jar`
- `target/lib/*.jar`
