...
- Build date: 2023-12-05T18:47:04.490732Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.9.jar`
- `target/lib/*.jar`
