...
- Build date: 2024-10-11T20:21:33.744975Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.0.jar`
- `target/lib/*.jar`
