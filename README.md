...
- Build date: 2024-12-19T13:12:27.220023Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.98"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.98.jar`
- `target/lib/*.jar`
