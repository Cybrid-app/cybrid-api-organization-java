...
- Build date: 2024-02-12T13:56:48.940878Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.113.136"
  }
```
...
- `target/cybrid-api-organization-java-v0.113.136.jar`
- `target/lib/*.jar`
