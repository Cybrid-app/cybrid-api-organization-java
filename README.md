...
- Build date: 2025-06-09T13:19:03.327978Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.560"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.560.jar`
- `target/lib/*.jar`
