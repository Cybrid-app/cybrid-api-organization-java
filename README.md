...
- Build date: 2025-03-17T14:40:41.470745Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.298"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.298.jar`
- `target/lib/*.jar`
