...
- Build date: 2023-09-12T00:49:48.701549Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.93.2"
  }
```
...
- `target/cybrid-api-organization-java-v0.93.2.jar`
- `target/lib/*.jar`
