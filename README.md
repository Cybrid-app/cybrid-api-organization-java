...
- Build date: 2024-07-25T21:12:30.287958Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.99"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.99.jar`
- `target/lib/*.jar`
