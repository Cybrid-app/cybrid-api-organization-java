...
- Build date: 2024-12-04T15:31:10.434376Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.52"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.52.jar`
- `target/lib/*.jar`
