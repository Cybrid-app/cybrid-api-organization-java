...
- Build date: 2024-12-17T13:36:21.347166Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.92"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.92.jar`
- `target/lib/*.jar`
