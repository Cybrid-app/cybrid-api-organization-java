...
- Build date: 2022-05-17T16:07:59.583118Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.9.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.9.10.jar`
- `target/lib/*.jar`
