...
- Build date: 2022-05-25T10:30:21.174811Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.14.10"
  }
```
...
- `target/cybrid-api-organization-java-v0.14.10.jar`
- `target/lib/*.jar`
