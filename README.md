...
- Build date: 2024-12-04T22:58:11.947452Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.57"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.57.jar`
- `target/lib/*.jar`
