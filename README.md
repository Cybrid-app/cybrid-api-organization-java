...
- Build date: 2024-10-12T22:23:35.030238Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.121.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.121.3.jar`
- `target/lib/*.jar`
