...
- Build date: 2024-05-25T15:28:05.314549Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.117.14"
  }
```
...
- `target/cybrid-api-organization-java-v0.117.14.jar`
- `target/lib/*.jar`
