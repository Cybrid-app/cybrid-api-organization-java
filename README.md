...
- Build date: 2023-12-11T20:56:22.786599Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.112.32"
  }
```
...
- `target/cybrid-api-organization-java-v0.112.32.jar`
- `target/lib/*.jar`
