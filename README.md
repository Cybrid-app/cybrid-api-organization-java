...
- Build date: 2023-08-10T11:56:15.886521Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.83.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.83.3.jar`
- `target/lib/*.jar`
