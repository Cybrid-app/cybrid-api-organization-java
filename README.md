...
- Build date: 2023-05-26T01:11:06.918531Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.71.47"
  }
```
...
- `target/cybrid-api-organization-java-v0.71.47.jar`
- `target/lib/*.jar`
