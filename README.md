...
- Build date: 2023-07-04T16:58:20.223884Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.75.1"
  }
```
...
- `target/cybrid-api-organization-java-v0.75.1.jar`
- `target/lib/*.jar`
