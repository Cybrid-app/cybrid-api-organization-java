...
- Build date: 2023-08-28T16:52:58.534229Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.88.11"
  }
```
...
- `target/cybrid-api-organization-java-v0.88.11.jar`
- `target/lib/*.jar`
