...
- Build date: 2024-06-05T20:08:07.814484Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.5.jar`
- `target/lib/*.jar`
