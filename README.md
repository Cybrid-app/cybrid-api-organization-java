...
- Build date: 2022-06-07T13:22:12.501921Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.20.0"
  }
```
...
- `target/cybrid-api-organization-java-v0.20.0.jar`
- `target/lib/*.jar`
