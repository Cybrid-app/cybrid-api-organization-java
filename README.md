...
- Build date: 2025-06-17T20:20:27.593134Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.601"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.601.jar`
- `target/lib/*.jar`
