...
- Build date: 2024-07-16T13:52:19.866954Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.80"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.80.jar`
- `target/lib/*.jar`
