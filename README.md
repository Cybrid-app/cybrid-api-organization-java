...
- Build date: 2023-10-13T14:51:46.886954Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.106.3"
  }
```
...
- `target/cybrid-api-organization-java-v0.106.3.jar`
- `target/lib/*.jar`
