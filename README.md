...
- Build date: 2023-11-23T20:56:24.322323Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.110.25"
  }
```
...
- `target/cybrid-api-organization-java-v0.110.25.jar`
- `target/lib/*.jar`
