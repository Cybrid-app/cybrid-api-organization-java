...
- Build date: 2023-07-31T20:56:48.009406Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.81.9"
  }
```
...
- `target/cybrid-api-organization-java-v0.81.9.jar`
- `target/lib/*.jar`
