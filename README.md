...
- Build date: 2023-04-18T16:25:32.343874Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.68.54"
  }
```
...
- `target/cybrid-api-organization-java-v0.68.54.jar`
- `target/lib/*.jar`
