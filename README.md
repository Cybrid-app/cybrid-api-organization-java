...
- Build date: 2024-07-24T14:10:08.309190Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.118.91"
  }
```
...
- `target/cybrid-api-organization-java-v0.118.91.jar`
- `target/lib/*.jar`
