...
- Build date: 2023-06-23T18:53:25.800289Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.74.5"
  }
```
...
- `target/cybrid-api-organization-java-v0.74.5.jar`
- `target/lib/*.jar`
