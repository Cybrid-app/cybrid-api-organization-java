...
- Build date: 2024-08-07T15:13:29.292598Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.119.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.119.8.jar`
- `target/lib/*.jar`
