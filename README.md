...
- Build date: 2022-05-13T18:10:30.026413Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.8.8"
  }
```
...
- `target/cybrid-api-organization-java-v0.8.8.jar`
- `target/lib/*.jar`
