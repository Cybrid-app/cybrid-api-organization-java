...
- Build date: 2025-04-25T20:45:35.391897Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "app.cybrid:cybrid-api-organization-java:v0.123.430"
  }
```
...
- `target/cybrid-api-organization-java-v0.123.430.jar`
- `target/lib/*.jar`
